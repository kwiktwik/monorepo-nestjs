<!-- Source: https://developer.phonepe.com/offline-integration/cancel-payment-request-api -->
...
**Prod Endpoints:**
`POST` [https://mercury-t2.phonepe.com/v3/charge/{merchantId}/{transactionId}/cancel](https://mercury-t2.phonepe.com/v3/charge/%7BmerchantId%7D/%7BtransactionId%7D/cancel)
