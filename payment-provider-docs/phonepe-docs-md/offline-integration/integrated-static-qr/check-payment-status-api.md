<!-- Source: https://developer.phonepe.com/offline-integration/integrated-static-qr/check-payment-status-api -->
...
**Prod Endpoints:**
`GET` [https://mercury-t2.phonepe.com/v3/transaction/{merchantId}/{transactionId}/status](https://mercury-t2.phonepe.com/v1/merchant/transaction/metadata)
