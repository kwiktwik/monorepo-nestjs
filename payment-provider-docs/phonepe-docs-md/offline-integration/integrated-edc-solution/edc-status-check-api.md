<!-- Source: https://developer.phonepe.com/offline-integration/integrated-edc-solution/edc-status-check-api -->
...
**UAT Endpoints:**
`POST` [https://mercury-uat.phonepe.com/enterprise-sandbox/v1/edc/transaction/{merchantId}/{transactionId}/status](https://mercury-uat.phonepe.com/enterprise-sandbox/v1/edc/transaction/%7BmerchantId%7D/%7BtransactionId%7D/status)

**Prod Endpoints:**
`POST` [https://mercury-t2.phonepe.com/v1/edc/transaction/{merchantId}/{transactionId}/status](https://mercury-t2.phonepe.com/v1/edc/transaction/%7BmerchantId%7D/%7Btran/v1/edc/transaction/%7BmerchantId%7D/%7BtransactionId%7D/statussactionId%7D/status)
