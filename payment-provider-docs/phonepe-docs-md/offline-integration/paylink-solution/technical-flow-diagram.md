<!-- Source: https://developer.phonepe.com/offline-integration/paylink-solution/technical-flow-diagram -->
...
For the detailed API contract for raising collect request, please refer [PaymentLink API](/phonepe-docs-md/offline-integration/paylink-solution/paymentlink-api.md) section of the documentation.
...
The collect request will automatically be canceled and payment will be failed after `ExpiresIn` time sent through [Charge](/phonepe-docs-md/offline-integration/paylink-solution/ref-charge.md) ends. Recommended time for expiry of collect request is 180 seconds.
