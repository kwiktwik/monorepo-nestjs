<!-- Source: https://razorpay.com/docs/payments/dashboard/account-settings/webhooks -->

You can [set up](/razorpay-docs-md/dashboard/account-settings/webhooks.md#set-up-webhooks), [edit](/razorpay-docs-md/dashboard/account-settings/webhooks.md#edit-a-webhook), [enable/disable](/razorpay-docs-md/dashboard/account-settings/webhooks.md#enabledisable-a-webhook) and [delete](/razorpay-docs-md/dashboard/account-settings/webhooks.md#delete-a-webhook) webhooks from the Dashboard.
...
3. Click the **+ Add New Webhook** button.
   ...
   ![Add a new webhooks button on the Dashboard](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/webhooks-webhook-creation-1.jpg)
4. In the **Webhook Setup** pop-up page:
   ...
   ![List of active webhook events on Razorpay Dashboard](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/webhooks-webhook-creation-2.jpg)
5. Click **Create Webhook**. After you set up a webhook, it appears on the list of webhooks.

   ![List of webhooks on Razorpay Dashboard](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/webhooks-webhooks-list.jpg)
...
5. The **Webhook Setup** pop-up page is displayed. You can modify the following:
   ...
   ![Edit Webhooks on Dashboard](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/webhooks-webhook-edit-2.jpg)
...
- [Set Up and Edit Payout Webhooks](/docs/webhooks/setup-edit-payouts/)
