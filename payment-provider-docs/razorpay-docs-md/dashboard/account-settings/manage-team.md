<!-- Source: https://razorpay.com/docs/payments/dashboard/account-settings/manage-team -->
...
- Use the [Dispute Manager](/razorpay-docs-md/dashboard/account-settings/manage-team.md#dispute-manager)

  role for team members who only need to handle chargebacks without access to refunds or bank details.
- Use the [Pseudo Owner](/razorpay-docs-md/dashboard/account-settings/manage-team.md#pseudo-owner)

  role sparingly for trusted individuals who need to manage the account when the Owner is unavailable.
- Use the [View-Only](/razorpay-docs-md/dashboard/account-settings/manage-team.md#view-only-auditor)

  role for auditors and stakeholders who need visibility without operational access.
...
![Accept invite to be team member (for an existing Razorpay user)](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/dashboard-guide-accept-invitation.jpg)
...
![Send invite to new member (for a new Razorpay user)](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/dashboard-guide-invite-new-user.jpg)
