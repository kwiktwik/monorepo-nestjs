<!-- Source: https://razorpay.com/docs/payments/dashboard/account-settings/email-sms-whatsapp -->
...
![Manage SMS Notifications](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/manage-sms-notifications.jpg)
...
This feature is available only to the owner user role. Know about the various [user roles](/razorpay-docs-md/dashboard/account-settings/manage-team.md).
...
![Manage WhatsApp Notifications](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/manage-whatsApp-notifications.jpg)
