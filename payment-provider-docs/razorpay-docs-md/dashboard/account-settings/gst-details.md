<!-- Source: https://razorpay.com/docs/payments/dashboard/account-settings/gst-details -->
...
3. Click **GST details** under **Business settings** section.
   ...
   ![Add GST details on the Razorpay Dashboard](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/dashboard-guide-profile-add-gst-details.jpg)
...
4. In the **Add GST details** pop-up page:
   ...
   ![Submit GST details on Razorpay Dashboard](https://razorpay.com/docs/payments/dashboard/account-settings/build/browser/assets/images/dashboard-guide-profile-add-gst.jpg)
