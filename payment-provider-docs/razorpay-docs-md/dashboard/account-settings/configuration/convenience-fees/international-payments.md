<!-- Source: https://razorpay.com/docs/payments/dashboard/account-settings/configuration/convenience-fees/international-payments -->
...
4. The checkout pop-up page is displayed. The customer enters the **Phone number and Email**.
   ...
   ![customer details](https://razorpay.com/docs/payments/dashboard/account-settings/configuration/convenience-fees/build/browser/assets/images/cfb-dcc-phone-no-details.jpg)
5. The customer selects the payment method on the checkout page and tries to make the payment.

   ![card details](https://razorpay.com/docs/payments/dashboard/account-settings/configuration/convenience-fees/build/browser/assets/images/cfb-dcc-card-details.jpg)
6. The customers also get the option to change the currency as per their choice. Based on the selected currency, the **Fees Breakup** page containing the **Convenience Fee** appears, and the customer clicks **Continue**.
   ...
   ![Fees breakup](https://razorpay.com/docs/payments/dashboard/account-settings/configuration/convenience-fees/build/browser/assets/images/cfb-dcc-charges-breakup.jpg)
...
Refer to the [list of currencies](/razorpay-docs-md/international-payments.md#supported-currencies) that support the Convenience Fee model.
...
- [Convenience Fee Model](/razorpay-docs-md/dashboard/account-settings/configuration/convenience-fees.md)
