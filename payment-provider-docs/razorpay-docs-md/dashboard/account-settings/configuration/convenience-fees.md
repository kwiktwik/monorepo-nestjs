<!-- Source: https://razorpay.com/docs/payments/dashboard/account-settings/configuration/convenience-fees -->
...
![Fees breakup](https://razorpay.com/docs/payments/dashboard/account-settings/configuration/build/browser/assets/images/dashboard-guide-settings-fee-bearer-fee-breakup-v2.jpg)
...
2. You select the **Convenience Fee Model** option on the **Settings** → **Fee Bearer** section of the Dashboard.
   ...
   ![Customer pays the fee](https://razorpay.com/docs/payments/dashboard/account-settings/configuration/build/browser/assets/images/dashboard-guide-settings-fee-bearer-customer-fee-bearer.jpg)
3. The customer selects an item on your website/Payment Link/Payment Page and clicks the pay button.

   ![Customer clicks pay button](https://razorpay.com/docs/payments/dashboard/account-settings/configuration/build/browser/assets/images/dashboard-guide-settings-fee-bearer-payment-page.jpg)
