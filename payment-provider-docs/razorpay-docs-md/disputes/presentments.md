<!-- Source: https://razorpay.com/docs/payments/disputes/presentments -->
...
`string` 3-letter ISO currency code associated with the amount. List of [supported currencies](/razorpay-docs-md/international-payments.md#supported-currencies).

amount\_deducted

`integer` The amount, in currency subunits, deducted from your Razorpay current balance when the dispute is `lost`. This amount will be `0` unless the status of dispute is updated to `lost`. Learn about the different [states of disputes](/razorpay-docs-md/disputes.md#dispute-states).
...
`object` Provides details of the evidence submitted/saved for contesting a dispute. Use the [Documents API](/razorpay-docs-md/api/documents.md) to securely share documents with Razorpay.
...
`list` (List of document ids) [Document(s)](/razorpay-docs-md/api/documents.md) which serves as proof that the product was shipped to the customer at the customer provided address. It should show the customer’s full shipping address, if possible.
...
![](https://razorpay.com/docs/payments/disputes/build/browser/assets/images/disputes-presentment-dispute-states.jpg)

## APIs

The following API operations can be performed:

- [Fetch All Disputes](/razorpay-docs-md/disputes/presentments.md#fetch-all-disputes)
- [Fetch a Dispute](/razorpay-docs-md/disputes/presentments.md#fetch-a-dispute)
- [Accept a dispute](/razorpay-docs-md/disputes/presentments.md#accept-a-dispute)
- [Contest a dispute](/razorpay-docs-md/disputes/presentments.md#contest-a-dispute)
...
- Attaching an evidence document (A document uploaded to the Razorpay ecosystem using [Documents API](/razorpay-docs-md/api/documents.md)

  having purpose set to `dispute_evidence`).
...
All successful responses are returned with HTTP Status code 200. In case of failure, Razorpay API returns a JSON error response with the parameters that detail the reason for the failure. [Learn more about error codes](/docs/errors/).
...
- [Documents API](/razorpay-docs-md/api/documents.md)
