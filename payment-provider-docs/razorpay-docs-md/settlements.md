<!-- Source: https://razorpay.com/docs/payments/settlements -->
...
- Your account must be fully activated for payments to be settled to your bank account. Know more about [KYC Verification](/razorpay-docs-md/set-up.md#2-submit-kyc-details)  .
- The payment must be captured. Know more about [capturing payments](/razorpay-docs-md/payments/capture-settings.md)  .

## Settlement Cycle

We automatically settle captured payments to the bank account you submitted to us during your [KYC verification](/razorpay-docs-md/set-up.md#2-submit-kyc-details) following our settlement cycle. The settlement cycle is subject to bank approval and can vary based on your business vertical, risk factors and so on.

![Checkout screen with details of Settlement Cycle](https://razorpay.com/docs/payments/build/browser/assets/images/dashboard-guide-settlement_cycle.jpg)
...
Razorpay allows you to accept payments in any of the [supported international currencies](/razorpay-docs-md/international-payments.md#supported-currencies).
...
![Feature Request GIF](https://razorpay.com/docs/payments/build/browser/assets/images/feature-request.gif)
...
![Settlement Life Cycle flow](https://razorpay.com/docs/payments/build/browser/assets/images/dashboard-guide-settlement_life_cycle.jpg)
...
- [View settlement details](/razorpay-docs-md/settlements/dashboard.md#view-settlements-using-dashboard)
- [Check settlements break-up](/razorpay-docs-md/settlements/dashboard.md#settlements-break-up-description)
- [Enable settlements on hold](/razorpay-docs-md/settlements/dashboard.md#enable-settlements-placed-on-hold)
- [View reports related to settlements](/razorpay-docs-md/settlements/dashboard.md#reports)

### Related Information

- [Settlements APIs](/razorpay-docs-md/settlements/apis.md)
