<!-- Source: https://razorpay.com/docs/payments/webstore/faqs -->
...
You can view the payments as and when they are made in the [Transactions Details View](/razorpay-docs-md/payment-pages/view-reports.md) of the Webstore.

![Transaction details view page for tracking payments](https://razorpay.com/docs/payments/webstore/build/browser/assets/images/payment-pages-v3-view_report.jpg)
...
If you want to show more wallets or [payment methods](/razorpay-docs-md/payment-methods.md) at Checkout, please raise a request with the [Razorpay Support team](https://razorpay.com/support/#request).
...
1. Follow [these steps](/razorpay-docs-md/international-payments/international-debit-credit-cards.md#application-process)
