<!-- Source: https://razorpay.com/docs/payments/payment-button/receipt -->

You can share payment receipts with customers through email after they complete payments using the Payment Button. The payment receipts can be generated and shared [Automatically](/razorpay-docs-md/payment-button/receipt.md#automated-receipt) or [Manually](/razorpay-docs-md/payment-button/receipt.md#manual-receipt).

Here is a sample PDF of the payment receipt.

![PDF Receipt](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-pages-receipt-receipt-example.jpg)
...
5. Navigate to the page's **Transactions Details** section. All the payments made using the Payment Button are listed here.
   ...
   ![Transaction Details](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-pages-receipt-pp-transactions-send.jpg)
...
8. Enter a reference number for the receipt as per your business requirements.
   ...
   ![Transaction Details](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-pages-receipt-pp-manual-ref.jpg)
9. Click **Send**.
...
![Payment Receipt](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-pages-receipt-email-non80g.jpg)

### Related Information [Configure 80G-enabled Payment Button Receipt](/razorpay-docs-md/payment-button/80g-receipt.md)
