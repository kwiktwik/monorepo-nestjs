<!-- Source: https://razorpay.com/docs/payments/payment-button/quick-pay -->
...
1. [Select a Template](/razorpay-docs-md/payment-button/quick-pay.md#1-select-a-template)
2. [Add Button Details](/razorpay-docs-md/payment-button/quick-pay.md#2-add-quick-pay-button-details)
...
![Payment Button types](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-quick-pay-quick-pay-1.jpg)
...
![Payment Button Details](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-quick-pay-button-details.jpg)
...
![Payment Button - Customer Details](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-quick-pay-customer-details-1.jpg)
...
2. On the pop-up page:
   ...
   3. Select **Optional Item**.
      ...
      ![Customer Details - Field Type](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-quick-pay-customer-details-2.jpg)
   4. Click **Save**.
3. To proceed, click **Save**, and then **Next**.

![Customer Details entered](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-quick-pay-customer-details-3.jpg)
...
2. Click **Create Button**.
   ...
   ![Payment Button - Review and Create](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-quick-pay-review.jpg)
...
![](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-customerpayment.gif)
...
![](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-transaction-detail.jpg)
