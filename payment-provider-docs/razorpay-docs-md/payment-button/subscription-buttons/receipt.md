<!-- Source: https://razorpay.com/docs/payments/payment-button/subscription-buttons/receipt -->
...
![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-receipt-example.jpg)

**Setting Up Payment Receipt**

Payment Receipts can be generated and shared:

- [Automatically](/razorpay-docs-md/payment-button/subscription-buttons/receipt.md#automated-receipt)
- [Manually](/razorpay-docs-md/payment-button/subscription-buttons/receipt.md#manual-receipt)
...
![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-pp-receipt-auto-settings.gif)
...
3. You can show an input field such as `Name`, `Address` and its associated value on the Receipt. To do this:
   ...
   ![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-manual-pp-receipt.gif)
4. Click **Save**.
...
![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-email-non80g.jpg)
