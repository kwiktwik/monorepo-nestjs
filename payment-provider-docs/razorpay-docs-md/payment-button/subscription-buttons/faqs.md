<!-- Source: https://razorpay.com/docs/payments/payment-button/subscription-buttons/faqs -->
...
- Raise a request with [Support team](https://razorpay.com/support/)

  to enable Subscriptions Button.
...
2. Click the **Subscription Buttons** tab, and then click the required button. The button details view appears.
3. Scroll down, and then click **One-Time Payments** tab.
4. Click **Export All (CSV)**.
...
You cannot setup a one-time payment subscription button. For one-time payment, please use [Payment Button](/razorpay-docs-md/payment-button.md).
...
You can view the payments as and when they are made in the [Transactions Details View](/razorpay-docs-md/payment-button/view-reports.md) of the Subscription Button.
...
Raise a request on the Dashboard to display more [payment methods](/razorpay-docs-md/dashboard/account-settings/payment-methods.md#request-for-payment-methods-and-support) on Checkout.
...
You can accept payments in international currency using Subscription Button. Refer to the [list of supported currencies](/razorpay-docs-md/international-payments.md#supported-currencies). Follow these steps:

1. Raise a request with [Razorpay Support](https://razorpay.com/support/#request)

   to enable international payments for your account.
