<!-- Source: https://razorpay.com/docs/payments/payment-button/subscription-buttons/80g-receipt -->
...
- [Automatically](/razorpay-docs-md/payment-button/subscription-buttons/80g-receipt.md#automated-receipt)
- [Manually](/razorpay-docs-md/payment-button/subscription-buttons/80g-receipt.md#manual-receipt)
...
3. You can show an input field such as `Name`, `Address` and its associated value on the Receipt. To do this:
   ...
   ![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-pp-receipt-80g-setting.gif)
...
5. Use the **Click here** link to add relevant 80-G text to be displayed in the payment receipt. This opens the **Manage 80-G** modal where you can add a description and upload the signature of the authorized signatory.
   ...
   ![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-pp-receipt-80g-sign.gif)
6. Click **Save**.
...
3. You can show an input field such as `Name`, `Address` and its associated value on the Receipt. To do this:
   ...
   ![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-80g-manual-pp-receipt.gif)
4. To issue receipts with 80-G details, enable the **Issue 80-G Receipts** option.
5. Use the **Click here** link to add relevant 80-G text to be displayed in the payment receipt. This opens the **Manage 80-G** modal where you can add a description and upload the signature of the authorized signatory.
   1. Enter the description. For example:
      Donation eligible for exemption under 80-G under IT Act 1861 .. with ID DIT(E)/2009-2010/W-110/15XX dated 24.09.2009
   ...
   ![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-80g-manual-pp-receipt-sign.gif)
6. Click **Done**.
7. Navigate to the page's **Transactions Details** screen. All the payments made using the Subscription Button are listed here.

   ![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-pp-transactions-send.jpg)
...
10. Enter a reference number for the receipt as per your business requirements.
    ...
    ![](https://razorpay.com/docs/payments/payment-button/subscription-buttons/build/browser/assets/images/payment-pages-receipt-pp-manual-ref.jpg)
11. Click **Send**.
