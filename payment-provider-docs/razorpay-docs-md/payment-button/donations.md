<!-- Source: https://razorpay.com/docs/payments/payment-button/donations -->
...
1. [Select a Template](/razorpay-docs-md/payment-button/donations.md#1-select-a-template)
2. [Add Button Details](/razorpay-docs-md/payment-button/donations.md#2-add-button-details)
...
![Dashboard - Payment Button](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-payment-button-dashboard.jpg)

1.3 Click **+ Create Payment Button**.

1.4 On the **Button Creation Wizard**, select the **Donations** button type.

![Select Payment Buttons type](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-donations-button-donations-button-template.jpg)
...
![Payment Button details](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-donations-button-button-detail.jpg)
...
![Enter donation amount](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-donations-button-amount.jpg)
...
![Enter customer details](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-donations-button-customer-details.jpg)
...
2. Click **Create Button**.
   ...
   ![Payment Button - Review and Create](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-donations-button-review.jpg)
3. After completing the steps, the button code appears. Copy this code and add it in your webpage.

   ![Button created successfully](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-pb-success.jpg)
...
![](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-embed-min.gif)
...
![Donor Interaction GIF](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-customerpayment.gif)
...
![Transaction details on Razorpay Dashboard](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-donations-button-transaction-detail.jpg)
