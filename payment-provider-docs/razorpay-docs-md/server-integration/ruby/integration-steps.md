<!-- Source: https://razorpay.com/docs/payments/server-integration/ruby/integration-steps -->
...
![Configure Ruby integrated payment gateway checkout based on your requirement](https://razorpay.com/docs/payments/server-integration/ruby/build/browser/assets/images/web-integration-checkout-new.jpg)
...
Integrate with your Ruby-based website.
...
- You can create an order using the [Orders API](/razorpay-docs-md/server-integration/ruby/integration-steps.md#api-sample-code)
...
You can capture payments automatically with one-time [Payment Capture setting configuration](/razorpay-docs-md/server-integration/ruby/integration-steps.md#3-go-live-checklist) on the Dashboard.
...
Test your integration using these [test cards](/razorpay-docs-md/server-integration/ruby/integration-steps.md#2-test-integration).
...
The way the Payment Success and Failure scenarios are handled depends on the [Checkout Sample Code](/razorpay-docs-md/server-integration/ruby/integration-steps.md#122-code-to-add-pay-button) you used in the last step.
...
![Check if the payment id is generated and the status is captured](https://razorpay.com/docs/payments/server-integration/ruby/build/browser/assets/images/testpayment.jpg)

### 2. Test Integration

After the integration is complete, a **Pay** button appears on your webpage/app.

![Test integration on your webpage/app](https://razorpay.com/docs/payments/server-integration/ruby/build/browser/assets/images/test-int.gif)
