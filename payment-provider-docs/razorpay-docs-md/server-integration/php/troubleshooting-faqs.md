<!-- Source: https://razorpay.com/docs/payments/server-integration/php/troubleshooting-faqs -->
...
You can integrate Razorpay with Laravel using [Razorpay PHP SDK](/razorpay-docs-md/server-integration/php.md) which is compatible with Laravel and other PHP frameworks.
