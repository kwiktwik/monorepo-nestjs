<!-- Source: https://razorpay.com/docs/payments/smart-collect/va-vpa-qr -->
...
![](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/smart-collect-smart-collect-flow1.jpg)

**Note**

Payments made using Smart Collect largely follow existing Razorpay [payment flow](/razorpay-docs-md/payment-gateway/how-it-works.md). If you are new to Razorpay, it is recommended to understand this flow before you proceed to read the document.
...
You can consider a payment to be successful only when you receive the notification from Razorpay. You can check the [payment status on the Dashboard](/razorpay-docs-md/smart-collect/va-vpa-qr/dashboard/create.md#view-payments). Also, you can choose to configure [webhooks](/razorpay-docs-md/smart-collect/va-vpa-qr/notification.md) and subscribe to the `virtual_account.credited` event to receive notifications when customers make payments.

![](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/smart-collect-sc_workflow1.jpg)
...
- Username
  ...
  - Merchant Prefix
    `payto00000` is the standard merchant prefix. You can opt for a custom, 4-10 character merchant prefix as per your brand requirements. For example, `acmevendor`. Contact [Razorpay Support](https://razorpay.com/support)

    to get this configured for your Razorpay account.
  - Descriptor
...
![](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/smart-collect-QrCode.jpeg)
...
When first created via [Dashboard](/razorpay-docs-md/smart-collect/va-vpa-qr/dashboard/create.md) or [API](/razorpay-docs-md/smart-collect/va-vpa-qr/api/create.md), a Virtual Accounts is said to be in the `active` status. That is, it is ready to accept payments.

## Closed

A Virtual Accounts can be closed in two ways:

- Automatically, by using the `close_by` option at the time of Virtual Accounts creation, via [Dashboard](/razorpay-docs-md/smart-collect/va-vpa-qr/dashboard/create.md)

  or [API](/razorpay-docs-md/smart-collect/va-vpa-qr/api/create.md)  .
- Manually, from the [Dashboard](/razorpay-docs-md/smart-collect/va-vpa-qr/dashboard/close.md)

  or using the [API](/razorpay-docs-md/smart-collect/va-vpa-qr/api/close.md)  .

Once the account is in `closed` state, customers cannot make payments to that account.

See [API Endpoints](/razorpay-docs-md/smart-collect/va-vpa-qr/api.md) for more details.
