<!-- Source: https://razorpay.com/docs/payments/smart-collect/va-vpa-qr/refunds -->
...
You can initiate refunds from the [Dashboard](/razorpay-docs-md/smart-collect/va-vpa-qr/dashboard/refund.md) or using [APIs](/razorpay-docs-md/smart-collect/va-vpa-qr/api/refunds.md).
