<!-- Source: https://razorpay.com/docs/payments/smart-collect/create -->
...
3. Select the type of receiver in **Methods to accept payments in this customer identifier**. Only Bank Transfer (NEFT, RTGS, IMPS) is live, and enabled by default.
   ...
   ![Create Customer Identifier](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/create-ci-smart-collect.jpg)
...
7. You can set a closure date for the Customer Identifier using the **Close By** option. Click **Disable Auto Close** option and select the date and time at which the account must be automatically closed. Ensure that the time specified is at least 15 minutes after the creation time.
   ...
   ![Set a Close-by date for your Virtual Account](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/smart-collect-close-by-date.jpg)
8. Click **Add Internal Note** to enter any notes for internal reference.
9. Click **Create Customer Identifier**.

![Customer Identifier Created](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/smart-collect-va_list.jpg)
...
![Created CI list](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/smart-collect-va-created-list.jpg)
...
3. Complete these steps to add account details for the **Third Party Validation**:
   ...
   1. Select the **Bank Transfers (NEFT, RTGS, IMPS)** checkbox to create Customer Identifier details with TPV for bank transfers. Know more about [Third Party Validation](/razorpay-docs-md/smart-collect/third-party-validation.md)      .
   2. Click **Configure** to add details of **Authorised Accounts**.

      ![Smart Collect TPV](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/smart-collect-tpv.jpg)
   3. Enter **IFSC Code** and **Account Number**.

      ![TPV - Add Bank Account no and IFSC](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/smart-collect-authorised_accounts.jpg)
...
2. Navigate to **Smart Collect** in the left menu → click **+ Create Customer Identifier**.

   ![ Dashboard create SC 2.0 Customer Identifier](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/payments-sc2-create-ci.jpg)
3. Select the type of receiver in **Methods to accept payments in this customer identifier**. Both **Bank Transfers (NEFT, RTGS, IMPS)** and **UPI Transfer** are enabled by default. You can choose to disable either as needed.

   - Enable **Bank Transfer (NEFT, RTGS, IMPS)** to create a Customer Identifier.
   - Enable **UPI Transfer** to create a virtual UPI ID.

   ![Create Customer Identifier](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/smart-collect-create_ci.jpg)
4. Select **Customer** from the drop-down list. You can also create a new customer instantly. This is an optional step. Select the **Add Billing Address** check box if necessary.
   ...
   **Watch Out!**
   ...
   #### [Configure Advance Options](/razorpay-docs-md/smart-collect/create.md#Configure Advance Options)
...
5. Click **Create Customer Identifier**.
...
![Smart Collect 2 Customer Identifier success](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/payments-sc2-ci-create-success.jpg)
...
1. Follow the steps to [create Smart Collect 2.0 Customer Identifiers](/razorpay-docs-md/smart-collect/create.md#to-create-smart-collect-20-customer-identifiers)   .
2. Click **View Advance Options**.
3. Click **Configure** for **Third Party Validation**.
4. In the **Authorised Accounts** pop-up modal, **IFSC Code** and **Account Number**. You can add up to 10 accounts.

   For RBL banks, ensure the fifth character in the IFSC is number `0` and not the letter O.
5. Click **Save**.

   ![SC 2.0 Customer Identifier with TPV](https://razorpay.com/docs/payments/smart-collect/build/browser/assets/images/payments-sc2-ci-tpv.jpg)
6. Add other Advance Options as necessary.
7. Click **Create Customer Identifier**.

This successfully creates a [Customer Identifiers with TPV](/razorpay-docs-md/smart-collect/create-tpv.md).

**Handy Tips**

- After you create a Customer Identifier, it moves to `active` status. Know more about the [states of Customer Identifiers](/razorpay-docs-md/smart-collect/states.md)  .
- You can disable/ [close a Customer Identifier using APIs](/razorpay-docs-md/api/payments/smart-collect/close.md)

  if you no longer need it to accept payments.
