<!-- Source: https://razorpay.com/docs/payments/smart-collect/faqs -->
...
You can fetch the `allowed_payers` list using [Webhook](/docs/webhooks/smart-collect/) or API response.
...
You can open a [Current account](/docs/x/account-types/current-account/)

/ [Escrow account](/docs/x/account-types/escrow/) with Yes Bank or Axis Bank.

5. How do I make payouts from the Escrow/Current account?

You can make payouts using the [Payouts APIs](/docs/x/payouts/api/).
...
We collect the Smart Collect 2.0 usage fee from your [Fee Credits](/razorpay-docs-md/dashboard/account-settings/credits.md#fee-credits). If your Fee Credits are low, we charge it from your [settlement](/razorpay-docs-md/settlements.md#settlement-cycle).
