<!-- Source: https://razorpay.com/docs/payments/subscriptions/plugins/magento -->
...
Click the below button to download the Magento plugin. [Magento](https://github.com/razorpay/subscriptions-magento-plugin/releases)
...
- Razorpay Subscriptions is based on the existing Razorpay [payment flow](/razorpay-docs-md/payment-gateway/how-it-works.md)

  process. If you are new to Razorpay, we recommend you to understand this flow before you read further.
...
1. [Install the Razorpay Subscriptions for Magento Plugin](/razorpay-docs-md/subscriptions/plugins/magento.md#install-the-razorpay-subscriptions-for-magento-plugin)

   .
2. [Configure Magento Store](/razorpay-docs-md/subscriptions/plugins/magento.md#configure-magento-store)

   .
3. [Create a Plan for a Subscription Product](/razorpay-docs-md/subscriptions/plugins/magento.md#create-a-plan-for-subscription-product)

   .
4. [Enable Subscriptions for your Product](/razorpay-docs-md/subscriptions/plugins/magento.md#configure-your-product-for-subscriptions)

   .
5. [Test it out - Sign up for a Subscription](/razorpay-docs-md/subscriptions/plugins/magento/test-it-out.md)

   .

On the Razorpay Dashboard:

1. [Enable Webhooks](/razorpay-docs-md/subscriptions/plugins/magento.md#enable-webhooks)
...
1. Download the `code.zip` file from the [latest release](https://github.com/razorpay/subscriptions-magento-plugin/releases)
...
2. Click **Stores** in the left menu and navigate to **Settings** → **Configuration**.
   ...
   ![](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/sub_config_magento_configuration.jpg)
3. Expand **Sales** in the left menu and click **Payment Methods**.

   ![](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/sub_config_magento_payment_meth.jpg)
4. Go to **Razorpay** in the **Payment Methods** page.
5. Enter your test mode [KEY\_ID] and [KEY\_SECRET]. These can be generated from your Dashboard.
...
7. Select **Yes** from the **Enabled** drop-down list to enable the option to sell the Subscriptions.
   ...
   ![](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/sub_config_magento_enable_rzp.jpg)
8. Click **Save Config**.
...
2. Navigate to **Razorpay Subscription** → **Manage Plans**.
   ...
   ![](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/sub_magento_manage_palns.jpg)
3. Click **Add New Plan**.
4. Enter the all the required details.
5. Click **Save Plan**.

   ![](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/sub_magento_plan_save.jpg)

**Watch Out!**

You can enable or disable a plan only after it is created.

![](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/sub_magento_enable_disable_plan.jpg)
...
2. Navigate to **Catalog** → **Products**.
   ...
   ![](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/sub_magento_catalog_products.jpg)
...
4. Enable the Subscription on the product level. You can select the Subscription mode. Following are the options available.
   - **Subscription Only:** Customers will get an option of only a Subscription with a respective plan, and they will be unable to buy a product for one time.
     ...
     ![](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/sub_magento_sub_only.jpg)
   - **With Subscription:** Customers will have both the option for buying a product once for all and a Subscription.

     ![](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/sub_magento_sub_one_time.jpg)
...
1. Go to your [Magento website](https://business.adobe.com/products/magento/magento-commerce.html/)

   and select the product which you have enabled for Subscription.
...
For details of available events and sample payloads, refer to the [Webhook Events section](/razorpay-docs-md/payment-gateway/ecommerce-plugins/woocommerce/troubleshooting-faqs.md).
...
3. Click the **+ Add New Webhook** button.
   ...
   ![Add a new webhooks button on the Dashboard](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/webhooks-webhook-creation-1.jpg)
4. In the **Webhook Setup** pop-up page:
   ...
   ![List of active webhook events on Razorpay Dashboard](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/webhooks-webhook-creation-2.jpg)
5. Click **Create Webhook**. After you set up a webhook, it appears on the list of webhooks.

   ![List of webhooks on Razorpay Dashboard](https://razorpay.com/docs/payments/subscriptions/plugins/build/browser/assets/images/webhooks-webhooks-list.jpg)
