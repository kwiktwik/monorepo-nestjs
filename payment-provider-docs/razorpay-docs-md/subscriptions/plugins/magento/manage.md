<!-- Source: https://razorpay.com/docs/payments/subscriptions/plugins/magento/manage -->
...
![](https://razorpay.com/docs/payments/subscriptions/plugins/magento/build/browser/assets/images/rzp-subscriptions-plugin-rzp-subs-plugin-16.jpg)
...
![](https://razorpay.com/docs/payments/subscriptions/plugins/magento/build/browser/assets/images/rzp-subscriptions-plugin-rzp-subs-plugin-17.jpg)

Once an existing subscription is cancelled, it cannot be restarted.

![](https://razorpay.com/docs/payments/subscriptions/plugins/magento/build/browser/assets/images/rzp-subscriptions-plugin-rzp-subs-plugin-18.jpg)
...
If you need to refund money to a customer for any reason, you need to do this manually from the [Razorpay Dashboard](/razorpay-docs-md/payments/dashboard.md#issue-refunds).
