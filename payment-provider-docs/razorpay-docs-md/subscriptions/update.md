<!-- Source: https://razorpay.com/docs/payments/subscriptions/update -->

You can update Subscriptions from the [Dashboard](/razorpay-docs-md/subscriptions/update.md#update-a-subscription-from-dashboard) or using [APIs](/razorpay-docs-md/api/payments/subscriptions.md#update-a-subscription).
...
- `Subscription Start Date` for the updated Subscription details. This can either be immediate or any future date. You can choose to update a Subscription:
  - [Immediately](/razorpay-docs-md/subscriptions/update.md#update-subscriptions-immediately)
  - [At the end of the current billing cycle](/razorpay-docs-md/subscriptions/update.md#update-subscription-at-the-end-of-the-current)
...
- You can only update Subscriptions in the `authenticated` and `active` states. Subscriptions in the `created`, `pending` or `halted` state cannot be updated. There is no state change when a Subscription is updated. Know more about the [Subscription states.](/razorpay-docs-md/subscriptions/states.md)
...
- [Charge the customer an extra amount](/razorpay-docs-md/subscriptions/update.md#charge-a-customer-extra)
- [Refund an amount to the customer](/razorpay-docs-md/subscriptions/update.md#refund-money-to-a-customer)
...
- If you are updating a Subscription, ensure that the prorated amount difference between the existing and new plans is at least 50 currency subunits, that is, ₹0.50. You will get an error if the amount difference between the two plans is less than ₹0.50.
...
In this example, you have to charge the customer an extra amount of ₹18,270.
...
In this example, you have to charge the customer an extra amount of ₹1,760.
...
Use the [Update a Subscription API](/razorpay-docs-md/api/payments/subscriptions/update-subscription.md) to update a Subscription.
