<!-- Source: https://razorpay.com/docs/payments/subscriptions/faqs -->
...
- [Subscriptions plugin for WooCommerce](/razorpay-docs-md/subscriptions/plugins/woocommerce.md)
- [Subscriptions plugin for WooCommerce Build Integration](/razorpay-docs-md/subscriptions/plugins/woocommerce/build-integration.md)
...
Yes, the WooCommerce Subscriptions plugin depends on the Razorpay WooCommerce plugin. The WooCommerce Subscriptions plugin is fully compatible with Razorpay WooCommerce plugin equal to or greater than v2.4, including the latest v3.0 release. Know more about [plugin dependencies](/razorpay-docs-md/subscriptions/plugins/woocommerce.md#plugin-dependencies).
...
3. Click the **Duplicate Plan** icon in the top-right corner of the pop-up, as shown in the screenshot below.
   ...
   ![Plan duplicate option on Subscription plan duplicate page](https://razorpay.com/docs/payments/subscriptions/build/browser/assets/images/subscription_plan_duplicate.jpg)
...
Yes. You can update details such as the plan amount, duration and quantity of a Subscription, even if it is live. Refer to the [Update Subscription section](/razorpay-docs-md/subscriptions/update.md) for more details.
...
You can only update a Subscription when it is in `authenticated` and `active` states. There is no state change when you update a Subscription. Know about [Updating a Subscription](/razorpay-docs-md/subscriptions/update.md).
...
Subscriptions in the `active` state can be paused. You cannot pause a Subscription in any other state. Refer to the [life cycle](/razorpay-docs-md/subscriptions/states.md) section for more details.

3. How can I pause a Subscription?

You can pause a Subscription:

- [From the Dashboard](/razorpay-docs-md/subscriptions/pause-resume-cancel.md#pause-subscription-via-the-dashboard)

  .
- [Using APIs](/razorpay-docs-md/api/payments/subscriptions.md#pause-a-subscription)
...
- [From the Dashboard](/razorpay-docs-md/subscriptions/pause-resume-cancel.md#resume-subscription-via-the-dashboard)

  .
- [Using APIs](/razorpay-docs-md/api/payments/subscriptions.md#resume-a-subscription)
...
- [From the Dashboard](/razorpay-docs-md/subscriptions/pause-resume-cancel.md)

  .
- [Using APIs](/razorpay-docs-md/api/payments/subscriptions.md#cancel-a-subscription)
...
You can set up the [subscription.cancelled](/docs/webhooks/subscriptions/#subscription-cancelled) webhook event to get a notification when your customer cancels their Subscription. Know more about [subscribing to a webhook event](/razorpay-docs-md/subscriptions/subscribe-to-webhooks.md).
...
Refer to the [list of banks that support cards](/razorpay-docs-md/subscriptions/supported-banks-apps.md#cards).
...
![Error message when card does not support recurring payments](https://razorpay.com/docs/payments/subscriptions/build/browser/assets/images/cards-mandatehq-error-sub.jpg)
...
Refer to the [Subscriptions document](/razorpay-docs-md/subscriptions.md) for more information.
...
![Sample pre-debit notification](https://razorpay.com/docs/payments/subscriptions/build/browser/assets/images/cards-mandatehq-pre-debit.jpg)
...
To process debits of amounts above ₹15,000 (upto ₹1,00,000 for [certain merchant categories](/razorpay-docs-md/subscriptions/supported-banks-apps.md#supported-mccs)
...
![Customer flow for consent through AFA link](https://razorpay.com/docs/payments/subscriptions/build/browser/assets/images/cards-mandatehq.gif)
...
2. Click **Mandate summary page** under **Checkout settings**.
   ...
   ![Mandate summary page option under Checkout settings](https://razorpay.com/docs/payments/subscriptions/build/browser/assets/images/mandate_settings.jpg)
3. Enable the **Show Mandate Summary Page for Cards** option.

   ![Enable show Mandate Summary Page for cards option](https://razorpay.com/docs/payments/subscriptions/build/browser/assets/images/show_mandate_cards_rp.jpg)
...
RuPay SI requires payment processors/aggregators and banks to work with NPCI to enable the support. NPCI is continuously working with more banks to support recurring payments on RuPay cards. Refer to the [Supported Banks and Apps](/razorpay-docs-md/subscriptions/supported-banks-apps.md#cards) document for the list of supported banks.
...
**\*** Due to [payment retries](/razorpay-docs-md/subscriptions/payment-retries.md#retry-model-for-upi), this may extend to T+1.
...
For certain MCCs, the maximum amount limit for one transaction is ₹1,00,000. Refer to the [the list of supported MCCs](/razorpay-docs-md/subscriptions/supported-banks-apps.md#supported-mccs), issuing banks and PSP applications.

19. What is the supported amount limit on PSP applications?

20. Is QR Code supported for UPI Autopay?

Yes, [QR Code](/razorpay-docs-md/subscriptions/qr-codes.md) is supported on Standard Checkout to collect Subscription payments. The customers can scan the QR using any PSP app and make the payment.
...
![Checkout with OC125 Enabled](https://razorpay.com/docs/payments/subscriptions/build/browser/assets/images/upi_oc125.jpg)
...
Currently, Subscription through Emandate is available for a few banks. Refer to the [Supported Banks and Apps](/razorpay-docs-md/subscriptions/supported-banks-apps.md) page for more information.
...
Razorpay supports eSign as an [authentication type](/razorpay-docs-md/subscriptions/supported-banks-apps.md#emandate) for the Aadhaar authentication.
...
know more about [Subscription Offers](/razorpay-docs-md/subscriptions/offers.md).
...
Yes. You can [link an offer to a Subscription after it has gone live](/razorpay-docs-md/subscriptions/offers/link.md#link-offer-to-an-existing-subscription).
...
Yes. You can accept Subscription payments in any of the [supported currencies](/razorpay-docs-md/international-payments.md#supported-currencies).
...
Refer to our [International Payments page](/razorpay-docs-md/international-payments.md) for more details.
