<!-- Source: https://razorpay.com/docs/payments/recurring-payments/create -->
...
![Feature Request GIF](https://razorpay.com/docs/payments/recurring-payments/build/browser/assets/images/feature-request.gif)

To create a recurring payment:

1. [Create a registration link](/razorpay-docs-md/recurring-payments/create.md#1-create-a-registration-link)
2. [View the payment status](/razorpay-docs-md/recurring-payments/create.md#2-view-the-payment-status)
3. [Search for the token](/razorpay-docs-md/recurring-payments/create.md#3-search-for-the-token)
4. [Charge the token](/razorpay-docs-md/recurring-payments/create.md#4-charge-the-token)
...
You can create registration links using APIs. Refer to the [API section](/razorpay-docs-md/api/payments/recurring-payments.md) for more details.
...
- [Batch Operations](/razorpay-docs-md/recurring-payments/batch-operations.md)
