<!-- Source: https://razorpay.com/docs/payments/recurring-payments/emandate/faqs -->
...
![NPCI eNACH registration flow diagram](https://razorpay.com/docs/payments/recurring-payments/emandate/build/browser/assets/images/enach-registration.jpg)
...
![](https://razorpay.com/docs/payments/recurring-payments/emandate/build/browser/assets/images/emandate-registration.jpg)
...
- Delete the mandate token using [Dashboard](/razorpay-docs-md/recurring-payments/create.md#delete-the-token)

  or [APIs](/razorpay-docs-md/api/payments/recurring-payments/emandate/tokens.md#23-delete-tokens)  .
- Razorpay will initiate cancellation for the deleted tokens on the next working day.
- On acknowledgement from NPCI for cancellation, you will receive a 'Token Cancelled' [webhook](/razorpay-docs-md/api/payments/recurring-payments/webhooks.md#token-cancelled)  , which can be taken as a confirmation of mandate cancellation.

  ![](https://razorpay.com/docs/payments/recurring-payments/emandate/build/browser/assets/images/emandate-faq-5.jpg)
...
Know more about [Subscriptions](/razorpay-docs-md/subscriptions.md).
...
You can refer to the [Supported Banks](/razorpay-docs-md/recurring-payments/emandate/supported-banks.md) page for the list of supported banks for Emandates.
...
![](https://razorpay.com/docs/payments/recurring-payments/emandate/build/browser/assets/images/debit_presentment_enach.jpg)
...
Payments have to be `captured` for the corresponding settlement to take place. You can manually capture the payment from the [Dashboard](/razorpay-docs-md/payments/capture-settings.md#manually-capture-payments).

Alternatively, to avoid manual dependency, you can enable Auto Capture for all your payments from the Dashboard.

Know more about [Capture Settings](/razorpay-docs-md/payments/capture-settings.md#auto-capture-all-payments).
