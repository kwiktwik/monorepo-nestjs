<!-- Source: https://razorpay.com/docs/payments/widgets/buyer-protection/shopify -->

[Razorpay Buyer Protection Widget on Shopify Changelog

Discover new features, updates and deprecations related to RazorpayBuyer Protection Widget on Shopify (since Jan 2024).](/razorpay-docs-md/changelog.md#widgets) [Troubleshooting & FAQs

Find answers to frequently asked questions about Razorpay Buyer Protection.](/razorpay-docs-md/widgets/buyer-protection/faqs.md)
...
- Log in to the Dashboard and [generate the API keys](/razorpay-docs-md/api/authentication.md#generate-api-keys)
...
2. Search for Razorpay Trusted Business or install the app directly from the [Shopify app store](https://apps.shopify.com/razorpay-trusted-badges)   .
   ...
   ![Shopify RTB App Install](https://razorpay.com/docs/payments/widgets/buyer-protection/build/browser/assets/images/shopify-rtb-app-install.jpg)
...
3. After installing the app, you will be directed to your Shopify store. Enter your Razorpay Live API Key ID and click **Save**. This step is necessary to verify your eligibility for the widget. Know how to [generate API Keys](/razorpay-docs-md/api/authentication.md#generate-api-keys)

   from the Dashboard.

   ![Live api key id](https://razorpay.com/docs/payments/widgets/buyer-protection/build/browser/assets/images/live-api-key-id.jpg)
   ...
   **Handy Tips**
   ...
   ![Shopify theme editor page](https://razorpay.com/docs/payments/widgets/buyer-protection/build/browser/assets/images/shopify-widget-theme-editor.jpg)
...
5. Navigate to **Apps** and select **rtb-widget** (Razorpay Trusted Business). The customers will be able to view the widget below the product price.
   ...
   ![Shopify default product page - buyer protect widget](https://razorpay.com/docs/payments/widgets/buyer-protection/build/browser/assets/images/buyer-protect.gif)
...
![Glimpse of the default widget](https://razorpay.com/docs/payments/widgets/buyer-protection/build/browser/assets/images/widgets-buyer-protect.jpg)
...
![View the Buyer Protect widget on desktop](https://razorpay.com/docs/payments/widgets/buyer-protection/build/browser/assets/images/buyer-widget-desktop.jpg)

On Mobile

![View the Buyer Protect widget on mobile](https://razorpay.com/docs/payments/widgets/buyer-protection/build/browser/assets/images/buyer-widget-mobile.jpg)

### Related Information

- [Money Back Promise](/razorpay-docs-md/widgets/buyer-protection/money-back-promise.md)
- [FAQs](/razorpay-docs-md/widgets/buyer-protection/faqs.md)
