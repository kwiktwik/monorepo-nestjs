<!-- Source: https://razorpay.com/docs/payments/widgets/trusted-business -->
...
![View the RTB widget on desktop](https://razorpay.com/docs/payments/widgets/build/browser/assets/images/rtb-widget-desktop.jpg)
...
![RTB Widget Flow Diagram](https://razorpay.com/docs/payments/widgets/build/browser/assets/images/rtb-widget-flow.jpg)

## Prerequisites

- Create a [Razorpay account](https://dashboard.razorpay.com/signup)  .
- Generate the API Keys on the Dashboard. You can use the [Test Mode keys](/razorpay-docs-md/api/authentication.md#live-mode-api-keys)

  to test the integration and preview the Widget. Later, switch to **Live Mode** on the Dashboard, generate the [Live API keys](/razorpay-docs-md/api/authentication.md#live-mode-api-keys)

  and replace it with the test keys.
- Check if you are [eligible](/razorpay-docs-md/payment-gateway/features/trusted-business.md#eligibility-requirements)

  for Razorpay Trusted Business on the Dashboard.
...
- Currently, the RTB widget is supported on Web and [shopify](/razorpay-docs-md/widgets/trusted-business/rtb-widget-shopify.md)  .
...
```javascript
<razorpay-trusted-business key="rzp_test_XXXX00000XXXX"></razorpay-trusted-business>
```
...
```java
<razorpay-trusted-business dark-mode="true" key="rzp_test_XXXX00000XXXX" hide_attributes="age, transaction_history, return_policy"></razorpay-trusted-business>
```
...
After you preview and test the widget on your Dashboard, switch to the live mode to generate live API keys. Replace the test keys with these live keys to take the integration live. Know more about [live API keys](/razorpay-docs-md/api/authentication.md#live-mode-api-keys).
...
- Here is a glimpse of the default widget:
  ...
  ![View the RTB widget on mobile](https://razorpay.com/docs/payments/widgets/build/browser/assets/images/rtb-widget-mobile.jpg)
- Here is a glimpse of the RTB website:

  On Web

  ![Desktop view of the RTB website for more information](https://razorpay.com/docs/payments/widgets/build/browser/assets/images/rtb-widget-website-desktop.jpg)

  On Mobile

  ![Mobile view of the RTB website for more information](https://razorpay.com/docs/payments/widgets/build/browser/assets/images/rtb-widget-website-mobile.jpg)
