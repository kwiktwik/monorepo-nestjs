<!-- Source: https://razorpay.com/docs/payments/payments/late-authorisation/handle -->
...
Auto refunds are issued within 5 days. However, if you want to issue a refund instantly, you can capture the payment and issue a refund as per your requirements. Know more about [Refunds](/razorpay-docs-md/refunds.md).
...
- Setup custom timeouts for automatic and [manual capture](/razorpay-docs-md/payments/capture-settings/api.md)  .
...
- Allows you to auto-capture payments based on the parameters passed in the [Orders API](/razorpay-docs-md/payments/capture-settings/api.md)  . Capture values passed in the Orders API take precedence over the Payment Capture settings configured on the Dashboard.
...
You can send email notifications to your customers about the payment status, asking them to take further action to deliver the service. You can set up webhooks from the Dashboard. Know more about [webhooks](/docs/webhooks/).
...
- [Payment capture settings on the Dashboard](/razorpay-docs-md/payments/capture-settings.md)
...
- [Late Authorisations](/razorpay-docs-md/payments/late-authorisation.md)
