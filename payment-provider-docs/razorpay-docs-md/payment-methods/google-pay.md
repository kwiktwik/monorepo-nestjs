<!-- Source: https://razorpay.com/docs/payments/payment-methods/google-pay -->
...
**1. CRYPTOGRAM\_3DS Flow (Device-Tokenised Cards):**
...
**2. PAN\_ONLY Flow (Stored Card Details):**
...
- Follow [Google Pay Android brand guidelines](https://developers.google.com/pay/api/android/guides/brand-guidelines)
...
![Google Pay payment flow](https://razorpay.com/docs/payments/payment-methods/build/browser/assets/images/google-pay-payment-flow.gif)
