<!-- Source: https://razorpay.com/docs/payments/payment-methods/zip/s2s-integration -->
...
![Feature Request GIF](https://razorpay.com/docs/payments/payment-methods/zip/build/browser/assets/images/feature-request.gif)
