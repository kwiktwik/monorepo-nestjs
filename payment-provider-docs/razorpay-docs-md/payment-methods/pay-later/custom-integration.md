<!-- Source: https://razorpay.com/docs/payments/payment-methods/pay-later/custom-integration -->
...
- The [Razorpay Custom Checkout](/razorpay-docs-md/payment-gateway/web-integration/custom.md)

  should be integrated on your website or app.
...
After an order is created and the customer's payment details are received, the information should be sent to Razorpay to complete the payment. You can do this by invoking `createPayment` and passing `method=paylater` and `provider=<provider_name>`.
