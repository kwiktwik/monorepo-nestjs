<!-- Source: https://razorpay.com/docs/payments/payment-methods/upi/faqs -->
...
- [Standard Integration](/docs/announcements/upi-collect-migration/standard-integration/)

  .
- [Custom Integration](/docs/announcements/upi-collect-migration/custom-integration/)
- [S2S Integration](/docs/announcements/upi-collect-migration/s2s-integration/)
...
- **Self-Serve Accounts**: Raise a support ticket via your [Razorpay Dashboard](https://dashboard.razorpay.com)

  or email [[support@razorpay.com](mailto:support@razorpay.com)](mailto:support@razorpay.com)
...
- Refer to the [Standard Checkout migration guide](/docs/announcements/upi-collect-migration/standard-integration/)
...
- You might have made a request using a non-owner role. Please log in as an owner and try again. See [Manage Team](/razorpay-docs-md/dashboard/account-settings/manage-team.md)  .
- If the issue persists, clear your cookies and retry.

If you still receive an error, reach out to the [Razorpay Support team](https://razorpay.com/support/).
...
See [UPI Payment Methods](/razorpay-docs-md/payment-methods/upi.md).

3. Which UPI apps does Razorpay support?

Here is the [list of supported UPI apps](/razorpay-docs-md/payment-methods/upi/supported-apps.md).
