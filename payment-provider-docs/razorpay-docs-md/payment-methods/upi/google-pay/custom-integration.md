<!-- Source: https://razorpay.com/docs/payments/payment-methods/upi/google-pay/custom-integration -->
...
3. Verify your VPA (UPI ID) details on the [Google Merchant Console](https://support.google.com/pay/business/answer/7684398?hl=en&ref_topic=7684388)   . Google deposits a small amount into the bank account linked to your VPA (UPI ID).
...
On desktop browsers, the Collect request flow works the same way as [Razorpay's UPI](/razorpay-docs-md/payment-gateway/web-integration/custom/payment-methods.md#upi).
...
![](https://razorpay.com/docs/payments/payment-methods/upi/google-pay/build/browser/assets/images/gpay-mweb-customui.jpg)
...
```
   ...
   Know more about [Custom Web Integration](/razorpay-docs-md/payment-gateway/web-integration/custom.md)   .
...
Refer to the [Success/Error Callbacks](/razorpay-docs-md/payment-gateway/web-integration/custom/build-integration.md#14-store-fields-in-your-server) section for more details.
...
Additionally, if you want to open Google Pay within your application for customers to make the payment without any redirection, you can do so by integrating with [Google Pay SDK](/razorpay-docs-md/payment-methods/upi/google-pay/custom-integration.md#intent-based-integration-using-google-pay-sdk).
...
This is the same as the existing [UPI Collect Integration](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods.md#collect-flow).
...
1. Download the [Google Pay SDK](https://rzp-1415-prod-mobile.s3.amazonaws.com/android/googlepay-sdk/google-pay-client-api-1.0.0.aar)

   and add the `.aar` files to the application library.
