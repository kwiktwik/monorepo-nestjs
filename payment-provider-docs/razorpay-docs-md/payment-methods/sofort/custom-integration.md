<!-- Source: https://razorpay.com/docs/payments/payment-methods/sofort/custom-integration -->
...
2. You can create an order using the [Orders API](/razorpay-docs-md/payment-methods/sofort/custom-integration.md#api-sample-code)   . It is a server-side API call.  Know how to [authenticate](/razorpay-docs-md/api/authentication.md#generate-api-keys)
