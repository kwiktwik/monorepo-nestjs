<!-- Source: https://razorpay.com/docs/payments/payment-methods/bharatqr/notification -->
...
Payments made using this method will also trigger webhooks much like regular payments. Refer our [Webhooks](/docs/webhooks/) documentation to learn how to use webhooks.
