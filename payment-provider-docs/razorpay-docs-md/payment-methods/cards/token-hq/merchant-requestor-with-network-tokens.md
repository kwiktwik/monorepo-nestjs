<!-- Source: https://razorpay.com/docs/payments/payment-methods/cards/token-hq/merchant-requestor-with-network-tokens -->
...
![Subsequent payment Tokenisation flow](https://razorpay.com/docs/payments/payment-methods/cards/token-hq/build/browser/assets/images/cards-tokenisation-subsequent-payment.jpg)
...
- [APIs](/razorpay-docs-md/payment-methods/cards/token-hq/merchant-requestor/apis.md)
- [Webhooks](/razorpay-docs-md/payment-methods/cards/token-hq/merchant-requestor/webhooks.md)
