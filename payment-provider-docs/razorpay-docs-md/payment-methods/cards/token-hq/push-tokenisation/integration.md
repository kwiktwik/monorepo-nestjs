<!-- Source: https://razorpay.com/docs/payments/payment-methods/cards/token-hq/push-tokenisation/integration -->
...
For more information, refer [Standard Checkout](/razorpay-docs-md/payment-gateway/web-integration/standard.md)
...
Refer to the [Fetch Token API](/razorpay-docs-md/payment-methods/cards/token-private.md) document for more information.
...
For more information, refer to the [S2S Integration - Tokenisation APIs](/razorpay-docs-md/payment-methods/cards/token-hq/merchant-requestor/apis.md) documentation.
...
To be able to create tokens using Push Tokenisation, you must create a customer using phone number as the primary identifier. For more details, refer [Create a Customer API](/razorpay-docs-md/api/customers/create.md).
...
2. Webhook Setup:
   ...
   - Watch this [tutorial video](/docs/webhooks/setup-edit-payments/)

     for detailed steps on setting up the webhook.
