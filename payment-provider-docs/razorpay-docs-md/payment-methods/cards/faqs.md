<!-- Source: https://razorpay.com/docs/payments/payment-methods/cards/faqs -->
...
Businesses can enable card payments by signing up with Razorpay, completing the KYC process, and configuring the card payment option in the [dashboard](/razorpay-docs-md/dashboard/account-settings/payment-methods.md#request-for-payment-methods).
