<!-- Source: https://razorpay.com/docs/payments/payment-methods/cards/google-pay/s2s-integration/redirect -->
...
1. Show Google Pay as a separate option when Google Pay is set up on your customer's device (Know how to [check if Google Pay Cards is available](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-3-check-if-gpay-cards-is-supported)
...
- Configure [payment capture settings](/razorpay-docs-md/payments.md#dashboard-actions)
  ...
  on the Dashboard.
- Follow the [Razorpay S2S Integration documentation](/razorpay-docs-md/payment-gateway/s2s-integration/redirect.md)  .
- You must have a PCI compliance certificate to get this feature enabled on your account.

## Integration Steps

1. [Download the SDKs](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-1-download-the-sdks)
2. [Add dependencies in Build Gradle file](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-2-add-dependencies-in-build-gradle-file)
3. [Check if GPay Cards is supported](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-3-check-if-gpay-cards-is-supported)
4. [Create an order](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-4-create-an-order)
5. [Create a payment](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-5-create-a-payment)
6. [Prepare payload for Initiating Payment to Google](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-6-prepare-payload-for-initiating-payment-to)
7. [Invoke Google Pay App](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-7-invoke-google-pay-app)
8. [Handle response from Google Pay App (optional)](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-8-handle-response-from-google-pay-app)
9. [Verify payment status](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#step-9-verify-payment-status)
...
- You can create an order using the [Orders API](/razorpay-docs-md/payment-methods/cards/google-pay/s2s-integration/redirect.md#api-sample-code)  . It is a server-side API call.  Know how to [authenticate](/razorpay-docs-md/api/authentication.md#generate-api-keys)
