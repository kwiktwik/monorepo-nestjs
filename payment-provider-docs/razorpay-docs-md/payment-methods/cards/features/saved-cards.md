<!-- Source: https://razorpay.com/docs/payments/payment-methods/cards/features/saved-cards -->
...
Know [how to integrate saved cards at Standard Checkout.](/razorpay-docs-md/payment-methods/cards/features/integrate-saved-cards.md)
...
![Feature Request GIF](https://razorpay.com/docs/payments/payment-methods/cards/features/build/browser/assets/images/feature-request.gif)
...
3. While making a card payment, the customer can choose to:
   ...
   ![Saved cards checkout flow](https://razorpay.com/docs/payments/payment-methods/cards/features/build/browser/assets/images/pm-saved-cards.gif)
...
3. They enter the OTP sent to their phone or use their fingerprint if [Biometric Authentication](/razorpay-docs-md/payment-gateway/features.md)

   biometric authentication is set up, then click **Verify**.
...
1. Log in to the [Portal](https://razorpay.com/flashcheckout/manage/)

   using their **Mobile Number** and enter your **Email**. Click **Send OTP**.
...
3. They can choose to select a card and delete the website/app on that particular card, or they can also select a website/app and delete the card on that particular website/app.
   ...
   ![Delete/Edit a card on a particular website/app.](https://razorpay.com/docs/payments/payment-methods/cards/features/build/browser/assets/images/delete-saved-card-choose.jpg)

   To delete website/app on a particular card:

   1. Select **Cards**. View a list of saved cards.

      ![View list of Saved cards](https://razorpay.com/docs/payments/payment-methods/cards/features/build/browser/assets/images/delete-saved-card-choose-card.jpg)
   ...
   1. Select **Websites/Apps**. They view a list of websites/apps they have saved their cards on earlier.
      ...
      ![View list of saved Websites/Apps](https://razorpay.com/docs/payments/payment-methods/cards/features/build/browser/assets/images/delete-saved-card-website.jpg)
   ...
   4. Click **Delete**. A pop-up appears to confirm the action, click **Yes, Delete**.
      ...
      ![Delete confirmation.](https://razorpay.com/docs/payments/payment-methods/cards/features/build/browser/assets/images/delete-saved-card-confirm.jpg)
...
![Allow Cookies](https://razorpay.com/docs/payments/payment-methods/cards/features/build/browser/assets/images/saved-cards-chrome-settings-3.jpg)
