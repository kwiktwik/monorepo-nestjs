<!-- Source: https://razorpay.com/docs/payments/payment-methods/gopay -->
...
- List of [supported region and currency](/razorpay-docs-md/payment-methods/gopay.md#supported-region-and-currency)  .
...
- You can refund customer payments made using GoPay by following the usual [refunds](/razorpay-docs-md/refunds.md)
...
Secure [S2S integration](/razorpay-docs-md/payment-methods/gopay/s2s-integration.md) for seamless payment processing.
