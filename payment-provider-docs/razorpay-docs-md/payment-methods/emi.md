<!-- Source: https://razorpay.com/docs/payments/payment-methods/emi -->
...
![Dashboard - Payment Methods Enable EMI.](https://razorpay.com/docs/payments/payment-methods/build/browser/assets/images/payment-methods-emi.jpg)

**Additional Payment Methods**

You can raise requests for [additional payment methods](/razorpay-docs-md/dashboard/account-settings/payment-methods.md#request-for-payment-methods). Know more about [Payment Methods](/razorpay-docs-md/dashboard/account-settings/payment-methods.md#request-for-payment-methods).
...
2. Select **EMI**, **No Cost EMI** or **Low Cost EMI** as the payment method as highlighted below.
   ...
   ![Select EMI or No Cost EMI option.](https://razorpay.com/docs/payments/payment-methods/build/browser/assets/images/emi-no-low-cost-emi.jpg)
3. Select a preferred EMI type, [Credit](/razorpay-docs-md/payment-methods/emi/credit-card-emi.md)   , [Debit](/razorpay-docs-md/payment-methods/emi/debit-card-emi.md)

   or [Cardless](/razorpay-docs-md/payment-methods/emi/cardless-emi.md)   .
4. Choose a bank from the list and select the EMI tenure. This flow is for Credit Card EMI. Click **Continue**.

   ![EMI tenure and click Select Plan](https://razorpay.com/docs/payments/payment-methods/build/browser/assets/images/emi-tenure-new.jpg)
...
This is a real transaction and money will be deducted from your account. However, the amount debited will be auto-refunded to your account in 5-7 working days. [Pay with Razorpay](https://razorpay.com/emidemo/)

## Test Card

You can use the test cards to test domestic payments, international payments and subscriptions. Know more about [Test Card details](/razorpay-docs-md/payments/test-card-details.md#test-card-for-emi-payments).
