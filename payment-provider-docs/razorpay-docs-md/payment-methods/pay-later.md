<!-- Source: https://razorpay.com/docs/payments/payment-methods/pay-later -->

#### Pay Later Changelog

Discover new features, updates and deprecations related to Pay Later (since Jan 2024).

Accept payments from your customers using the **Pay Later** service offered by various third-party providers.

- Know about [how to enable/disable Pay Later](/razorpay-docs-md/dashboard/account-settings/payment-methods.md#request-for-payment-methods-and-support)

  as a payment method for your account.
...
1. At the Checkout, customers enter their contact details and from the displayed list of **Pay Later** providers, customers select their preferred provider.
   ...
   ![Pay Later payment method on Checkout screen](https://razorpay.com/docs/payments/payment-methods/build/browser/assets/images/pm-paylater-checkout.jpg)
...
- Check the standard interest rates charged by [Pay Later providers](/razorpay-docs-md/payment-gateway/emi-/faqs.md#2-what-are-the-standard-interest-rates-charged)  .
