<!-- Source: https://razorpay.com/docs/payments/settlements/instant/route -->

[Instant settlements](/razorpay-docs-md/settlements/instant.md) on Route enable you to settle payments instantly to your Linked Accounts for a small fee. You can choose which Linked Account to enable instant settlements on, and all subsequent transfers to that account will be processed instantly.
...
With instant settlements, you can [create a Linked Account](/razorpay-docs-md/route/linked-account.md#add-and-manage-linked-accounts) on Route, initiate a transfer and settle the payments to them instantly.
...
- You have an [existing/created Linked Account](/razorpay-docs-md/route/linked-account.md#add-and-manage-linked-accounts)

  on Route.
- You have [disabled refunds from Linked Accounts](/razorpay-docs-md/settlements/instant/route.md#how-to-disable-refunds-for-a-linked-account)  .

**Watch Out!**

Instant Settlements on Route fail when:

- The [transfer](/razorpay-docs-md/route/faqs.md#1-how-can-i-transfer-money-to-customers)
...
2. Contact support to enable instant settlements on Route for the Linked Accounts.
3. Initiate transfers to your Linked Account.
4. The Linked Account/Vendor receives the transferred amount instantly.

   ![Instant settlements on Route How it Works](https://razorpay.com/docs/payments/settlements/instant/build/browser/assets/images/settlements-instant-route-v2.jpg)
...
2. Disable **Allow Refunds** for your Linked Accounts.
   ...
   2. Go to **Route** in the left menu.
   3. Navigate to the **Accounts** tab.
   4. View the relevant Linked Accounts and click the **Allow Refunds** toggle to disable it.

      ![Disable refunds on Razorpay Dashboard for Route](https://razorpay.com/docs/payments/settlements/instant/build/browser/assets/images/payments-is-route-disable-refunds.jpg)
   5. In the **Disable Allow Refunds** pop-up modal, click **Disable**.
...
- [Payments](/razorpay-docs-md/route/transfer-funds-to-linked-accounts.md#transfers-via-payments)
  ...
  .
- [Create Transfers from Orders API](/razorpay-docs-md/api/payments/route/create-transfers-orders.md)

  .
- [Create Transfers from Payments API](/razorpay-docs-md/api/payments/route/create-transfers-payments.md)
