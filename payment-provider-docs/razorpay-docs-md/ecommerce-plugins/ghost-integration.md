<!-- Source: https://razorpay.com/docs/payments/ecommerce-plugins/ghost-integration -->
...
2. Razorpay detects a `payment.captured` [webhook event](/docs/webhooks/payments/)   .
...
1. Sign up for a [Razorpay account](https://dashboard.razorpay.com/signup)
   ...
   (with Payment Links or Subscriptions set up).
2. Sign up for a [Zapier](https://zapier.com/sign-up)

   account (Pro plan recommended for webhook features).
3. Ensure you have a Ghost CMS account (self-hosted or Ghost Pro).

### Integration Steps

1. Set up your [Razorpay Webhook](/docs/webhooks/setup-edit-payments/)   .
   - You will need the [Zapier **Catch Hook** URL](/razorpay-docs-md/ecommerce-plugins/ghost-integration/zapier-integration.md)

     to complete the webhook set up.
...
2. Create a [Razorpay Payment Button](/razorpay-docs-md/ecommerce-plugins/ghost-integration/add-payment-button.md)   .
...
4. Create a [Zapier Zap](/razorpay-docs-md/ecommerce-plugins/ghost-integration/zapier-integration.md)   .
...
- **Ensure Certificate Verification**: Always configure your application to enable [SSL/TLS certificate verification](/docs/security/whitelists/)
...
- [Zapier Integration](/razorpay-docs-md/ecommerce-plugins/ghost-integration/zapier-integration.md)
