<!-- Source: https://razorpay.com/docs/payments/ecommerce-plugins/razorpay-direct-credit-card/troubleshooting-faqs -->
...
Follow the [installation steps](/razorpay-docs-md/ecommerce-plugins/razorpay-direct-credit-card.md#integration-steps) to install the plugin.
...
You can create a Razorpay account and use the [Razorpay Direct - Credit Card Plugin](/razorpay-docs-md/ecommerce-plugins/razorpay-direct-credit-card.md) for credit card payments even if you are not currently a [Razorpay Payment Gateway](/razorpay-docs-md/payment-gateway.md) user.
...
2. In the **Website and app settings** section, click **Webhooks**.
   ...
   ![Navigate to Webhooks](https://razorpay.com/docs/payments/ecommerce-plugins/razorpay-direct-credit-card/build/browser/assets/images/account-settings-webhooks.jpg)
...
To accept **live** payments, follow the steps mentioned in the [Switch from Test Mode to Live Mode](/razorpay-docs-md/ecommerce-plugins/razorpay-direct-credit-card.md#22-switch-from-test-mode-to-live-mode) section.
