<!-- Source: https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/risk-decline-rate -->
...
![How to calculate risk decline rate](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/calculate-risk-decline.jpg)
...
![Risk decline rate graph](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/risk-decline-count.jpg)
...
2. Navigate to **Risk and Fraud** and click **Download list**.
   ...
   ![Risk decline list download](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/risk-decline-download-list.jpg)
3. On the **Download risk declined list** page, select the **duration** and add the **Recipient's Details**. Click **Send Request**.

   ![Risk decline list download send request](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/risk-decline-send-request.jpg)
