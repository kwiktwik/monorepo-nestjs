<!-- Source: https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/dispute-sales-ratio -->

A dispute is a situation where a customer or the issuing bank questions the validity of payments. It may arise due to unauthorised charges, failure to deliver the promised merchandise, or excessive charges levied by the business. Know more about the [disputes](/razorpay-docs-md/disputes.md).
...
![How to calculate DTS](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/calculate-dts.jpg)
...
![Dispute to sales ratio value](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/dts-value-count.jpg)
...
![FTS graph](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/dts-total-count.jpg)
...
For example, you may notice a spike in disputes from a particular country or Card BIN associated with specific product categories or IP addresses. Visualising this data through custom charts or analysing the parameters in the [downloadable list of disputes](/razorpay-docs-md/international-payments/risk-visibility-dashboard/dispute-sales-ratio.md#download-the-list-of-disputes) allows you to gain valuable insights into potential risk factors contributing to the DTS ratio.
...
**Taking Proactive Measures:** Using the Dashboard, you can request our risk team to [block future transactions](/razorpay-docs-md/international-payments/risk-visibility-dashboard/dispute-sales-ratio.md#block-highest-dispute-contributors) from this high-risk IP address. This proactive measure helps prevent further fraudulent activities associated with the identified cohort, reducing the likelihood of future fraud incidents.
...
2. Navigate to **Risk and Fraud** and click **Download list**.
   ...
   ![Disputes list download](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/dts-download-list.jpg)
3. On the **Download disputes transaction list** page, select the **duration** and add the **Recipient's Details**. Click **Send Request**.

   ![Disputes list download send request](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/dts-send-request.jpg)
...
2. Navigate to **Risk and Fraud** and click **Request blacklist**.
   ...
   ![Disputes blacklist request](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/dts-request-blacklist.jpg)
3. On the **Request blacklist** page.
   ...
   ![Send request blacklist](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/dts-blacklist-send-request1.jpg)
