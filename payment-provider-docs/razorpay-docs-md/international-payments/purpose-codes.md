<!-- Source: https://razorpay.com/docs/payments/international-payments/purpose-codes -->
...
Download the complete [list of transaction purpose codes](/razorpay-docs-md/international-payments/build/browser/assets/images/transaction_purpose_codes.md) you can select during the onboarding process.
...
5. On the Purpose code page, select the correct purpose code from the list and click **Continue**.
   ...
   ![Select the purpose code](https://razorpay.com/docs/payments/international-payments/build/browser/assets/images/select-purpose-code-new.jpg)
...
7. On **Supporting details** page, enter all the supporting details and click **Submit details**.
...
3. Select the appropriate **Purpose Code**.
   ...
   2. Update your HS Code under the **International Payment Codes** section.
      ...
      ![Purpose code update](https://razorpay.com/docs/payments/international-payments/build/browser/assets/images/firs-purpose-code-update2.jpg)
...
As consumers or buyers, you get the option to make payments through the [Razorpay payment gateway](/razorpay-docs-md/payment-gateway.md). On selecting Razorpay, various payment methods will be displayed at the Razorpay checkout to complete the payment.
