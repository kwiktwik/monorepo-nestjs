<!-- Source: https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create -->
...
2. Navigate to **Offers** and click **+ Create No & Low Cost EMI**.
   ...
   ![Create a Low Cost EMI offer](https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/build/browser/assets/images/offers-offers-dashboard.jpg)
3. The **Create an Offer** wizard appears with the following four sections. Enter details in all these sections to create the offer.
   - [**Description**](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create.md#description)
   - [**Discount Type**](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create.md#discount-type)
   - [**Applicable On**](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create.md#applicable-on)
   - [**Offer Validity**](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create.md#offer-validity)

You can review the offer configurations at the end under the [**Overview**](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create.md#overview) tab.
...
![Enter the offer details to proceed](https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/build/browser/assets/images/offers-low-cost-emi-description.jpg)
...
![Enter the discount details to proceed](https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/build/browser/assets/images/offers-low-cost-emi-discount-type.jpg)
...
![Enter the payment method details](https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/build/browser/assets/images/offers-low-cost-emi-applicable-on.jpg)
...
![Enter the offer validity details to proceed](https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/build/browser/assets/images/offers-low-cost-emi-offer-validity.jpg)
...
![Check the terms and conditions and create an offer](https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/build/browser/assets/images/offers-low-cost-emi-overview.jpg)

By default, all the created offers are in the **enabled** state.

## Test the Low Cost EMI Offer

You can test the created Low Cost EMI offer for all Standard Checkout payments, including [Payment Links](/razorpay-docs-md/payment-links.md), [Payment Button](/razorpay-docs-md/payment-button.md), [Payment Pages](/razorpay-docs-md/payment-pages.md) and so on.
...
1. Select the **Payment Link Id** you wish to test the created offer from the Dashboard.
   ...
   ![Payment Link Test Offer](https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/build/browser/assets/images/offer-dashboard-test.jpg)
2. Copy the **Payment Link** URL and open it in your browser.
3. Enter your contact details and click **Proceed**.
4. Select **EMI**.
5. Select the payment option you created for the offer on from the Dashboard. Select the EMI plan and enter the required [test details](/razorpay-docs-md/payments/test-card-details.md)   .
6. Click **Pay via EMI**
...
3. Click the required Offer\_id.
4. Go to the **Status** field in the pane that appears and click **Disable**.

   ![Disable an Offer](https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/build/browser/assets/images/disable-offer.jpg)
5. Click **Yes, Disable**.

## Next Steps

Now that the Low Cost EMI is created, you should integrate it with the Checkout for customers to avail the EMI scheme.
Know more about [integrating Low Cost EMI Offers with Standard Checkout](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/standard-integration.md).

### Related Information

- [Tutorial - How to Create Low Cost EMI Offers](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/tutorial.md)
- [Low Cost EMI FAQs](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/faqs.md)
