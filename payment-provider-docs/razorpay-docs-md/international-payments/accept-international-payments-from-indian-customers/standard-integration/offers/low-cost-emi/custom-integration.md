<!-- Source: https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/custom-integration -->
...
You can decide the cost to subvent for each EMI tenure while [creating an offer](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create.md) and the customer bears the remaining cost. This approach ensures that customers enjoy the benefits of EMI at an affordable cost, helping you minimise the overall cost.

**New to Custom Checkout Integration?**

If yes, know more about the [custom integration flow](/razorpay-docs-md/payment-gateway/web-integration/custom.md).

## Prerequisites

Before integrating Low Cost EMI offers for your custom Checkout, run through this checklist:

1. Understand the [payment flow](/razorpay-docs-md/payments.md#payment-life-cycle)   .
2. Generate the API keys from the [Dashboard](/razorpay-docs-md/dashboard/account-settings.md#api-keys)   .
...
The procedure for integrating Custom Checkout on your website is explained in the [Custom Integration document](/razorpay-docs-md/payment-gateway/web-integration/custom.md). However, the procedure varies while passing the offers in the payment details.

1. [Create a Low Cost EMI Offer](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/custom-integration.md#step-1-create-a-low-cost-emi-offer)
2. [Create an Order and Pass Offer\_id](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/custom-integration.md#step-2-create-an-order-and-pass-offer-id)
3. [Show the Offer on Checkout](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/custom-integration.md#step-3-show-the-offer-on-checkout)
4. [Submit Payment Details](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/custom-integration.md#step-4-submit-payment-details)

## Step 1: Create a Low Cost EMI Offer

You can create a Low Cost EMI offer from the [Dashboard](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create.md).
...
This is mandatory only in cases where you want to associate an offer or offers with the Order or you had not selected the [Show Offer on Checkout](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create.md#offer-validity) while creating the offer from the Dashboard.
...
![Low Cost EMI on Standard Checkout](https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/build/browser/assets/images/low-cost-emi-standard.jpg)
...
Know more about [Custom Checkout](/razorpay-docs-md/payment-gateway/web-integration/custom.md).
