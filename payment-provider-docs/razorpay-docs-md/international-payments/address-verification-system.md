<!-- Source: https://razorpay.com/docs/payments/international-payments/address-verification-system -->
...
![Feature Request GIF](https://razorpay.com/docs/payments/international-payments/build/browser/assets/images/feature-request.gif)
...
- [Integrate](/razorpay-docs-md/payment-gateway/web-integration/standard.md)

   with
  Razorpay
   Standard Checkout. This feature is available for all types of Standard Checkout, including server language SDKs, e-commerce plugins, and products such as Invoices, Payment Button, Payment Links and Payment Pages.
- Enable [international payments](/razorpay-docs-md/international-payments.md)
...
![AVS Workflow](https://razorpay.com/docs/payments/international-payments/build/browser/assets/images/international-payments-address-verification-system-flow.jpg)
...
1. The customer selects `card` as the payment method and enters the credit card details.
   ...
   ![Address Verification Service - Customer enters credit card details](https://razorpay.com/docs/payments/international-payments/build/browser/assets/images/international-payments-avs-checkout-card.jpg)
2. The customer is asked to enter their billing address. This is a one-time activity and Razorpay will save the address securely. Customer will not be asked to provide the address on repeat transactions.
   ...
   ![Address Verification Service - Customer enters address details](https://razorpay.com/docs/payments/international-payments/build/browser/assets/images/international-payments-avs-address-details.jpg)
