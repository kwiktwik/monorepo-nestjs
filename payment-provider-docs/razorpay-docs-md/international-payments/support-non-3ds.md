<!-- Source: https://razorpay.com/docs/payments/international-payments/support-non-3ds -->
...
- You must have [international payments](/razorpay-docs-md/international-payments.md)
...
3. Select **International Payments** and click **Request** besides **Support for Non-3D Secure transactions** under **International Cards**.
   ...
   ![Disable Non-3DS](https://razorpay.com/docs/payments/international-payments/build/browser/assets/images/non-3ds-disable.jpg)
...
![Enable Non-3DS](https://razorpay.com/docs/payments/international-payments/build/browser/assets/images/non-3ds-enable.jpg)
