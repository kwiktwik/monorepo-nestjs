<!-- Source: https://razorpay.com/docs/payments/payment-links/faqs -->
...
No. You can create Payment Links with fixed amounts only. Customers cannot enter an amount of their choice. Use [Payment Pages](/razorpay-docs-md/payment-pages.md) if you want to allow customers to enter an amount of their choice.

3. Can I accept recurring payments using Payment Links?

No. Payment Links can only be used to accept one-time payments. Use [Razorpay Subscriptions](/razorpay-docs-md/subscriptions.md) to collect recurring payments from customers.
...
Currently, you can set a minimum upfront amount only through APIs. Refer to this [API endpoint](/razorpay-docs-md/api/payments/payment-links.md#request-parameters) for more information. To enabled this feature for your account, raise a ticket to the support team.

9. Can I cancel a Payment Link if it is in "partially\_paid" state?
...
No, you cannot send an invoice automatically. [Razorpay's Invoices](/razorpay-docs-md/invoices.md) is designed to initiate payments, not for post-payment invoicing. You need to handle invoice generation on your end after receiving payment confirmation.

11. Can I accept international payments using Payment Links?

Yes, you can accept international payments using Payment Links. Know more about [international payments](/razorpay-docs-md/international-payments.md).

12. Can I use a Payment Link to accept payments from multiple customers?

No, you can only accept payments from a single customer using a Payment Link. Use [Payment Pages](/razorpay-docs-md/payment-pages.md) if you want to use one link to accept payments from multiple customers.

13. Why is the "callback\_url" not working for UPI Payment Links on Android?

UPI Payment Links will not redirect to "callback\_url" on an Android device even if the parameter is passed while creating a Payment Link.
...
![report payment link](https://razorpay.com/docs/payments/payment-links/build/browser/assets/images/payment-links-report-a-link.jpg)
...
![Email Report Payment ink](https://razorpay.com/docs/payments/payment-links/build/browser/assets/images/payment-links-email-report.jpg)
...
5. Complete the captcha step and click **SUBMIT REPORT**.
   ...
   ![report payment link](https://razorpay.com/docs/payments/payment-links/build/browser/assets/images/payment-links-report-payment-link.jpg)
...
- File a dispute against the business. Know more about [Disputes](/razorpay-docs-md/disputes.md)  .
