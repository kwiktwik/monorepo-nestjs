<!-- Source: https://razorpay.com/docs/payments/magic-checkout/shopify/custom/ios-integration -->
...
- Integrate with [iOS Integration](/razorpay-docs-md/magic-checkout/ios-integration.md)  .
...
Integrate with iOS App for Shopify.
...
Create a Razorpay order id required for the payment modal. This API requires the `shopify_checkout_id` from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/ios-integration.md#11-create-a-checkout-id).
...
`string` Checkout id from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/ios-integration.md#11-create-a-checkout-id).
...
![add Frameworks, Libraries and Embed Content](https://razorpay.com/docs/payments/magic-checkout/shopify/custom/build/browser/assets/images/ios-embed-framework.gif)
