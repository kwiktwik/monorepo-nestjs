<!-- Source: https://razorpay.com/docs/payments/magic-checkout/shopify/custom/android-integration -->
...
- Integrate with [Android Integration](/razorpay-docs-md/magic-checkout/android-integration.md)  .
...
Integrate with Android App for Shopify.
...
Create a Razorpay order id required for the payment modal. This API requires the `shopify_checkout_id` from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/android-integration.md#11-create-a-checkout-id).
...
`string` Checkout id from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/android-integration.md#11-create-a-checkout-id).
...
Use the `setKeyId()` method of the Checkout class to dynamically add your API key id. You can generate your API keys from the [Razorpay Dashboard](/razorpay-docs-md/dashboard/account-settings/api-keys.md#generate-api-keys).
...
Create an instance of the `Checkout` and pass the payment details and options as a `JSONObject`. Ensure that you add the `order_id` generated in [Step 5](/razorpay-docs-md/magic-checkout/android-integration.md#15-create-an-order).
