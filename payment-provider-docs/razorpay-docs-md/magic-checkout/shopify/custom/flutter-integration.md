<!-- Source: https://razorpay.com/docs/payments/magic-checkout/shopify/custom/flutter-integration -->
...
- Integrate with [Flutter Integration](/razorpay-docs-md/magic-checkout/flutter-integration.md)  .
...
Integrate with Flutter App for Shopify.
...
Create a Razorpay order id required for the payment modal. This API requires the `shopify_checkout_id` from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/flutter-integration.md#11-create-a-checkout-id).
...
`string` Checkout id from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/flutter-integration.md#11-create-a-checkout-id).
