<!-- Source: https://razorpay.com/docs/payments/magic-checkout/shopify/custom/capacitor-integration -->
...
- Integrate with [Capacitor Integration](/razorpay-docs-md/magic-checkout/capacitor-integration.md)  .
...
Integrate with Capacitor App for Shopify.
...
Create a Razorpay order id required for the payment modal. This API requires the `shopify_checkout_id` from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/capacitor-integration.md#11-create-a-checkout-id).
...
`string` Checkout id from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/capacitor-integration.md#11-create-a-checkout-id).
