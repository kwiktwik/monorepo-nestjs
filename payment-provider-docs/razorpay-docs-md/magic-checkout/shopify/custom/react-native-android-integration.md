<!-- Source: https://razorpay.com/docs/payments/magic-checkout/shopify/custom/react-native-android-integration -->
...
- Integrate with [React Native: Android Integration](/razorpay-docs-md/magic-checkout/react-native-android-integration.md)  .
...
Integrate with React Native Android App for Shopify.
...
Create a Razorpay order id required for the payment modal. This API requires the `shopify_checkout_id` from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/react-native-android-integration.md#11-create-a-checkout-id).
...
`string` Checkout id from [Step 1.1](/razorpay-docs-md/magic-checkout/shopify/custom/react-native-android-integration.md#11-create-a-checkout-id).
