<!-- Source: https://razorpay.com/docs/payments/magic-checkout/shopify/configuration -->
...
- [Cash on Delivery](/razorpay-docs-md/magic-checkout/shopify/configuration.md#cash-on-delivery)
- [Partial Cash on Delivery](/razorpay-docs-md/magic-checkout/shopify/configuration.md#partial-cash-on-delivery)
- [RTO](/razorpay-docs-md/magic-checkout/shopify/configuration.md#rto)
- [Convert COD Orders to Prepaid](/razorpay-docs-md/magic-checkout/shopify/configuration.md#convert-cod-orders-to-prepaid)
- [Shipping Options](/razorpay-docs-md/magic-checkout/shopify/configuration.md#shipping-options)
- [International Shipping](/razorpay-docs-md/magic-checkout/shopify/configuration.md#international-shipping)
- [Coupons](/razorpay-docs-md/magic-checkout/shopify/configuration.md#coupons)
- [Login with Razorpay](/razorpay-docs-md/magic-checkout/shopify/configuration.md#login-with-razorpay)
- [Offers](/razorpay-docs-md/magic-checkout/shopify/configuration.md#offers)
- [Separate Billing Address](/razorpay-docs-md/magic-checkout/shopify/configuration.md#separate-billing-address)
- [Capture and Validate GSTIN](/razorpay-docs-md/magic-checkout/shopify/configuration.md#capture-and-validate-gstin)
- [Capture Order Instructions](/razorpay-docs-md/magic-checkout/shopify/configuration.md#capture-order-instructions)
- [Google Analytics](/razorpay-docs-md/magic-checkout/shopify/configuration.md#google-analytics)
- [Google Ads](/razorpay-docs-md/magic-checkout/shopify/configuration.md#google-ads)
- [Facebook Ads](/razorpay-docs-md/magic-checkout/shopify/configuration.md#facebook-ads)
- [Gift Card Settings](/razorpay-docs-md/magic-checkout/shopify/configuration.md#gift-card-settings)
...
Use [Advanced Partial COD Slabs](/razorpay-docs-md/magic-checkout/shopify/configuration.md#set-advanced-partial-cod-slabs) to create price slabs for partial COD within specific order ranges, adjusting amounts based on customer risk categories.
...
6. Select **Set up your own rates**. Follow the steps given below:
   ...
   **Handy Tips**
   ...
   You can create multiple shipping options by charging extra for cash on delivery. Know how to [create multiple shipping rates](/razorpay-docs-md/magic-checkout/shopify/configuration.md#cash-on-delivery-shipping-rates)   .
