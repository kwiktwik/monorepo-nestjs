<!-- Source: https://razorpay.com/docs/payments/magic-checkout/shopify/features -->
...
- [Cash on Delivery](/razorpay-docs-md/magic-checkout/shopify/features.md#cash-on-delivery)
- [Partial Cash on Delivery](/razorpay-docs-md/magic-checkout/shopify/features.md#partial-cash-on-delivery)
- [RTO](/razorpay-docs-md/magic-checkout/shopify/features.md#rto)
- [Convert COD Orders to Prepaid](/razorpay-docs-md/magic-checkout/shopify/features.md#convert-cod-orders-to-prepaid)
- [Shipping Options](/razorpay-docs-md/magic-checkout/shopify/features.md#shipping-options)
- [International Shipping](/razorpay-docs-md/magic-checkout/shopify/features.md#international-shipping)
- [Coupons](/razorpay-docs-md/magic-checkout/shopify/features.md#coupons)
- [Login with Razorpay](/razorpay-docs-md/magic-checkout/shopify/features.md#login-with-razorpay)
- [Orders Not Placed](/razorpay-docs-md/magic-checkout/shopify/features.md#orders-not-placed)
- [Inventory and Stock](/razorpay-docs-md/magic-checkout/shopify/features.md#inventory-and-stock)
- [Offers](/razorpay-docs-md/magic-checkout/shopify/features.md#offers)
- [Shopify Bundles](/razorpay-docs-md/magic-checkout/shopify/features.md#shopify-bundles)
- [Separate Billing Address](/razorpay-docs-md/magic-checkout/shopify/features.md#separate-billing-address)
- [Capture and Validate GSTIN](/razorpay-docs-md/magic-checkout/shopify/features.md#capture-and-validate-gstin)
- [Capture Order Instructions](/razorpay-docs-md/magic-checkout/shopify/features.md#capture-order-instructions)
- [Google Analytics](/razorpay-docs-md/magic-checkout/shopify/features.md#google-analytics)
- [Google Ads](/razorpay-docs-md/magic-checkout/shopify/features.md#google-ads)
- [Facebook Ads](/razorpay-docs-md/magic-checkout/shopify/features.md#facebook-ads)
- [Gift Card Settings](/razorpay-docs-md/magic-checkout/shopify/features.md#gift-card-settings)
...
4. Enable **COD as a payment option**.
   ...
   ![COD settings](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-cod-settings.jpg)
...
1. Configure the **Cart order value** by selecting an option based on your requirement:
   ...
   4. Click **Save slabs**.
      ...
      ![Create COD eligibility slabs with COD charges](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-cod-slabs.jpg)
...
4. Select the country, state and city where the COD charges configured in the previous step should be applicable. Click **Confirm**.
   ...
   ![Create COD zones](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-cod-zone.jpg)
5. Click **Save & apply**.
6. Navigate to **Manual Zipcode upload** and click **Upload ZIP codes** to offer COD only to specific ZIP codes.

   ![Upload ZIP codes to offer COD only to specific ZIP codes](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-cod-shipping-pincode.jpg)
...
4. Click **Save slab**.
   ...
   ![Create advanced COD eligibility slabs](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-advanced-cod-slabs.jpg)
...
9. You can configure COD based on either the zone or product categories.
   ...
   - **Zone Configuration**: Manage applicable COD slabs and rates for different zones.
     1. Click **+ Set zone configuration**.
        ...
        ![Set zone configuration](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopif-zone-config.jpg)
     2. Select the slabs based on your requirement and click **Save configuration**. It is mandatory to configure all the zones you create. The COD charge applies to each zone based on the slabs you select.
        ...
        ![Select zone-wise COD slabs](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-zone-cod-slabs.jpg)
     3. Click **Save & apply**.
   - **Product categories**: Create **Product categories** to establish custom rates or zone restrictions for different categories.
     ...
     2. Click **+ Add categories**.
        ...
        ![Add product categories](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-product-cat.jpg)
     ...
     6. Click **+ Set category configuration** to configure the zones and slabs for each category.
        ...
        ![Set category configuration](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-product-cat-config.jpg)
     ...
     8. Click **Save configuration**. It is mandatory to configure slabs for all the zones you create.
        ...
        ![Config zone and slabs for each category](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-category-config.jpg)
     9. Click **Save & apply**.
...
4. Click **+ Add New Blocklist**.
   ...
   ![Add blocklist](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-blocklist.jpg)
...
6. Click **Confirm**.
   ...
   ![Confirm](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/cod-blocklist-confirm.jpg)
...
2. Select the required products to add a COD tag.
   ...
   ![Select the products to add a COD tag](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-cod-configs.jpg)
...
3. Click the options icon below and click **Add tags**.
   ...
   ![Add the required COD tags](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-cod-add-tags.jpg)
...
5. Click **Save**.
   ...
   ![Enter the COD charge and save the changes](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-cod-tag-save.jpg)
...
![Customers view the tag at the checkout](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-cod-tag-customer.jpg)
...
4. Turn on **Enable Partial COD** and click **Enable** to confirm.
   ...
   ![Enable partial COD](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-config-partial-cod-enable.jpg)
5. Select the appropriate check boxes to enable **Partial COD** for specific categories:
   ...
   ![enable partial COD for specific categories](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-config-partial-cod-risk.jpg)
6. You can select a default partial amount or set a custom amount for partial COD.
   ...
   ![choose a default amount](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-config-partial-cod-default-amt.jpg)
...
Use [Advanced Partial COD Slabs](/razorpay-docs-md/magic-checkout/shopify/features.md#set-advanced-partial-cod-slabs) to create price slabs for partial COD within specific order ranges, adjusting amounts based on customer risk categories.
...
1. In the **Partial COD** section, click **Set advanced slabs**.
   ...
   ![set advanced slabs](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-config-partial-cod-set-advanced.jpg)
2. Click **+ New Slab**.
...
![Partial COD advanced slab settings](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-config-partial-cod-advanced.jpg)
...
![Enable COD intelligence](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-cod-enable.jpg)

You can disable **COD Intelligence** if required. This will enable the COD option for all the customers, including those considered risky by Magic Checkout. Once you enable COD intelligence, the **RTO Analytics** tab will appear. Know more about [RTO Analytics](/razorpay-docs-md/magic-checkout/analytics/rto.md).
...
4. Toggle on **Manually review COD orders**.
   ...
   ![Manual Review](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-manual-review-shopify.jpg)

Once you enable manual review, you can review the COD orders and take necessary actions. Refer to the [COD Orders](/razorpay-docs-md/magic-checkout/order-settings/review-cod-orders.md#cod-orders) section for the next steps.
...
Converting orders to prepaid can help you increase order commitment, reduce RTO, streamline operations and enhance customer trust. Know how to [convert COD orders to prepaid](/razorpay-docs-md/magic-checkout/order-settings/prepay-cod.md).
...
4. Click **Add Profile** in the **Custom Shipping Profile** section.
   ...
   ![Navigate to Shipping settings on the Razorpay Dashboard](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-shipping-settings.jpg)
5. Click **+ Add category** in the **Product categories** section.

   ![Add product categories to configure shipping](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-wooc-shipping-category.jpg)
6. You can add products to the category in two ways.
   ...
   ![Product Category, manual selection](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shipping-manual-category.jpg)
...
8. Enter the **Zone name** and select the country, state and city of your choice.
   ...
   ![Add shipping zones to determine the shipping charges for each zone](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-add-shipping-zone.jpg)
...
11. Click **+ Add shipping method** and configure the **Shipping method & rate** for all the shipping zones added in the previous step.
    ...
    ![Configure the shipping rates for each zone](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-shipping-method.jpg)
...
14. Configure the Shipping slab based on the **Amount** and **Weight** of the product and enter the minimum and maximum values respectively. For example, enter the minimum-maximum value as ₹500-₹900. If the amount of the product falls in that range, a shipping rate is applicable on the product.
    ...
    ![Configure the shipping method](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-configure-shipping-method.jpg)
...
16. Enter the estimated delivery timeline and click **Confirm**.
    ...
    ![Configure the shipping method](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-configure-shipping-delivery.jpg)
...
19. Enable **Magic Shipping**. To confirm the action, click **Yes, enable**.
    ...
    **Watch Out!**
    ...
    ![Enable Shipping settings on the Razorpay Dashboard](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/shopify-magic-enable-shipping-settings.jpg)
...
1. Log in to the [Shopify Store](https://accounts.shopify.com/store-login)
   ...
   ![Shopify shipping](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-shipping.jpg)
2. Create a profile under general or custom shipping rates and add the required details.
   ...
   **Watch Out!**
   ...
   ![Profile for general or custom shipping rates](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-profile.jpg)
3. After creating a profile, click **Manage** to navigate to the shipping settings under that profile.

   ![Edit shipping settings](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-manage.jpg)
4. Click **Create shipping zone** and add zones of your choice. Click **Done**.

   ![Shipping zones](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-shipping-zone.jpg)
5. Click **Add rate** to add the shipping rates. You can create multiple shipping rates/options you want to show to your customers on Magic Checkout.
   ...
   ![Add shipping rates](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-add-rate.jpg)
6. Select **Set up your own rates**. Follow the steps given below:
   ...
   4. Click **Done**.
      ...
      ![Set up your own rates](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-own-rate.jpg)

   **Handy Tips**

   You can create multiple shipping options by charging extra for cash on delivery. Know how to [create multiple shipping rates](/razorpay-docs-md/magic-checkout/shopify/features.md#cash-on-delivery-shipping-rates)   .
...
3. Navigate to **Shipping Setup** and enable **International Shipping**.
   ...
   ![International shipping](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-international.jpg)
...
2. In the **Checkout Setup** tab, enable **Auto fetch coupon** and click **Save settings**. This step is mandatory and allows you to display coupons to your customers at checkout. Even if you enable **Display this coupon at checkout** in the next steps, you must still enable Auto fetch coupon.
   ...
   ![enable auto fetch coupon to display coupons to customers](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-auto-fetch.jpg)
...
4. Enable the following, as required:
   ...
   ![Enable toggles to configure coupons](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-toggle.jpg)
   ...
   **Watch Out!**
   ...
   - By default, all the coupons synced from Shopify are in the `created` state. You must manually configure and publish the coupons. To configure a coupon, identify the one you want to publish, click the options icon and click **View and Edit** *(if required)* or click **Publish**.
     ...
     ![publish the coupons synced from Shopify](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-publish-sync-shopify.gif)
...
5. Navigate to **All Coupons**, click **+ Create Coupon** and **Select a Coupon Type** based on your requirement. Alternatively, you can click **+ Create Coupon** next to **Coupons on Magic** in the **Setup** section and **Select a Coupon Type**.
   ...
   ![Create a coupon](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-create.jpg)
...
10. Select the **Automatically apply this coupon for eligible users** check box to automatically apply the coupon with the best value from those available.
    ...
    ![Enter the coupon code and description](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-code.jpg)
    ...
    **Handy Tips**
    ...
    ![To hide COD payment method when disabled](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-coupons-hide-cod.jpg)
...
1. **Discount Details**: Select the **Discount type**.
   ...
   **Discount amount**: Enter an amount by which the original price should be reduced. For example, if ₹150 is the flat discount applied, ₹150 is deducted from the original price.
   ...
   ![Configure the fixed discount details](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-discount.jpg)
2. Select the **Purchase requirements** based on your preference to set eligibility criteria for the customers to use the coupon.
   ...
   ![Configure purchase requirements](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-pur-req.jpg)
3. **Coupon validity**: Set the duration for the coupon.
   ...
   ![Configure the coupon validity](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-validity.jpg)
4. **Coupon eligibility**: Create the coupon for **All customers** or **Specific customers**. If you want to create coupons for specific customers:
   ...
   1. Click **+ Add Customers**.
      ...
      ![Configure the coupon eligibility](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-eligibility.jpg)
...
5. **Usage restriction**: Set the maximum limit to which a coupon is redeemed in total and per customer.
   ...
   2. Select the **Number of times the coupon can be used per customer** check box and set the number. For example, 2.
   3. Select **By mobile no.** or **By email id** via which the customer can use the coupon.

   ![configure coupon restriction](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-restriction.jpg)
6. **Coupon combinations** *(optional)*: You can combine this coupon with various other coupons as follows:
   ...
   ![Combine coupons created with other categories](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-order-combine.jpg)
...
2. Select **Products** or **Collections** to limit the discount to specific products or collections. Click **+ Add Products** or **+ Add Collections** respectively. Select the products or collections based on your requirement and click **Confirm**. You can add multiple products or collections.
   ...
   ![configure the discount details](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-discount-det.jpg)
...
7. **Coupon combinations** *(optional)*: You can combine this coupon with various other coupons as follows:
   ...
   ![Combine coupons created with other categories](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-prod-combine.jpg)
...
1. Configure the **Purchase requirements** for X products based on your preference to set eligibility criteria for the customers to avail of the coupon offer.
   ...
   ![Configure minimum quantity requirements](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-min-qt-buy.jpg)
2. Select **Products** or **Collections** to limit the discount to specific products or collections. Click **+ Add Products** or **+ Add Collections** respectively. Select the products or collections based on your requirement and click **Confirm**. You can add multiple products or collections.

   ![Configure coupon products purchased](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-product-config.jpg)
...
4. Select **Products** or **Collections** for Y products as well. Refer to step 2.
   ...
   ![Configure coupon discount](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-discount-offered.jpg)
5. **Discount type**: Select the **Discount type** applicable on Y products.
   ...
   - **Fixed Discount**: In this type, a fixed amount is deducted from the original amount of the Y product.
     ...
     ![configure fixed discount](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-fixed-dis.jpg)
   - **Percentage discount**: In this type, a set percentage of the amount is deducted from the original amount of the Y product.
     ...
     ![configure percentage discount](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-percentage-dis.jpg)
...
9. **Coupon combinations** *(optional)*: Combine this coupon with **Free shipping coupons** to provide free shipping along with the discount. If you select **Free shipping coupons** in this category then you must select the **BxGy discount coupons** check box in the **Free Shipping** category to combine the coupon.
   ...
   ![Combine this coupon with free shipping](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-free-combine.jpg)
...
2. Select **Products** or **Collections** to limit the discount to specific products or collections. Click **+ Add Products** or **+ Add Collections** respectively. Select the products or collections based on your requirement and click **Confirm**. You can add multiple products or collections.
   ...
   ![Configure coupon products purchased](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-product-config-bulk.jpg)
3. Select the **Discount type**.
   ...
   - **Fixed Discount**: In this type, a fixed amount is deducted from the original amount of the Y product.
     ...
     ![configure fixed discount](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-fixed-dis-bulk.jpg)
   - **Percentage discount**: In this type, a set percentage of the amount is deducted from the original amount of the Y product.
     - **Discount percentage**: The percentage by which the original price should be reduced. For example, if 10% discount is applied, on an order amount of ₹900, ₹90 will be deducted.

     ![configure percentage discount](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-percentage-dis-bulk.jpg)
...
5. **Coupon validity**: Set the duration for the coupon.
   ...
   ![Configure the coupon validity](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-validity-bulk.jpg)
...
3. **Coupon eligibility**: Create the coupon for **All customers** or **Specific customers**. If you want to create coupons for specific customers:
   ...
   ![Configure details for free shipping coupon](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-free.jpg)
...
5. **Coupon combinations** *(optional)*: You can combine this coupon with various other coupons as follows:
   ...
   ![Combine this coupon created with other categories](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupons-free-combine.jpg)
...
3. **Discount Offered**: Select one product variant to offer as a free gift when the purchase requirements are met:
   ...
   **Watch Out!**
   ...
   1. Click **+Add Products**.
      ...
      ![Select a product to offer free item discount](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/cod-magic-freebie-discount.jpg)
   2. Select the product of your choice and click **Confirm**.
...
8. **Coupon combinations** *(optional)*: You can combine this coupon with **Free shipping coupons** category to offer free shipping on an order.
   ...
   ![Combine this coupon created with other categories](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-freebie-combine.jpg)
9. Click **Create and Publish**.
...
2. Navigate to **Discounts** and click **Create discount**.
   ...
   ![Create discounts](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-discount.jpg)
3. You can create four types of discounts:
   ...
   ![Select discount](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-select-discount.jpg)
4. **Select discount type** of your choice and enter the following details:
   ...
   2. Select the **Value** of the discount based on your requirement. You can also choose to add a discount to **Specific collections** or **Specific products**.
      ...
      ![Select the value of the discount](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-config.jpg)
   ...
   7. Click **Save discount**.
      ...
      ![Save Configs](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-configs.jpg)
...
3. Navigate to **Checkout Setup**, disable **Auto fetch coupon** and click **Save settings**.
   ...
   ![Disable coupons](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-coupon.jpg)
...
Razorpay Magic SSO (Single Sign-On) offers a seamless login experience, helping you enhance conversions and gain valuable insights into user behaviour. Know more about how to setup [login with Razorpayt](/razorpay-docs-md/magic-checkout/login-with-razorpay.md) on your shopify store.
...
![refun orders not placed](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-orders-not-placed-refund.jpg)
...
Know more about [Inventory and Stock Settings](/razorpay-docs-md/magic-checkout/order-settings/inventory-stock.md).
...
Know how to [create offers](/razorpay-docs-md/offers/create.md).
...
3. Navigate to **Checkout Setup**, enable **Capture billing address** and click **Save settings**.
   ...
   ![Capture separate billing address](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-billing.jpg)
...
3. Navigate to **Checkout Setup**, enable **Capture GSTIN** and click **Save settings**.
   ...
   ![Capture customer's GSTIN](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-capture-gstin.jpg)
4. To validate the GSTIN entered by your customers at checkout, contact our [Support team](https://razorpay.com/support/#request)

   to enable GSTIN validation for your account.
...
![GSTIN on checkout](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-config-gstin.jpg)
...
3. Navigate to **Checkout Setup**, enable **Capture order instructions** and click **Save settings**.
   ...
   ![Capture customers order instructions](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-checkout-shopify-order-inst.jpg)
...
4. Select the integration type from the drop-down list.
   ...
   ![Select the integration type to configure GA](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-ga-integration.jpg)

GTag

Integrate with frontend. Enable the events of your choice and click **Save events**.

![Configure and save the events](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-ga-events.jpg)
...
5. The second snippet code (Event snippet) is the Gtag code. Copy the code and share it with us at [[magic-checkout-support@razorpay.com](mailto:magic-checkout-support@razorpay.com)](mailto:magic-checkout-support@razorpay.com)

   to get this feature enabled on your Shopify store.
...
4. Select the integration type from the drop-down list.
   ...
   ![Select the integration type to configure Facebook Ads](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-facebook-integrations.jpg)

Facebook Pixel

Facebook Capi

Both Facebook Pixel and Capi (Recommended)

Integrate with frontend. Enable the events of your choice and click **Save events**.

![Configure and save the events](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-facebook-events.jpg)
...
4. Once you enable the gift card settings, you can also enable the following options **if required**:
   ...
   ![Configure the gift card options if required](https://razorpay.com/docs/payments/magic-checkout/shopify/build/browser/assets/images/magic-shopify-gift-config.jpg)
5. Click **Save Settings**.

### Related Information [Troubleshooting and FAQs](/razorpay-docs-md/magic-checkout/troubleshooting-faqs.md#woocommerce)
