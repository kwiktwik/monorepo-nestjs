<!-- Source: https://razorpay.com/docs/payments/magic-checkout/react-native-ios-integration -->
...
Integrate with React Native iOS App.
...
If you use M1 MacBook, you need to make [these changes](/razorpay-docs-md/magic-checkout/react-native-ios-integration.md#m1-macbook-changes) in your `podfile`.
...
![](https://razorpay.com/docs/payments/magic-checkout/build/browser/assets/images/react-native-change_platform_version_podfile.jpg)
...
`string` Unique identifier of the order created [previously](/razorpay-docs-md/magic-checkout/react-native-ios-integration.md#17-create-an-order).
...
## Related Information [React Native: iOS Standard Integration](/razorpay-docs-md/payment-gateway/react-native-integration/standard/integration-steps-ios.md)
