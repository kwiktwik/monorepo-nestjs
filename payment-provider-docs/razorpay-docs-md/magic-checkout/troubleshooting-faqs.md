...
Follow these [steps](/razorpay-docs-md/magic-checkout/shopify/features.md#coupons) to configure coupon codes on your [Razorpay Dashboard](https://dashboard.razorpay.com/app/magic/coupons) for your Shopify store.
...
You can configure shipping rates at product, zone and method levels for your customers. Follow these [steps](/razorpay-docs-md/magic-checkout/shopify/features.md#method-1-razorpay-dashboard-1) to set up shipping profiles on the [Razorpay Dashboard](https://dashboard.razorpay.com/app/magic/settings/shipping-setup).
...
Login rewards are incentives such as coupons offered to users who log in via the widget. You must create the coupon using [Razorpay Coupon Engine](/razorpay-docs-md/magic-checkout/shopify/features.md#coupons) and raise a request with our [support team](https://razorpay.com/support/#request) to get the feature enabled.
