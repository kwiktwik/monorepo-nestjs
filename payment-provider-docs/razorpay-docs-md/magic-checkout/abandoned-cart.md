<!-- Source: https://razorpay.com/docs/payments/magic-checkout/abandoned-cart -->
...
![enable abandoned webhook](https://razorpay.com/docs/payments/magic-checkout/build/browser/assets/images/magic-abandoned-cart.jpg)
