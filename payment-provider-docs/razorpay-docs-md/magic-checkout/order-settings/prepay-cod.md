<!-- Source: https://razorpay.com/docs/payments/magic-checkout/order-settings/prepay-cod -->
...
- This feature is available only if you use [Shopify](/razorpay-docs-md/magic-checkout/shopify.md)

  or [WooCommerce](/razorpay-docs-md/magic-checkout/woocommerce.md)

  (v4.3.5 and above) plugin.
...
3. Click **Convert COD to Prepaid**.
   ...
   ![Navigate to convert COD to prepaid on the Razorpay Dashboard](https://razorpay.com/docs/payments/magic-checkout/order-settings/build/browser/assets/images/magic-prepay-cod.jpg)

   **Manually Review COD Orders**

   The **Enable conversion for** field will appear if you enable the [Manually review COD orders](/razorpay-docs-md/magic-checkout/order-settings/review-cod-orders.md)

   feature. The COD conversion will be based on the type of RTO risk.

   ![Enable conversion field for manual review](https://razorpay.com/docs/payments/magic-checkout/order-settings/build/browser/assets/images/magic-prepay-cod-manual-review.jpg)
4. Enable **Discount** to add a flat or percentage discount to the total COD order amount. Adding a discount increases the probability of conversion by up to 30%. Select the type of discount you want to apply:
   ...
   **Watch Out!**
   ...
   ![offer flat discount](https://razorpay.com/docs/payments/magic-checkout/order-settings/build/browser/assets/images/magic-prepay-flat.jpg)
...
7. Click **Save settings**.
   ...
   **WooCommerce API Credentials**
   ...
   If you are a WooCommerce user and have not opted for the [Manually review COD orders](/razorpay-docs-md/magic-checkout/order-settings/review-cod-orders.md)

   feature, you must provide your **WooCommerce API credentials** to enable us to send the conversion links to your customers.

   ![Submit API keys to enable conversion links](https://razorpay.com/docs/payments/magic-checkout/order-settings/build/browser/assets/images/magic-checkout-submit-keys.jpg)
...
![View order Id and conversion status on the Razorpay Dashboard](https://razorpay.com/docs/payments/magic-checkout/order-settings/build/browser/assets/images/magic-prepay-status.jpg)
...
2. Under **Actions**, click the clock icon.
   ...
   ![Manually expire the conversion link](https://razorpay.com/docs/payments/magic-checkout/order-settings/build/browser/assets/images/magic-prepay-expire.jpg)
...
![View Conversion link on WhatsApp](https://razorpay.com/docs/payments/magic-checkout/order-settings/build/browser/assets/images/magic-prepay-link.jpg)
...
2. In the **Business settings** section, select **Account details**.
   ...
   ![Edit Account details on the Razorpay Dashboard](https://razorpay.com/docs/payments/magic-checkout/order-settings/build/browser/assets/images/magic-settings.jpg)
3. Click **Edit** and modify the name.

   ![Edit Display name](https://razorpay.com/docs/payments/magic-checkout/order-settings/build/browser/assets/images/magic-setting-edit-display-name.jpg)
