<!-- Source: https://razorpay.com/docs/payments/magic-checkout/react-native-android-integration -->
...
Integrate with React Native Android App.
...
If you use M1 MacBook, you need to make [these changes](/razorpay-docs-md/magic-checkout/react-native-android-integration.md#m1-macbook-changes) in your `podfile`.
...
`string` Unique identifier of the order created [previously](/razorpay-docs-md/magic-checkout/react-native-android-integration.md#15-create-an-order).
...
## Related Information [React Native: Android Standard Integration](/razorpay-docs-md/payment-gateway/react-native-integration/standard/integration-steps-android.md)
