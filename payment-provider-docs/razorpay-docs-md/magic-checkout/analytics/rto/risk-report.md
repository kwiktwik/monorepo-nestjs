<!-- Source: https://razorpay.com/docs/payments/magic-checkout/analytics/rto/risk-report -->
...
The following widgets are available in the **Risk Report** tab of the [RTO Analytics Dashboard](/razorpay-docs-md/magic-checkout/analytics/rto.md). Check which widgets are applicable when you opt either for:
...
![RTO Analytics safe vs risky users chart](https://razorpay.com/docs/payments/magic-checkout/analytics/rto/build/browser/assets/images/rto-safe-risky-users.jpg)
...
![RTO Analytics Risk Distribution across orders bar graph](https://razorpay.com/docs/payments/magic-checkout/analytics/rto/build/browser/assets/images/rto-risk-dist.jpg)
...
![RTO Analytics breakdown of risky users](https://razorpay.com/docs/payments/magic-checkout/analytics/rto/build/browser/assets/images/rto-breakdown-risky-more.jpg)

To view all the remaining reasons, click **View all reasons**.

![RTO Analytics breakdown of risky users - view all reasons](https://razorpay.com/docs/payments/magic-checkout/analytics/rto/build/browser/assets/images/rto-breakdown-risky.jpg)
...
![RTO Analytics incremental prepaid orders gained chart](https://razorpay.com/docs/payments/magic-checkout/analytics/rto/build/browser/assets/images/rto-incremental-orders2.jpg)
...
- [RTO Insights](/razorpay-docs-md/magic-checkout/analytics/rto/insights.md)
