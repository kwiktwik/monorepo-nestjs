<!-- Source: https://razorpay.com/docs/payments/magic-checkout/android-integration -->
...
`string` Unique identifier of the order created [previously](/razorpay-docs-md/magic-checkout/android-integration.md#15-create-an-order).
...
## Related Information [Android Standard Integration](/razorpay-docs-md/payment-gateway/android-integration/standard.md)
