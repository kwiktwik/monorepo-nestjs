<!-- Source: https://razorpay.com/docs/payments/magic-checkout/capacitor-integration -->
...
If you use M1 MacBook, you need to make [these changes](/razorpay-docs-md/magic-checkout/capacitor-integration.md#16-verify-payment-signature) in your `podfile`. Add the following code inside `post_install do |installer|`:
...
`string` Unique identifier of the order created [previously](/razorpay-docs-md/magic-checkout/capacitor-integration.md#14-create-an-order).
...
## Related Information [Capacitor Standard Integration](/razorpay-docs-md/payment-gateway/capacitor-integration.md)
