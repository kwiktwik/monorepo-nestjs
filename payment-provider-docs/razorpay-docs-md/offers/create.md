<!-- Source: https://razorpay.com/docs/payments/offers/create -->
...
2. Navigate to **Offers** and click **+ Create New Offer**.
   ...
   ![Create an Offer](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-offers-dashboard.jpg)
3. The **Create an Offer** window displays four sections. Complete all sections to create the offer:
   - [Description](/razorpay-docs-md/offers/create.md#offer-description)
   - [Discount Type](/razorpay-docs-md/offers/create.md#discount-type)
   - [Applicable On](/razorpay-docs-md/offers/create.md#applicable-on)
   - [Offer Validity](/razorpay-docs-md/offers/create.md#offer-validity)

You can review the offer configurations at the end under the [**Overview**](/razorpay-docs-md/offers/create.md#offer-overview) tab.
...
![Enter the offer details to proceed](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-offers-description.jpg)

### Discount Type

There are three types of discounts that can be offered:

- [Instant](/razorpay-docs-md/offers/create.md#instant)
- [Cashback](/razorpay-docs-md/offers/create.md#cashback)
- [Already Discounted](/razorpay-docs-md/offers/create.md#already-discounted)
...
![Enter the discount details to proceed](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-offers-discount-type.jpg)
...
2. Click **Next**.
   ...
   ![Create Cashback Offers](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-cashback-1.jpg)
...
![Enter the already discounted details](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-already-discounted.jpg)

**Display Already Discounted Offer at Checkout**

If you create an offer with the `Already Discounted` discount type, you must pass the Offer\_id parameter while creating the order. This is mandatory for the offer to be available at Checkout.
...
![Enter the payment method details](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-offers-applicable-on.jpg)
...
5. **Show Offer on Checkout**: Select this check box for the offer to be displayed for all Standard Checkout payments including [Payment Links](/razorpay-docs-md/payment-links.md)   . Know more about the different ways to [display offers on Standard Checkout](/razorpay-docs-md/offers/standard-integration.md)   .

   **Watch Out!**

   If you are not using products and plugins like Razorpay Magento, Shopify, WooCommerce, Payment Links, Payment Buttons, Payment Pages and Invoices to accept payments, you **should** integrate offers with the [Orders API](/razorpay-docs-md/api/orders.md)

   for the feature to work.
6. Click **Next**.

![Enter the offer validity details to proceed](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-offers-offer-validity.jpg)
...
2. Click **Create Offer**.
   ...
   ![Check the terms and conditions and create an offer](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-offers-overview.jpg)

By default, all the created offers will be in the **enabled** state.

## Test the Offer

You can test the created offer for all Standard Checkout payments, including [Payment Links](/razorpay-docs-md/payment-links.md), [Payment Button](/razorpay-docs-md/payment-button.md), [Payment Pages](/razorpay-docs-md/payment-pages.md) and so on.
...
2. Copy the **Payment Link** URL and open it in your browser.
   ...
   ![Payment Link Test Offer](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offer-dashboard-test.jpg)
...
5. Select the payment option you created the offer on from the Dashboard. Enter the required [test details](/razorpay-docs-md/payments/test-card-details.md)
...
![Verifying transaction](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offer-details.jpg)
...
Know how to [integrate Offers with Standard Checkout](/razorpay-docs-md/offers/standard-integration.md).
...
4. In the pane that appears, go to the **Status** field and click **Disable**.
   ...
   ![Disable the offer](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-disable_offer.jpg)

## Next Steps

After you create an offer, it needs to be integrated with Checkout for the customers to view and avail the offers while making payments. Know more about [integrating offers with Standard Checkout](/razorpay-docs-md/offers/standard-integration.md).

### Related Information

- [Tutorial - How to Create Offers](/razorpay-docs-md/offers/tutorial.md)
- [Integrate offers with Standard Checkout](/razorpay-docs-md/offers/standard-integration.md)
- [Offers FAQs](/razorpay-docs-md/offers/faqs.md)
