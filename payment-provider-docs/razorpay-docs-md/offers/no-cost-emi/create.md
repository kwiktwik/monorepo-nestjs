<!-- Source: https://razorpay.com/docs/payments/offers/no-cost-emi/create -->
...
2. Navigate to **Offers** and click **+ Create No & Low Cost EMI**.
   ...
   ![Create a No Cost EMI offer](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/offers-offers-dashboard.jpg)
3. The **Create an Offer** wizard appears with the following four sections. Enter details in all these sections to create the offer.
   - [**Description**](/razorpay-docs-md/offers/no-cost-emi/create.md#description)
   - [**Discount Type**](/razorpay-docs-md/offers/no-cost-emi/create.md#discount-type)
   - [**Applicable On**](/razorpay-docs-md/offers/no-cost-emi/create.md#applicable-on)
   - [**Additional Offer Type**](/razorpay-docs-md/offers/no-cost-emi/create.md#additional-offer-type)
   - [**Offer Validity**](/razorpay-docs-md/offers/no-cost-emi/create.md#offer-validity)

You can review the offer configurations at the end under the [**Overview**](/razorpay-docs-md/offers/no-cost-emi/create.md#overview) tab.
...
![Enter the offer details to proceed](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/offers-no-cost-emi-description.jpg)
...
![Enter the discount details to proceed](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/offers-no-cost-emi-discount-type.jpg)
...
![Enter the payment method details](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/offers-no-cost-emi-applicable-on.jpg)
...
![Configure additional offer type for enhanced customer benefits](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/offers-no-cost-emi-applicable-offer-type.jpg)
...
![Enter the offer validity details to proceed](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/offers-no-cost-emi-offer-validity.jpg)
...
![Check the terms and conditions and create an offer](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/offers-no-cost-emi-overview.jpg)

By default, all the created offers are in the **enabled** state.

## Test the No Cost EMI Offer

You can test the created No Cost EMI offer for all Standard Checkout payments, including [Payment Links](/razorpay-docs-md/payment-links.md), [Payment Button](/razorpay-docs-md/payment-button.md), [Payment Pages](/razorpay-docs-md/payment-pages.md) and so on.
...
2. Copy the **Payment Link** URL and open it in your browser.
   ...
   ![Payment Link Test Offer](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/no-cost-offer-dashboard-test.jpg)
...
![Disable an Offer](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/disable-offer.jpg)
...
Know more about [integrating No Cost EMI Offers with Standard Checkout](/razorpay-docs-md/offers/no-cost-emi/standard-integration.md).

### Related Information

- [Tutorial - How to Create No Cost EMI Offers](/razorpay-docs-md/offers/no-cost-emi/tutorial.md)
- [No Cost EMI FAQs](/razorpay-docs-md/offers/low-cost-emi/faqs.md)
