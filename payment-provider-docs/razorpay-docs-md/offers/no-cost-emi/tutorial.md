<!-- Source: https://razorpay.com/docs/payments/offers/no-cost-emi/tutorial -->
...
3. The **Create an Offer** wizard appears with the following four sections. Enter details in all these sections for the offer to be created:
   - [**Description**](/razorpay-docs-md/offers/no-cost-emi/tutorial.md#description)
   - [**Discount Type**](/razorpay-docs-md/offers/no-cost-emi/tutorial.md#discount-type)
   - [**Applicable On**](/razorpay-docs-md/offers/no-cost-emi/tutorial.md#applicable-on)
   - [**Offer Validity**](/razorpay-docs-md/offers/no-cost-emi/tutorial.md#offer-validity)

You can review the offer configurations at the end under the [**Overview**](/razorpay-docs-md/offers/no-cost-emi/tutorial.md#overview) tab.
...
![Enter the details to proceed](https://razorpay.com/docs/payments/offers/no-cost-emi/build/browser/assets/images/offers-no-cost-emi-applicable-on.jpg)
...
After the offer is created, you should integrate it with Checkout so that customers can avail discounts while making payments. Know more about [integrating offers with Standard Checkout](/razorpay-docs-md/offers/no-cost-emi/standard-integration.md).

### Related Information

- [About No Cost EMI Offers](/razorpay-docs-md/offers/no-cost-emi.md)
