<!-- Source: https://razorpay.com/docs/payments/offers/standard-integration -->

After creating [offers](/razorpay-docs-md/offers/create.md) from the Dashboard, you have to integrate them on Razorpay Standard Checkout so that your customers can avail them while making payments.
...
- [Display Offers by Default](/razorpay-docs-md/offers/standard-integration.md#method-1-display-offers-by-default)
- [Display Limited Offers](/razorpay-docs-md/offers/standard-integration.md#method-2-display-limited-offers)
...
![Enable the Show Offer on Checkout option](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-no-cost-emi-offer-validity.jpg)
...
1. [Create an Offer](/razorpay-docs-md/offers/standard-integration.md#step-1-create-an-offer-from-the-dashboard)

   .
2. [Pass the Offer in Orders API](/razorpay-docs-md/offers/standard-integration.md#step-2-pass-the-offer-in-orders-api)

   .
3. [Pass order\_id and Trigger Checkout](/razorpay-docs-md/offers/standard-integration.md#step-3-pass-order-id-and-trigger-the)

   .

### Step 1: Create an Offer from the Dashboard

You can [create offers](/razorpay-docs-md/offers/create.md#create-offers) from the [Dashboard](/razorpay-docs-md/offers/create.md).

![Create offers from the Razorpay Dashboard](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-offer-dashboard.jpg)
...
`integer` Enter the amount for which the order is to be created in currency subunits. For example, for an amount of ₹10,000, enter `1000000`.
...
- [Disable Offers](/razorpay-docs-md/offers/create.md#disabling-offers)
