<!-- Source: https://razorpay.com/docs/payments/optimizer/update-default-rule -->
...
![View Default Rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-view-default-rule.jpg)
...
2. In the side pane, click **Edit Rule**.
   ...
   ![Edit Default Rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-edit-default-rule.jpg)
...
4. Update the priority. Let us assume you want to ensure that 80% of transactions are routed through Razorpay and 20% through payment gateway ABC. To do this:
   ...
   3. In the new row, enter `20` in the **Route** field and select `ABC` against the **payment via** field.
      ...
      ![Edit Default Rule Details](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-edit-default-rule-details.jpg)
   4. Click **Next**.
