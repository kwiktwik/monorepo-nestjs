<!-- Source: https://razorpay.com/docs/payments/optimizer/dynamic-routing -->
...
You may not have specific routing requirements for all your payments. A simple routing rule could be to set the priority of the gateway, which would apply to all payments. This can be done using the [default rule](/razorpay-docs-md/optimizer/update-default-rule.md).
...
Standard routing may not always work for all your transactions. Your business might have specific requirements based on various parameters such as payment method, bank, card networks, and more, which can be used to determine the most relevant payment gateway to handle a specific transaction. [Custom rules](/razorpay-docs-md/optimizer/create-custom-rule.md) provide you with the capability and flexibility to define your business rules using various payment parameters.
...
![Reorder Rule Priority](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-dynamic-routing1.gif)
...
![Reorder Rule Priority](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-dynamic-routing2.gif)
...
Apart from regular payment parameters, you might need to route payments to a particular gateway based on some business logic defined at your end, such as customer or product information. You can use [custom identifiers](/razorpay-docs-md/optimizer/create-custom-rule.md#custom-identifiers) for such requirements to pass the value to us while creating the order and use it to [create a custom rule](/razorpay-docs-md/optimizer/create-custom-rule.md).
...
![Reorder Rule Priority](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-custom-identifiers.gif)
...
![Reorder Rule Priority](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-priority-routing.gif)
...
- [Create Custom Rule](/razorpay-docs-md/optimizer/create-custom-rule.md)
- [Set Rule Priority](/razorpay-docs-md/optimizer/set-rule-priority.md)
- [Update Default Rule](/razorpay-docs-md/optimizer/update-default-rule.md)
