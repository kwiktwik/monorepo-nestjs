<!-- Source: https://razorpay.com/docs/payments/optimizer/phonepe -->
...
4. Select **PhonePe** in the list of gateways available and enter the provider name and description. Click **Next**.
   ...
   ![Add Provider Name](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/phoneprovider1-name.jpg)
...
6. Select the payment methods you want to enable for PhonePe and click **Submit**.
   ...
   ![Add Salt Key payten](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-key-salt-phonepe.jpg)
...
5. Enter the value 100 in the **Route field**, select **PhonePe** in the **Payment Via** field, and click **Next**.
   ...
   ![PhonePe target Provider](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/pinelabs-target-provider.jpg)
6. Click **Publish Rule**.

   ![PhonePe Publish Rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/pinelabs-publish-rule.jpg)
