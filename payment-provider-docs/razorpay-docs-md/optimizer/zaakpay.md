<!-- Source: https://razorpay.com/docs/payments/optimizer/zaakpay -->
...
4. Select **ZaakPay** in the list of gateways available.
   ...
   ![Add Easebuzz](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-zaakpay-add.jpg)
5. Enter the Provider Name and Description and click **Next**.

   ![Add Easebuzz provider details](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-zaakpay-add-provider.jpg)
...
7. Select the **Payment Methods** you want to enable for ZaakPay and click **Submit**.
   ...
   ![Add Easebuzz final details](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-zaakpay-final.jpg)
...
ZaakPay supports [Third-Party Validation (TPV)](/razorpay-docs-md/optimizer/third-party-validation.md#supported-bank-gateways-payment-gateways-and-payment-methods).
...
5. Enter the value 100 in the **Route field**, select **ZaakPay** in the **Payment Via** field, and click **Next**.
   ...
   ![target Provider](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/zaakpay-target-provider.jpg)
6. Click **Publish Rule**.

   ![Publish Rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/zaakpay-publish-rule.jpg)
