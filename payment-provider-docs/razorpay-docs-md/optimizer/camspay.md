<!-- Source: https://razorpay.com/docs/payments/optimizer/camspay -->
...
3. Navigate to **Card, E-Mandate, Netbanking, and UPI** → **CAMSPay**.
   ...
   ![Add CAMSPay payment provider in Razorpay](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-CAMSPay-add-provider.jpg)
4. Enter your **Provider Details** and click **Next**.

   ![Add CAMSPay payment provider in Razorpay](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-CAMSPay-add-provider-details.jpg)
5. Add your **CAMSPay Production API Details** and click **Submit**.

   ![Add CAMSPay](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-CAMSPay-provider-api-prod-details.jpg)
...
2. Click **+ Add New Rule**.
   ...
   ![Add CAMSPay rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-simpl-rule.jpg)
3. Enter the **Rule Name** and **Rule Description**. Click **Next**.

   ![Add CAMSPay](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-add-rule-name-desc.jpg)
4. Select the rule conditions as follows:
   ...
   ![Add CAMSPay](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-CAMSPay-rule-conditions.jpg)
5. In the **Route** section, enter **100**, and select **CAMSPay** in the **payment via** section. Click **Next**.

   ![Add CAMSPay](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-CAMSPay-priority-route.jpg)
