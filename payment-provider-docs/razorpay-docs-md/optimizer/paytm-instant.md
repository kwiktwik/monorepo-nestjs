<!-- Source: https://razorpay.com/docs/payments/optimizer/paytm-instant -->

Go live with your Paytm Payment Gateway account instantly using the **Instant** integration mode. This is a beta release and supports limited [payment methods](/razorpay-docs-md/optimizer/paytm-instant.md#supported-payment-methods). Follow the steps below to onboard Paytm Instant (beta) as a payment provider.

Prerequisites

- You need to have an active Paytm account with the necessary payment methods activated.
- [Write to the Paytm Support Team](/razorpay-docs-md/optimizer/paytm-instant.md#email-format-for-paytm-instant-beta)
...
- Generate API keys on the [Paytm Dashboard](https://dashboard.paytm.com/login/)  .
  ...
  ![Paytm test API keys](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-paytm-test-api-keys.jpg)
...
4. Select **PayTm** in the list of gateways available and click **Next**.
   ...
   ![Add Paytm](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-paytm-add.jpg)
5. Select **Instant (beta)** and click **Next**.

   ![Select Paytm Insant (beta)](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-paytm-select-instant.jpg)
...
8. Select the payment methods you want to enable for Paytm and click **Submit**.
   ...
   ![Add Paytm final details](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-paytm-final-new.jpg)
...
If you want to offer all payment methods and support refunds from the Dashboard, please use the [S2S integration mode](/razorpay-docs-md/optimizer/paytm-s2s.md).
...
You might be generating a unique Order id or Receipt for every order which can be passed to Paytm via [Orders API](/razorpay-docs-md/api/orders.md#orders-api).
...
5. Enter the value 100 in the **Route field**, select **Paytm** in the **payment via** field, and click **Next**.
   ...
   ![Paytm target Provider](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-paytm-rule-add.jpg)
6. Click **Publish Rule**.

   ![Paytm Publish Rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-paytm-publish-rule.jpg)
