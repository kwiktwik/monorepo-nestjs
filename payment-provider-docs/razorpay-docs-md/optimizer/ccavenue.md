<!-- Source: https://razorpay.com/docs/payments/optimizer/ccavenue -->
...
1. Write to your CCAvenue Relationship Manager asking to do the following:
   ...
   **Watch Out!**
   ...
   You must provide the attached undertaking signed on your company's letterhead along with signature of authorised personnel for CCAvenue to ignore the IP validation. Know more about [undertaking for Ignore IP Validation](/razorpay-docs-md/optimizer/ccavenue.md#undertaking-for-ignore-ip-validation)   .
...
4. Select **CCAvenue** in the list of gateways available and click **Next**.
   ...
   ![Add CCAvenue](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-ccavenue.jpg)
5. Enter the provider name and description and click **Next**.

   ![Add Provider Name CCAvenue](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/provider-name-ccavenue.jpg)
...
7. Select the payment methods you want to enable for CCAvenue and click **Submit**.
   ...
   ![Add Key CCAvenue](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-key-ccavenue-new-one.jpg)
...
5. Enter the value 100 in the **Route field**, select **CCAvenue** in the **Payment Via** field, and click **Next**.
   ...
   ![target Provider CCAvenue](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/target-provider-ccavenue.jpg)
6. Click **Publish Rule**.

   ![Publish Rule CCAvenue](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/publish-rule-ccavenue.jpg)
