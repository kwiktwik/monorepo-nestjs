<!-- Source: https://razorpay.com/docs/payments/optimizer/cashfree-instant -->
...
4. Select **Cashfree** and **Instant (beta)** in the list of gateways available and click **Next**.
   ...
   ![Add Cashfree](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-cashfree-new-instant.jpg)
...
7. Select the payment methods you want to enable for Cashfree and click **Submit**.
   ...
   ![Add App key secret cashfree instant](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-app-key-secret-instant.jpg)
