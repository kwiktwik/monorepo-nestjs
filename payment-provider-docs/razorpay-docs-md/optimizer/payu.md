<!-- Source: https://razorpay.com/docs/payments/optimizer/payu -->
...
1. [Write to your PayU Relationship Manager](/razorpay-docs-md/optimizer/payu.md#email-format)

   with the following requests and copy `production.support@payu.in` on the email:
...
2. Copy Razorpay in the email. We will provide the supporting document from our end. Know more about the [email format for PayU](/razorpay-docs-md/optimizer/payu.md#email-format)   .
3. To pass your unique **Order ID** or **Receipt** for every order, write to your relationship manager to show the `udf1` parameter in PayU Dashboard and customize report. Know more about [how to send your order id to PayU](/razorpay-docs-md/optimizer/payu.md#send-receipt-order-id-to-external-gateway)   .
...
5. Click **Add Another Condition** and enter the following rule:
   ...
   - **Select Connection**: Select **Equal to**.
   - **Select Comparing Value**: Select **the EMI Duration** as per your requirement, and click **Next**. Know more about [EMI durations](/razorpay-docs-md/optimizer/supported-gateways-aggregators.md#emi)

     for PayU EMI.

   ![Rule for EMI PayU](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/emi-payu-route.jpg)
6. Enter the value **100** in the **Route** field, select **payu** in the **payment via** field, and click Next.

   ![Add provider EMi PayU](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/emi-payu-provider.jpg)
7. Click **Publish Rule**.

   ![EMI PayU Publish Rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/emi-payu-publish-rule.jpg)
...
4. Select **PayU** in the list of gateways available and click **Next**.
   ...
   ![Add PayU](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-payu.jpg)
5. Enter the provider name and description and click **Next**.

   ![Add Provider Name](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/provider-name.jpg)
6. Enter your PayU key and Salt key.
7. Select the payment methods you want to enable for PayU and click **Submit**.

   ![Add Salt Key sodexo](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-key-salt-payu.jpg)
...
PayU supports [Third-Party Validation (TPV)](/razorpay-docs-md/optimizer/third-party-validation.md#supported-bank-gateways-payment-gateways-and-payment-methods).
...
You might be generating a unique Order ID or Receipt for every order which can be passed to PayU via [Orders API](/razorpay-docs-md/api/orders.md#orders-api). Follow the steps given below for your order id to be visible on the PayU Dashboard:
