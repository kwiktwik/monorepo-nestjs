<!-- Source: https://razorpay.com/docs/payments/optimizer/simpl -->
...
3. Look for **Simpl** and click **Request**. Know more about [how to request for a payment method](/razorpay-docs-md/dashboard/account-settings/payment-methods.md#request-for-payment-methods)   .

   ![paylater simpl request](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/simpl-paylatr-req.jpg)
...
4. Select **Simpl** in the list of gateways available.
   ...
   ![Add simpl](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-simpl.jpg)
5. Enter the provider name and description and click **Next**.

   ![simpl Add Provider Name](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/simpl-provider-name.jpg)
...
7. Select **Simpl** from the Paylaters dropdown under the payment method section, and click Submit.
   ...
   ![Add Key simpl](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-terminal-id-simpl.jpg)
...
3. Click **+ Add New Rule**.
   ...
   ![Add simpl rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-simpl-rule.jpg)
4. Enter the **Rule Name** and **Rule Description**, then click **Next**.

   ![Add simpl](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-simpl-rule-name-desc.jpg)
...
6. Click **Add Another Condition** and select the rule conditions as follows:
   ...
   ![Add simpl](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-simpl-rule-conditions.jpg)
7. Click **Next**.
8. In the **Route** section, enter **100**, select **Simpl** in the **Payment Via** section, and click **Next**.

   ![Add simpl](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-simpl-target-provider.jpg)
9. Click **Publish Rule**.

   ![Add simpl](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/simpl-publish-rule.jpg)
