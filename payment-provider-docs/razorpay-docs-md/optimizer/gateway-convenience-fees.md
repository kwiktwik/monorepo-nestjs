<!-- Source: https://razorpay.com/docs/payments/optimizer/gateway-convenience-fees -->
...
2. The checkout pop-up page is displayed. The customer selects the payment method and the payment gateway through which they want to make the payment.
   ...
   ![cfb optimizer](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/cfb-optimizer-gateway.gif)
...
- [Collect Standard Convenience Fee](/razorpay-docs-md/optimizer/convenience-fees.md)
