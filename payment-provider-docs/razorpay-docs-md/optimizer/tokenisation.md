<!-- Source: https://razorpay.com/docs/payments/optimizer/tokenisation -->
...
If you are using the saved card feature, you must redirect cards traffic to the supported gateways only. Know more about [supported payment gateways](/razorpay-docs-md/optimizer/tokenisation.md#supported-payment-gateways).
...
1. When [Razorpay is a Token Requestor(TR)](/razorpay-docs-md/optimizer/tokenisation.md#when-razorpay-is-a-token-requestortr)   .
2. When [External PA/PG or Merchant is a Token Requestor(TR)](/razorpay-docs-md/optimizer/tokenisation.md#when-external-papg-or-merchant-is-a-token)   .
...
![Tokenisation flow first time](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/tokenisation_entity.jpg)
...
![Saved card payment Tokenisation flow](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/cards-tokenisation-saved-payment2.jpg)
...
![External Tokenisation flow first time](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/external-cards-tokenisation3.jpg)
...
- Tokenisation for **Amex** and **Diners** card networks is an on-demand feature. Please raise a request with our [Support team](https://razorpay.com/support/#request)
...
- Watch this video to know how to raise a feature enablement request on the Razorpay Dashboard.
  ...
  ![Feature Request GIF](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/feature-request.gif)
...
- [APIs](/razorpay-docs-md/payment-methods/cards/token-hq/razorpay-requestor-with-network-tokens/apis.md)
- [Webhooks](/razorpay-docs-md/payment-methods/cards/token-hq/razorpay-requestor-with-network-tokens/webhooks.md)
- [Tokenisation FAQs](/razorpay-docs-md/payment-methods/cards/token-hq.md)
