<!-- Source: https://razorpay.com/docs/payments/optimizer/easebuzz -->
...
1. [Write to the Easebuzz Support Team](/razorpay-docs-md/optimizer/easebuzz.md#email-format-for-easebuzz)
...
4. Select **Easebuzz** in the list of gateways available and click **Next**.
   ...
   ![Add Easebuzz](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-easebuzz-add.jpg)
5. Enter the provider name and description and click **Next**.

   ![Add Easebuzz provider details](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-easebuzz-add-provider.jpg)
...
7. Select the **Payment Methods** you want to enable for Easebuzz and click **Submit**.
   ...
   ![Add Easebuzz final details](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-easebuzz-final.jpg)
...
- Easebuzz supports [Third-Party Validation (TPV)](/razorpay-docs-md/optimizer/third-party-validation.md#supported-bank-gateways-payment-gateways-and-payment-methods)  .

## Email Format for Easebuzz

Follow the email format given below to communicate the [prerequisites](/razorpay-docs-md/optimizer/easebuzz.md#prerequisites) or any other requirements to the Easebuzz support team:

Dear Team,

We are using a technology service provider to manage our integration with Easebuzz for account `<Merchant/Account ID>`.
...
4. Click **Next** and enter the following rule:
   ...
   ![Easebuzz Add Rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/easebuzz-add-rule.jpg)
5. Enter the value 100 in the **Route field**, select **Easebuzz** in the **Payment Via** field, and click **Next**.

   ![Easebuzz target Provider](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-easebuzz-rule-add.jpg)
6. Click **Publish Rule**.

   ![Easebuzz Publish Rule](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-easebuzz-publish-rule.jpg)
