<!-- Source: https://razorpay.com/docs/payments/route/reversal -->
...
![Payments reversal flow description](https://razorpay.com/docs/payments/route/build/browser/assets/images/route_refund.jpg)

In certain cases, Linked Accounts must directly refund the amount to the customers. To handle this, you can [enable customer refunds](/razorpay-docs-md/route/linked-account.md#enable-refunds-capability) for linked accounts from your Dashboard. The Linked Account users can [issue refund to the customer](/razorpay-docs-md/route/linked-account/initiate-refund.md) from the Linked Account Dashboard.
...
![Create reversal confirmation dialog](https://razorpay.com/docs/payments/route/build/browser/assets/images/route-make-reversal.jpg)
