<!-- Source: https://razorpay.com/docs/payments/route/linked-account -->
...
- **MFDs (Mutual Fund Distributors)**: Linked Accounts are automatically created with AMC details after Route access. Contact [support](https://razorpay.com/support/)
...
Know more about [penny testing](/razorpay-docs-md/route/faqs.md#penny-testing).
...
3. Find the relevant Linked Account and enable **Dashboard Access**.
   ...
   ![Grant Dashboard access to linked accounts](https://razorpay.com/docs/payments/route/build/browser/assets/images/allow-dashboard-access-la.jpg)
...
- While you can create a Linked Account without adding their email, you cannot grant them Dashboard access. The access can be granted or provided only after you add the email address of the Linked Account.
  ...
  ![Grant Dashboard access to linked accounts](https://razorpay.com/docs/payments/route/build/browser/assets/images/route-la-email.jpg)
...
2. Turn on the **Allow Refunds** toggle against the relevant account.
   ...
   ![Grant refund access to linked accounts](https://razorpay.com/docs/payments/route/build/browser/assets/images/permit-refund-la.jpg)
...
- [Route Overview](/razorpay-docs-md/route.md)
- [Processing Refunds](/razorpay-docs-md/route/linked-account/initiate-refund.md)
- [Settlements and Reversals](/razorpay-docs-md/route/linked-account/reversals-settlements.md)
- [Profile Management](/razorpay-docs-md/route/linked-account/manage-profile.md)
- [Route APIs](/razorpay-docs-md/api/payments/route.md)
