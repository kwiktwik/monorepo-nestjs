<!-- Source: https://razorpay.com/docs/payments/route/transfer-funds-to-linked-accounts -->

You can transfer funds to your Linked Accounts using the following methods: [Orders

Transfer funds to Linked Accounts at the time of order creation.](/razorpay-docs-md/route/transfer-funds-to-linked-accounts.md#transfer-funds-to-linked-account-via-orders) [Payments

Transfer funds to Linked Accounts from the payment received from a customer.](/razorpay-docs-md/route/transfer-funds-to-linked-accounts.md#transfers-funds-to-linked-accounts-via-payments) [Direct Transfer

Transfer funds to Linked Accounts directly from your account balance using Direct Transfers.](/razorpay-docs-md/route/transfer-funds-to-linked-accounts.md#transfer-funds-to-linked-accounts-via-direct-transfers)

#### Prerequisites

1. Create Linked Accounts. **Linked Accounts have a cooling period of 24 hours after which you can initiate transfers.**
2. Provide [Dashboard](/razorpay-docs-md/route/linked-account.md)

   access to the Linked Account to ensure transparency between the two parties, such as:
...
3. Ensure the Direct Transfer feature is enabled for your account. Contact our [support team](https://razorpay.com/support/#request)
...
This eliminates the extra step of triggering the [Direct Transfers](/razorpay-docs-md/api/payments/route/direct-transfers.md) or [Transfers via Payments API](/razorpay-docs-md/api/payments/route/create-transfers-payments.md).
...
1. Create an Order using the [Transfer via Orders API](/razorpay-docs-md/api/payments/route/create-transfers-orders.md)   .
2. [Capture the Payment](/razorpay-docs-md/payment-gateway/how-it-works.md#capture-payments)

   .
3. Set up the [webhook event `transfer.processed`](/docs/webhooks/setup-edit-payments/)   .
...
You can initiate a transfer from a payment received from a customer. This can be done from the Dashboard or using the [Create Transfers from Payments API](/razorpay-docs-md/api/payments/route/create-transfers-payments.md).
...
![Create Transfer](https://razorpay.com/docs/payments/route/build/browser/assets/images/route-make-transfer.jpg)

## Transfer Funds to Linked Accounts Via Direct Transfers

You can transfer funds to your Linked Accounts directly from your account balance using Direct Transfers. You can make direct transfers from the Dashboard or using the [Direct Transfer API](/razorpay-docs-md/api/payments/route/direct-transfers.md).
...
2. Under the **Transfers** tab, click **+Create Direct Transfer**.
   ...
   ![View Direct Transfer](https://razorpay.com/docs/payments/route/build/browser/assets/images/route-create-direct-transfer.jpg)
...
4. Click **Create Transfer**.
   ...
   ![View Direct Transfer](https://razorpay.com/docs/payments/route/build/browser/assets/images/route-add-transfer-details.jpg)
...
- [Transfers and Related Fees](/razorpay-docs-md/route/transfer-fees-example.md)
- [Schedule Settlements](/razorpay-docs-md/route/schedule-settlement.md)
- [Payment Reversals](/razorpay-docs-md/route/reversal.md)
- [Refund to Customers](/razorpay-docs-md/route/refund.md)
