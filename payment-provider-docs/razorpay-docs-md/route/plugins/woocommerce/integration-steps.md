<!-- Source: https://razorpay.com/docs/payments/route/plugins/woocommerce/integration-steps -->
...
1. Log in to the **WordPress Admin Dashboard** and navigate to **WooCommerce** → **Settings**.
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-settings.jpg)
2. Go to **Payments** and click **Razorpay – Credit Card/Debit Card/NetBanking**.

   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-settings-payments.jpg)
3. Select **Enable route module?** and click **Save changes**.

   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-enable.jpg)
...
2. Click **Razorpay Route** in the **Product data** section.
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-transfers.jpg)
...
6. You can add multiple transfer details by using the **Add Field** button.
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-transfers-details.jpg)
...
- `transfer.failed` [Enable Webhooks](/docs/webhooks/setup-edit-payments/#set-up-webhooks) to receive notifications for these events.
...
2. Click the required **Payment Id** to create a transfer.
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-payment-transfer.jpg)
3. Click **Create Transfer** and provide the following details:
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-manual-transfer.jpg)
4. Click **Create** to create a transfer.

   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-payment-transfer-create.jpg)
...
3. Click **Change** under **Transfer Details**.
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-settlement-change.jpg)
4. Select either of the following **Settlement Schedule** options:
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-settlement-schedule.jpg)
5. Click **Save**.
...
1. Log in to the **WordPress Admin Dashboard** and navigate to **Razorpay Route woocommerce** → **Payments**.
2. Check if a **Payment Id** has been generated and note the status. In case of a successful payment, the status is marked as **Captured**. Know more about various [payment states](/razorpay-docs-md/payments.md#payment-life-cycle)   .

   ![Check if the payment id is generated and the status is captured](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-payment-status.jpg)
...
2. Click **Create Direct Transfer**.
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-direct-transfer.jpg)
3. Enter the **Transfer Amount** and **Linked Account Number** to create a Transfer.
4. Click **Create**.

   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-direct-transfer2.jpg)

The transfer is successful. You can see the details in the **Transfers** tab.

![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-direct-transfer-details.jpg)
...
![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-test-integration.jpg)
...
- Ensure you have entered [Test Mode API keys](/razorpay-docs-md/api/authentication.md#generate-api-keys)
...
2. Click the recent **Transfer Id** to view the details.
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/woocommerce-route-test-transfers.jpg)
...
2. Click **Accounts** tab, and then click **+ Add Account**.
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/route-account.jpg)
...
5. Click **Add**.
   ...
   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/route-add-linked-account.jpg)
6. On the **KYC Form** pop-up page, enter **Business Details** and **Bank Account Details**, and then click **Submit Form**.

   ![](https://razorpay.com/docs/payments/route/plugins/woocommerce/build/browser/assets/images/route-add-account-kyc.jpg)
...
4. Replace the Test API Key with the Live Key in the WordPress Dashboard and accept actual payments.

You have successfully generated your API keys in Live Mode. Use this pair of `Key_ID` and `Key_Secret` to accept payments from your customers and route them to the involved third parties using [Route](/razorpay-docs-md/route.md).
