<!-- Source: https://razorpay.com/docs/payments/mobile-app/accept-payments/razorpay-me -->
...
1. We create the Razorpay.me URL for you instantly after account activation. For example, if your business name is Acme Co, your URL will be `razorpay.me/acmeco`. Know how to [edit your Razorpay.me URL.](/razorpay-docs-md/mobile-app/accept-payments/razorpay-me/manage.md)

   ![Create Razorpay.me URL](https://razorpay.com/docs/payments/mobile-app/accept-payments/build/browser/assets/images/payments-payment-handle-mobile-create.jpg)
2. You either add a specific amount for the customers to pay or directly send the link and they can enter an amount of their choice.
   ...
   ![Specify the amount the customer should pay](https://razorpay.com/docs/payments/mobile-app/accept-payments/build/browser/assets/images/payments-payment-handle-mobile-optional.jpg)
3. Share this URL with your customers through SMS, email, WhatsApp or other social media sites.

   ![Share Razorpay.me URL](https://razorpay.com/docs/payments/mobile-app/accept-payments/build/browser/assets/images/payments-payment-handle-mobile-create-share.jpg)
4. Your customers open this URL on their desktop or mobile device, enter the amount if **not** specified, select the payment method and complete the payment.
   ...
   ![Preview Razorpay.me URL](https://razorpay.com/docs/payments/mobile-app/accept-payments/build/browser/assets/images/payments-payment-handle-mobile-preview.jpg)
5. You can [check the payment status on the Razorpay Payments Mobile App.](/razorpay-docs-md/mobile-app/track-manage.md)

### Related Information

- [Manage Razorpay.me URL](/razorpay-docs-md/mobile-app/accept-payments/razorpay-me/manage.md)
- [FAQs](/razorpay-docs-md/mobile-app/faqs.md#razorpay-me)
