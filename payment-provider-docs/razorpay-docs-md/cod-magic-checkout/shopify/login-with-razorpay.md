<!-- Source: https://razorpay.com/docs/payments/cod-magic-checkout/shopify/login-with-razorpay -->
...
1. Log in to the [Shopify Store](https://accounts.shopify.com/store-login)
   ...
   and navigate to **Settings** → **Customer accounts**.
2. In the **Login Links** section, select **Legacy**.
3. Click **Switch to legacy customer accounts** to confirm.

   ![Switch to legacy customer accounts on shopify store](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-sso-legacy-account.gif)
...
6. Click **Save**.
   ...
   ![Disable captcha settings on shopify store](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-sso-captcha-disable.gif)
...
3. Turn on **Enable Login with Razorpay**.
   ...
   ![Enable Login with Razorpay](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-sso-enable.jpg)
4. You will be able to view the following options for the SSO widget:
   - [Settings](/razorpay-docs-md/cod-magic-checkout/shopify/login-with-razorpay.md#settings)
   - [Customise](/razorpay-docs-md/cod-magic-checkout/shopify/login-with-razorpay.md#customise)

![Settings and customisation options on SSO](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-sso-settings.jpg)
...
- **When a customer begins the checkout process**: Display the login screen when they proceed to checkout, just before payment. Select the checkbox.
  ...
  ![Display login screen](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-sso-display-login.jpg)
...
- **Do not ask for consent**: No explicit consent prompt is displayed for marketing communications.
  ...
  ![Ask consent from customer for marketing communication](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-sso-ask-consent.jpg)
...
- **Collect Missing Emails (recommended)**: Prompt users to enter their email during login if it is not already available.
  ...
  ![Collect missing emails](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-sso-collect-emails.jpg)
...
1. In the **Customise** section, The preview turns into edit mode. You can edit the following:
   ...
   ![Edit widget heading](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-sso-widget-heading.gif)
2. Click **Save**.
...
![Mobile/Desktop view and Live Mode](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-sso-view-mode.jpg)
...
- [Automatic Customer Tagging for Retargeting](/razorpay-docs-md/cod-magic-checkout/shopify/login-with-razorpay/automation-tags.md)
- [Customer Analytics](/razorpay-docs-md/cod-magic-checkout/shopify/login-with-razorpay/customer-analytics.md)
