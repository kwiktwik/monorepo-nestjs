<!-- Source: https://razorpay.com/docs/payments/cod-magic-checkout/shopify/configure-cod -->
...
2. Toggle on **Enable COD as a payment option** to allow customers to choose COD at checkout. Click **Yes, enable** in the confirmation pop-up modal.
   ...
   ![Enable COD as a payment option](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-checkout-cod-enable.jpg)
3. Turn on **Enable RTO Intelligence** to check customer eligibility for COD based on their purchase history. If a customer is ineligible, the COD option is hidden, displaying only prepaid options at checkout. Click **Enable COD Intelligence** in the confirmation pop-up modal.
   ...
   ![Enable RTO Intelligence](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-checkout-cod-rto-intelligence.jpg)
   ...
   **Watch Out!**
   ...
   1. Click **Activate** under **Enable RTO Intelligence**.
      ...
      ![Activate Magic Checkout](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-cod-activate-magic.jpg)
   2. On the **Checkout Settings** page, turn on **Enable Magic Checkout**.
   3. Click **Save Settings**.

      ![Enable Magic Checkout to activate RTO Intelligence](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-checkout-cod-enable-magic.jpg)
4. Select the type of setting:

- [Basic](/razorpay-docs-md/cod-magic-checkout/shopify/configure-cod.md#basic)
- [Advanced](/razorpay-docs-md/cod-magic-checkout/shopify/configure-cod.md#advanced)

  *(Recommended)*

## Basic

Configure COD for the shipping methods synced from your Shopify store. These methods are based on the profiles you have set up on Shopify to manage shipping locations and costs at checkout. Know more about [shipping options on Shopify](/razorpay-docs-md/cod-magic-checkout/shopify/shipping-options.md).
...
1. In **COD Settings**, click **Configure COD** under **Configure COD for Shopify Shipping Methods** to select the payment methods allowed for the shipping method synced from Shopify.
   ...
   **Handy Tips**
   ...
   ![Configure COD for shopify shipping methods](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-config-cod.jpg)

   **Watch Out!**

   You can configure the shipping method rate only on your Shopify store. Know more about how to create [shipping options on Shopify](/razorpay-docs-md/cod-magic-checkout/shopify/shipping-options.md)   .
...
![Configure COD for shopify shipping methods](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-config-cod-edit.jpg)
...
![Update Razorpay COD & Magic Checkout app](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-update-app.jpg)
...
![Shipping methods on checkout](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-shipping-methods.jpg)
...
3. You can create various shipping conditions:
   ...
   ![define when then conditions](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-when-then-condition.jpg)
   ...
   ![combine when and when-then condition](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-when-when-then-condition.jpg)
   ...
   ![combine when or condition](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-combine-when-or-condition.jpg)
...
![Payment methods on checkout](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-payment-methods.jpg)
...
3. You can create various payment conditions:
   ...
   ![define when then conditions](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-when-then-payment-condition.jpg)
   ...
   ![combine when and when-then condition](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-when-when-then-payment-condition.jpg)
   ...
   ![combine when or condition](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-combine-when-or-payment-condition.jpg)
