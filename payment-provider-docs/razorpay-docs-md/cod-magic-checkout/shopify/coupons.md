<!-- Source: https://razorpay.com/docs/payments/cod-magic-checkout/shopify/coupons -->
...
3. Navigate to **Coupons** → **Setup**.
   ...
   **Watch Out!**
   ...
   ![publish the coupons synced from Shopify](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-publish-sync-shopify.gif)
...
4. Navigate to **All Coupons**, click **+ Create Coupon** and **Select a Coupon Type** based on your requirement. Alternatively, you can click **+ Create Coupon** next to **Coupons on Magic** in the **Setup** section and **Select a Coupon Type**.
   ...
   **Handy Tips**
   ...
   - You can preview how customers will view the coupon summary at checkout as you configure the details.
     ...
     ![Preview Coupon Summary](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-preview-coupon.jpg)
...
7. Select the **Display this coupon at checkout** check box to display the coupon at checkout for your customers.
   ...
   ![Enter the coupon code and description](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magicx-shopify-coupon-code.jpg)
...
1. **Discount Details**: Select the **Discount type**.
   ...
   **Discount amount**: Enter an amount by which the original price should be reduced. For example, if ₹150 is the flat discount applied, ₹150 is deducted from the original price.
   ...
   ![Configure the fixed discount details](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-discount.jpg)
2. Select the **Purchase requirements** based on your preference to set eligibility criteria for the customers to use the coupon.
   ...
   ![Configure purchase requirements](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-pur-req.jpg)
3. **Coupon validity**: Set the duration for the coupon.
   ...
   ![Configure the coupon validity](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-validity.jpg)
4. **Coupon eligibility**: Create the coupon for **All customers** or **Specific customers**. If you want to create coupons for specific customers:
   ...
   1. Click **+ Add Customers**.
      ...
      ![Configure the coupon eligibility](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-eligibility.jpg)
...
5. **Usage restriction**: Set the maximum limit to which a coupon is redeemed in total and per customer.
   ...
   ![configure coupon restriction](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-restriction.jpg)
6. **Coupon combinations** *(optional)*: You can combine this coupon with various other coupons as follows:
   ...
   ![Combine coupons created with other categories](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magicx-shopify-coupon-order-combine.jpg)
...
2. Select **Products** or **Collections** to limit the discount to specific products or collections. Click **+ Add Products** or **+ Add Collections** respectively. Select the products or collections based on your requirement and click **Confirm**. You can add multiple products or collections.
   ...
   ![configure the discount details](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-discount-det.jpg)
...
7. **Coupon combinations** *(optional)*: You can combine this coupon with various other coupons as follows:
   ...
   ![Combine coupons created with other categories](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magicx-shopify-coupon-prod-combine.jpg)
...
1. Configure the **Purchase requirements** for X products based on your preference to set eligibility criteria for the customers to avail of the coupon offer.
   ...
   ![Configure minimum quantity requirements](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-min-qt-buy.jpg)
2. Select **Products** or **Collections** to limit the discount to specific products or collections. Click **+ Add Products** or **+ Add Collections** respectively. Select the products or collections based on your requirement and click **Confirm**. You can add multiple products or collections.

   ![Configure coupon products purchased](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-product-config.jpg)
...
4. Select **Products** or **Collections** for Y products as well. Refer to step 2.
   ...
   ![Configure coupon discount](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-discount-offered.jpg)
5. **Discount type**: Select the **Discount type** applicable on Y products.
   ...
   - **Fixed Discount**: In this type, a fixed amount is deducted from the original amount of the Y product.
     ...
     ![configure fixed discount](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-fixed-dis.jpg)
   - **Percentage discount**: In this type, a set percentage of the amount is deducted from the original amount of the Y product.
     ...
     ![configure percentage discount](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/magic-shopify-coupon-percentage-dis.jpg)
...
3. **Discount Offered**: Select one product variant to offer as a free gift when the purchase requirements are met:
   ...
   **Watch Out!**
   ...
   1. Click **+Add Products**.
      ...
      ![Select a product to offer free item discount](https://razorpay.com/docs/payments/cod-magic-checkout/shopify/build/browser/assets/images/cod-magic-freebie-discount.jpg)
