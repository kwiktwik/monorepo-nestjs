<!-- Source: https://razorpay.com/docs/api/qr-codes/fetch-customer-id -->

# Fetch QR Codes for a Customer ID

`GET`

`/v1/payments/qr_codes?customer_id={customer_id}`
...
The unique identifier of the customer. For example, `cust_HKsR5se84c5LTO`.
...
A wrong Customer id is provided.

Solution

{parameter} “cusomer\_id” is/are not required and should not be sent
