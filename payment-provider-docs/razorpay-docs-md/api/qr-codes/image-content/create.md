<!-- Source: https://razorpay.com/docs/api/qr-codes/image-content/create -->
...
This is an on-demand feature. Learn more about [Bharat QR](/razorpay-docs-md/payment-methods/bharatqr.md).
