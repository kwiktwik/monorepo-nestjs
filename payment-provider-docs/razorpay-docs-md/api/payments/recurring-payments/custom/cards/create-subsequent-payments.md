<!-- Source: https://razorpay.com/docs/api/payments/recurring-payments/custom/cards/create-subsequent-payments -->

You should perform the following steps to create and charge your customer subsequent payments:

1. [Create an order to charge the customer](/razorpay-docs-md/api/payments/recurring-payments/custom/cards/create-subsequent-payments.md#31-create-an-order-to-charge-the-customer)
2. [Create a recurring payment](/razorpay-docs-md/api/payments/recurring-payments/custom/cards/create-subsequent-payments.md#32-create-a-recurring-payment)
