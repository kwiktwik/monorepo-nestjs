<!-- Source: https://razorpay.com/docs/api/payments/subscriptions/fetch-subscriptions -->
...
Know more about [Subscriptions States](/razorpay-docs-md/subscriptions/states.md).
