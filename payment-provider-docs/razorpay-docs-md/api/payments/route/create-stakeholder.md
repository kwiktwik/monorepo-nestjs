<!-- Source: https://razorpay.com/docs/api/payments/route/create-stakeholder -->
...
The unique identifier of the account generated by Razorpay. For example, acc\_GLGeLkU2JUeyDZ. This id is used to fetch or update a stakeholder.
