<!-- Source: https://razorpay.com/docs/api/partners/account-onboarding/fetch -->
...
Use this endpoint to retrieve the details of an account. Know about the [various error responses](/razorpay-docs-md/api/partners/errors.md) for this API.
