<!-- Source: https://razorpay.com/docs/payments/payment-gateway/features/trusted-business -->
...
- You should have a very low number of disputes. Know more about [disputes](/razorpay-docs-md/disputes.md)  .
...
Razorpay Trusted Business badge will be enabled by default and start appearing automatically for all eligible merchants. No manual effort or integration is required. Know more about the [eligibility requirements for Razorpay Trusted Business badge](/razorpay-docs-md/payment-gateway/features/trusted-business.md#eligibility-requirements-for-razorpay-trusted-business-badge).
