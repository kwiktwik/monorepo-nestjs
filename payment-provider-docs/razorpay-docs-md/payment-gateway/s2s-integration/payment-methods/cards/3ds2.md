<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/payment-methods/cards/3ds2.0 -->
...
![Cards 3DS2 Protocol](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/payment-methods/cards/build/browser/assets/images/cards-3ds-flowchart.jpg)

### Next Steps

Choose the integration suitable for you:

- [Integration Steps for New Razorpay Businesses (Integrating after October 15, 2022)](/razorpay-docs-md/payment-gateway/s2s-integration/json/v2/build-integration/cards.md)
- [Migration Steps for Existing Razorpay Businesses (Integrated before October 15, 2022)](/razorpay-docs-md/payment-gateway/s2s-integration/json/v2/build-integration/cards/migrate-3ds2.md)
