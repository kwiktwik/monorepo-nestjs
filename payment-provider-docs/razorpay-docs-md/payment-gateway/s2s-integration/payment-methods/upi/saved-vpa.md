<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/payment-methods/upi/saved-vpa -->
...
Know how to [Build Integration](/razorpay-docs-md/payment-gateway/s2s-integration/payment-methods/upi/saved-vpa/build-integration.md) to save VPAs.
