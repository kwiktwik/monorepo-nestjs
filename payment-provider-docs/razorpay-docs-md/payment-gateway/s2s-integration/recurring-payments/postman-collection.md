<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments/postman-collection -->

We have a Postman collection to make the integration quicker and easier. Click the **Download Postman Collection** button below to get started. [Download Postman Collection](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/build/browser/assets/images/S2S_RecurringPayments.postman_collection.json.md)
...
- All Razorpay APIs are authorized using Basic Authorization.
  ...
  ![](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments/build/browser/assets/images/api-postman_basic_auth.gif)
