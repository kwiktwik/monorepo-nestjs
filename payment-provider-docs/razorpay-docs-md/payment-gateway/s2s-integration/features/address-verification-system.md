<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/features/address-verification-system -->
...
![Feature Request GIF](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/features/build/browser/assets/images/feature-request.gif)
...
- [Integrate](/razorpay-docs-md/payment-gateway/s2s-integration.md)

  with Razorpay S2S APIs.
...
![AVS Workflow](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/features/build/browser/assets/images/international-payments-address-verification-system-flow.jpg)
