<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/json/v1/build-integration/upi/collect -->
...
**1.1** [Create an Order](/razorpay-docs-md/payment-gateway/s2s-integration/json/v1/build-integration/upi/collect.md#11-create-an-order).

**1.2** [Create a Payment](/razorpay-docs-md/payment-gateway/s2s-integration/json/v1/build-integration/upi/collect.md#12-create-a-payment).

**1.3** [Handle Payment Success and Failure](/razorpay-docs-md/payment-gateway/s2s-integration/json/v1/build-integration/upi/collect.md#13-handle-payment-success-and-failure).

**1.4** [Verify Payment Signature](/razorpay-docs-md/payment-gateway/s2s-integration/json/v1/build-integration/upi/collect.md#14-verify-payment-signature).

**1.5** [Verify Payment Status](/razorpay-docs-md/payment-gateway/s2s-integration/json/v1/build-integration/upi/collect.md#15-verify-payment-status).
...
- An order should be created for every payment.
- You can create an order using the [Orders API](/razorpay-docs-md/payment-gateway/s2s-integration/json/v1/build-integration/upi/collect.md#api-sample-code)  . It is a server-side API call. Know how to [authenticate](/razorpay-docs-md/dashboard/account-settings/api-keys.md#generate-api-keys)
...
![Payment details on Dashboard](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/json/v1/build-integration/upi/build/browser/assets/images/testpayment.jpg)
