<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/redirect/test-integration -->
...
## Next Steps [Step 3: Go-live Checklist](/razorpay-docs-md/payment-gateway/s2s-integration/redirect/go-live-checklist.md)
