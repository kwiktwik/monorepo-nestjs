<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/drupal-commerce/troubleshooting-faqs -->
...
2. In the **Website and app settings** section, click **Webhooks**.
   ...
   ![Navigate to Webhooks](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/drupal-commerce/build/browser/assets/images/account-settings-webhooks.jpg)
...
**Order Id**: When a customer clicks the pay button on your app, an Order is created and a corresponding "order\_id" is generated in the response.
...
4. Select the check box and click **Uninstall**.
   ...
   ![Uninstall Drupal plugin](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/drupal-commerce/build/browser/assets/images/drupal-uninstall.jpg)
