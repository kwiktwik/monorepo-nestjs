<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/wix -->

#### Troubleshooting & FAQs

Troubleshoot common error scenarios and find answers to frequently asked questions about the Razorpay Wix Extension.
...
Watch the video before you start integrating the Wix extension with Payment Gateway.

#### Integration Steps

Check the steps to integrate the Wix extension with Payment Gateway.
