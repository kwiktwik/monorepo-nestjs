<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/whmcs/faqs -->
...
1. Reinstall the Razorpay WHMCS plugin and ensure that your system meets all the requirements mentioned [here](/razorpay-docs-md/payment-gateway/ecommerce-plugins/whmcs/integration-steps.md)   .
