<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ios-integration/standard/payment-methods/turbo-upi -->
...
You can seamlessly integrate Turbo UPI with Razorpay iOS Standard SDK. Explore the full potential of [Razorpay Turbo UPI](/razorpay-docs-md/payment-methods/upi/turbo-upi.md) and know How it Works.

![Turbo UPI Standard Checkout Flow](https://razorpay.com/docs/payments/payment-gateway/ios-integration/standard/payment-methods/build/browser/assets/images/turbo-upi-flow.jpg)

## Prerequisites

- Integrate with [Razorpay iOS Standard SDK](/razorpay-docs-md/payment-gateway/ios-integration/standard/integration-steps.md)  . Ensure that you integrate with SDK version 1.0.0 or higher.
...
Ensure your customers [onboard with Razorpay Turbo UPI](/razorpay-docs-md/payment-methods/upi/turbo-upi.md#2-onboarding-flow) to get started.
...
Razorpay SDK will handle all the changes related to `UpiTurbo` internally. To integrate with the payment flow, [pass payment option and display the checkout form](/razorpay-docs-md/payment-gateway/ios-integration/standard/integration-steps.md#14-pass-payment-options-and-display-checkout-form).
...
![View the non-transactional flow](https://razorpay.com/docs/payments/payment-gateway/ios-integration/standard/payment-methods/build/browser/assets/images/turbo-upi-non-transactional.jpg)
...
TurboError [Refer to the list of possible error reasons](/razorpay-docs-md/payment-gateway/ios-integration/standard/payment-methods/turbo-upi/error-codes.md).
