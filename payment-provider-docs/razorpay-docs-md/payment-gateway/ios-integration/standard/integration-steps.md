<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ios-integration/standard/integration-steps -->

Follow these steps to integrate your iOS application:

#### 1. Build Integration

Integrate iOS Standard Checkout.
...
![add Frameworks, Libraries and Embed Content](https://razorpay.com/docs/payments/payment-gateway/ios-integration/standard/build/browser/assets/images/ios-embed-framework.gif)
...
- You can create an order using the [Orders API](/razorpay-docs-md/payment-gateway/ios-integration/standard/integration-steps.md#api-sample-code)  . It is a server-side API call. Know how to [authenticate](/razorpay-docs-md/dashboard/account-settings/api-keys.md#generate-api-keys)
...
![Payment details on Dashboard](https://razorpay.com/docs/payments/payment-gateway/ios-integration/standard/build/browser/assets/images/testpayment.jpg)

## 2. Test Integration

After the integration is complete, a **Pay** button appears on your webpage/app.

![Test integration on your webpage/app](https://razorpay.com/docs/payments/payment-gateway/ios-integration/standard/build/browser/assets/images/test-int.gif)
