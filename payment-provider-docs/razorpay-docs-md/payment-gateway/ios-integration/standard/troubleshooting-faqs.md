<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ios-integration/standard/troubleshooting-faqs -->

1. I am getting an error "Razorpay contains unsupported Architecture x86\_64" while submitting the archive to the app store. What should I do?
...
- **Resolution**: Insert [this](https://s3.ap-south-1.amazonaws.com/rzp-1415-prod-mobile/ios/CustomLinks/StripInvalidArchitectures.sh)
...
No, we do not support Xamarin. However, since Xamarin is essentially a wrapper around Android and iOS, you can create your own Xamarin wrapper using our [Android](/razorpay-docs-md/payment-gateway/android-integration/standard.md) and [iOS](/razorpay-docs-md/payment-gateway/ios-integration/standard.md)
...
Yes, you can enable UPI Intent on your [Android](/razorpay-docs-md/payment-gateway/web-integration/standard/webview/upi-intent-android.md) or [iOS](/razorpay-docs-md/payment-gateway/web-integration/standard/webview/upi-intent-ios.md) app.
