<!-- Source: https://razorpay.com/docs/payments/payment-gateway/cordova-integration/integration-steps -->

Follow these steps to integrate your Cordova application:

#### 1. Build Integration

Integrate Cordova Standard Checkout.
...
- You can create an order using the [Orders API](/razorpay-docs-md/payment-gateway/cordova-integration/integration-steps.md#api-sample-code)  . It is a server-side API call. Know how to [authenticate](/razorpay-docs-md/dashboard/account-settings/api-keys.md#generate-api-keys)
...
```
3. Add the [Checkout code](/razorpay-docs-md/payment-gateway/cordova-integration/integration-steps.md#131-code-to-add-pay-button)

   along with the `order_id` generated in the first step. Add the API key generated by you on the Dashboard.
...
![Payment details on Dashboard](https://razorpay.com/docs/payments/payment-gateway/cordova-integration/build/browser/assets/images/testpayment.jpg)

## 2. Test Integration

After the integration is complete, a **Pay** button appears on your webpage/app.

![Test integration on your webpage/app](https://razorpay.com/docs/payments/payment-gateway/cordova-integration/build/browser/assets/images/test-int.gif)
