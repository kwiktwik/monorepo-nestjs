<!-- Source: https://razorpay.com/docs/payments/payment-gateway/android-integration/custom/native-otp-integration -->
...
**1.1** [Update Razorpay Android Custom SDK version](/razorpay-docs-md/payment-gateway/android-integration/custom/native-otp-integration.md#11-update-razorpay-android-custom-sdk-version).

**1.2** [Implement `CardsFlowCallback` interface in the `getCardsFlow` function](/razorpay-docs-md/payment-gateway/android-integration/custom/native-otp-integration.md#12-implement-cardsflowcallback-interface-in-getcardsflow-function).
...
**1.4** [Handle Success and Error Events](/razorpay-docs-md/payment-gateway/android-integration/custom/native-otp-integration.md#14-handle-success-and-error-events).

**1.5** [Store Field in Server](/razorpay-docs-md/payment-gateway/android-integration/custom/native-otp-integration.md#15-store-fields-in-server).

**1.6** [Verify Payment Signature](/razorpay-docs-md/payment-gateway/android-integration/custom/native-otp-integration.md#16-verify-payment-signature).
...
## Next Steps [Step 2: Test Integration](/razorpay-docs-md/payment-gateway/android-integration/custom/test-native-otp-integration.md)
