<!-- Source: https://razorpay.com/docs/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock -->
...
2. Integrate with the [Razorpay Android Custom SDK](/razorpay-docs-md/payment-gateway/android-integration/custom/build-integration.md)   .
...
Follow these steps to integrate with [Turbo UPI with UI](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui.md#1-integration-steps).
...
4. The device binding process will initiate, including SMS sending.
5. After successful device binding, a list of banks for selection will appear.
6. Select Axis Bank or SBI Bank as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
...
6. Select Axis Bank or SBI Bank as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
7. The accounts based on the bank selection will be shown.
8. Select the account ending with xxxx0203, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
...
6. Select Axis Bank or SBI Bank as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
7. The accounts based on the bank selection will be shown.
8. Select an account ending with xxxx0001, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
...
4. The device binding process will initiate, including SMS sending.
5. After successful device binding, a list of banks for selection will appear.
6. Select HDFC or Yes Bank as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
...
7. The accounts based on the bank selection will be shown.
8. Select an account ending with xxxx0001, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
9. A card details screen will be displayed. Enter the details from [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
10. Enter bank OTP from [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)

    on the next screen then proceed.
...
7. The accounts based on the bank selection will be shown.
8. Select an account ending with xxxx0001, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
9. A card details screen will be displayed. Enter the details form [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)
...
8. Select an account ending with xxxx0203, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
...
7. The accounts based on bank selection will be shown.
8. Select an account ending with xxxx0001, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
9. A card detail screen will be displayed. Enter the details from [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
10. Enter the bank OTP from [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)
...
1. Begin by following the [integration steps](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui.md#1-integration-steps)   , specifically the `submit` method.
...
1. Begin by following the [integration steps](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui.md#1-integration-steps)   , specifically the `submit` method.
2. Enter an amount lower than the account balance mentioned in [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
...
1. Begin by following the [integration steps](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui.md#1-integration-steps)   , specifically the `submit` method.
2. Enter an amount greater than the account balance as mentioned in [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
3. Enter the correct PIN.
...
5. Click on Reset PIN and follow the prompts to input the bank OTP from the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)   .
...
2. A card details screen is displayed. Enter the details from the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)

   section.
3. Enter bank OTP from the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)

   on the next screen and then proceed.
...
- Based on the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)

  for bank accounts, choose a bank for a single, multiple or no bank account.
- Use the same ATM PIN and card Number mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#21-test-data)  .
- The UPI PIN will revert to its default setting or be removed when you uninstall or clear storage.
- Amount ₹24 is blocked for special cases. Please refer to [Additional Cases](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui-mock.md#24-additional-cases)  .
...
Complete this [Go-live Checklist](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui.md#3-go-live-checklist) to take your integration live.
