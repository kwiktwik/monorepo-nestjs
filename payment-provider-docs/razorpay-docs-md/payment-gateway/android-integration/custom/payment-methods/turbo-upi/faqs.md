<!-- Source: https://razorpay.com/docs/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/faqs -->
...
- Using the Turbo UPI logo is recommended for a better user experience. You can download the logo using the button below. [Download Turbo UPI Logo](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/build/browser/assets/images/Turbo-upi-logo.md)

  ![Turbo UPI Logo image](https://razorpay.com/docs/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/build/browser/assets/images/turbo-upi-logo.jpg)
...
- Conversion rates of transaction flow and account linking flow. [Refer to the list of possible error reasons](/razorpay-docs-md/payment-gateway/android-integration/custom/payment-methods/turbo-upi/error-codes.md)
