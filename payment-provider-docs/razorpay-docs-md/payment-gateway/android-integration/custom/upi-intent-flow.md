<!-- Source: https://razorpay.com/docs/payments/payment-gateway/android-integration/custom/upi-intent-flow -->
...
![](https://razorpay.com/docs/payments/payment-gateway/android-integration/custom/build/browser/assets/images/android-integration-custom-intent-flow.jpg)

## Integration Steps

**1.1** [Install Razorpay Android UPI Intent SDK](/razorpay-docs-md/payment-gateway/android-integration/custom/upi-intent-flow.md#11-install-razorpay-android-upi-intent-sdk).

**1.2** [Initialise SDK by Adding API Key](/razorpay-docs-md/payment-gateway/android-integration/custom/upi-intent-flow.md#12-initialise-sdk-by-adding-api-key).

**1.2** [Pass Result to Razorpay](/razorpay-docs-md/payment-gateway/android-integration/custom/upi-intent-flow.md#13-pass-result-to-razorpay).

### 1.1 Install Razorpay Android UPI Intent SDK [Download the jar file](http://rzp-mobile.s3.amazonaws.com/android/upi-intent-sdk/razorpay-upi-intent-sdk.jar) and include it in the `libs` folder.
