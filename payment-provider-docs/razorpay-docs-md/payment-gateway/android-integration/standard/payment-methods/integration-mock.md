<!-- Source: https://razorpay.com/docs/payments/payment-gateway/android-integration/standard/payment-methods/integration-mock -->
...
2. Integrate with the [Razorpay Android Standard Checkout SDK](/razorpay-docs-md/payment-gateway/android-integration/standard/integration-steps.md)   .
...
Follow these steps to integrate with [Turbo UPI](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/turbo-upi.md).
...
4. The device binding process will initiate, including SMS sending.
5. After successful device binding, a list of banks for selection will appear.
6. Select Axis Bank or SBI Bank as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
...
8. Select the account ending with xxxx0203, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
...
6. Select Axis Bank or SBI Bank as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
7. The accounts based on the bank selection will be shown.
8. Select an account ending with xxxx0001, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
...
4. The device binding process will initiate, including SMS sending.
5. After successful device binding, a list of banks for selection will appear.
6. Select HDFC or Yes Bank as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
...
7. The accounts based on the bank selection will be shown.
8. Select an account ending with xxxx0001, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
9. A card details screen will be displayed. Enter the details from [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
10. Enter bank OTP from [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)
...
7. The accounts based on the bank selection will be shown.
8. Select an account ending with xxxx0001, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
9. A card details screen will be displayed. Enter the details form [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)
...
8. Select an account ending with xxxx0203, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
...
7. The accounts based on bank selection will be shown.
8. Select an account ending with xxxx0001, as mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
9. A card detail screen will be displayed. Enter the details from [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
10. Enter the bank OTP from [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)
...
5. Click on Reset PIN and follow the prompts to input the bank OTP from the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)   .
...
- Based on the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)

  for bank accounts, choose a bank for a single, multiple or no bank account.
- Use the same ATM PIN and card Number mentioned in the [Test Data](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#21-test-data)  .
- The UPI PIN will revert to its default setting or be removed when you uninstall or clear storage.
- Amount ₹24 is blocked for special cases. Please refer to [Additional Cases](/razorpay-docs-md/payment-gateway/android-integration/standard/payment-methods/integration-mock.md#24-additional-cases)  .
