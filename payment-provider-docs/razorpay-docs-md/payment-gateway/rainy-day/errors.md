<!-- Source: https://razorpay.com/docs/payments/payment-gateway/rainy-day/errors -->
...
If you are using an official [Razorpay Language-wise SDK Integration](/razorpay-docs-md/server-integration.md), the error responses result in exceptions that need to be handled in your integration.
...
To understand more about error codes, refer to the [Error Codes](/docs/errors/) section.
