<!-- Source: https://razorpay.com/docs/payments/payment-gateway/react-native-integration/standard/troubleshooting-faqs -->
...
#### [For iOS (via CocoaPods)](/razorpay-docs-md/payment-gateway/react-native-integration/standard/troubleshooting-faqs.md#For iOS (via CocoaPods))
...
#### [For iOS (without CocoaPods)](/razorpay-docs-md/payment-gateway/react-native-integration/standard/troubleshooting-faqs.md#For iOS (without CocoaPods))
