<!-- Source: https://razorpay.com/docs/payments/payment-gateway/web-integration/standard/webview/upi-intent-ios -->

Follow the steps given below to enable UPI intent in WebView on your iOS application:

**1.1** [Setup App to Handle Deep Links](/razorpay-docs-md/payment-gateway/web-integration/standard/webview/upi-intent-ios.md#11-setup-app-to-handle-deep-links)

**1.2** [Setup WKNavigationDelegate for WKWebView](/razorpay-docs-md/payment-gateway/web-integration/standard/webview/upi-intent-ios.md#12-setup-wknavigationdelegate-for-wkwebview)

**1.3** [Conforming to WKNavigationDelegate](/razorpay-docs-md/payment-gateway/web-integration/standard/webview/upi-intent-ios.md#13-conforming-to-wknavigationdelegate)

**1.4** [Enable UPI Intent Support](/razorpay-docs-md/payment-gateway/web-integration/standard/webview/upi-intent-ios.md#14-enable-upi-intent-support)
...
2. Pass `webview_intent: true` parameter in the [payload](/razorpay-docs-md/payment-gateway/web-integration/standard/integration-steps.md#122-code-to-add-pay-button)
