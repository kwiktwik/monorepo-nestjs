<!-- Source: https://razorpay.com/docs/payments/payment-gateway/web-integration/custom/test-integration -->

After the integration is complete, a **Pay** button appears on your webpage/app.

![Test integration on your webpage/app](https://razorpay.com/docs/payments/payment-gateway/web-integration/custom/build/browser/assets/images/test-int.gif)
...
## Next Steps [Step 3: Go Live Checklist](/razorpay-docs-md/payment-gateway/web-integration/custom/go-live-checklist.md)
