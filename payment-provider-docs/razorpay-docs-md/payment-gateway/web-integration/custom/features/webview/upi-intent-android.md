<!-- Source: https://razorpay.com/docs/payments/payment-gateway/web-integration/custom/features/webview/upi-intent-android -->

Follow the steps given below to enable UPI intent in WebView on your android application:

**1.1** [Add WebView to Android App](/razorpay-docs-md/payment-gateway/web-integration/custom/features/webview/upi-intent-android.md#11-add-webview-to-android-app)

**1.2** [Setup WebViewClient](/razorpay-docs-md/payment-gateway/web-integration/custom/features/webview/upi-intent-android.md#12-setup-webviewclient)

**1.3** [Handle Deep Links in shouldOverrideUrlLoading()](/razorpay-docs-md/payment-gateway/web-integration/custom/features/webview/upi-intent-android.md#13-handle-deep-links-in-shouldoverrideurlloading-)

**1.4** [Enable UPI Intent Support](/razorpay-docs-md/payment-gateway/web-integration/custom/features/webview/upi-intent-android.md#14-enable-upi-intent-support)
