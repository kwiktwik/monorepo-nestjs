<!-- Source: https://razorpay.com/docs/payments/payment-gateway/web-integration/custom/chargeback/test-integration -->

After the integration is complete, a **Pay** button appears on your webpage/app.

![Test integration on your webpage/app](https://razorpay.com/docs/payments/payment-gateway/web-integration/custom/chargeback/build/browser/assets/images/test-int.gif)
...
## Next Steps [Step 3: Go Live Checklist](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/go-live-checklist.md)
