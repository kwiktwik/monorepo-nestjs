<!-- Source: https://razorpay.com/docs/payments/payment-gateway/emi²/payment-methods/custom-integration -->
...
![Feature Request GIF](https://razorpay.com/docs/payments/payment-gateway/emi²/payment-methods/build/browser/assets/images/feature-request.gif)
...
### Related Information [EMI² Suite](/razorpay-docs-md/payment-gateway/emi-.md)
