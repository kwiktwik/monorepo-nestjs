<!-- Source: https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/customise -->
...
1. Log in to the [WordPress account](https://wordpress.com/log-in)   , navigate to **WooCommerce** → **Settings** and click the **Payments** tab.
   ...
   ![WooCommerce settings](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/woocommerce-settings.jpg)
2. In the **Payments** tab, scroll down to **Razorpay** and click **Manage** to edit the settings.

   ![edit](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-razorpay-edit.jpg)
3. Select **Affordability Widget**.

   ![Select Affordability Widget to customise the widget](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-woocommerce-affordability.jpg)

You can now customise the following options:

1. [Offers](/razorpay-docs-md/payment-gateway/emi-/widget/woocommerce/customise.md#1-offers)
...
2. [Payment Methods](/razorpay-docs-md/payment-gateway/emi-/widget/woocommerce/customise.md#2-payment-methods)
...
3. [Themes and Colours](/razorpay-docs-md/payment-gateway/emi-/widget/woocommerce/customise.md#3-themes-and-colours)
...
Configure the offers you want to display on the website based on your requirement. The customers can choose from a wide range of offers for your product or service. Know how to [create offers](/razorpay-docs-md/offers/create.md).

**Handy Tips**

By default, all the offers marked visible on the Dashboard during the offer creation appear on the widget.

![Configure the offers on the widget](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-woocommerce-offers.jpg)
...
By default, all those offers with the **Show Offer on Checkout** option enabled during creation will appear on the widget. Additionally, you can enter the `offer_id` of the offer that did not have the [Show Offer on Checkout](/razorpay-docs-md/offers/create.md#offer-validity:~:text=Show%20Offer%20on%20Checkout) option enabled during offer creation.
...
![Configure the Payment Methods on the widget](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-woocommerce-payment-methods.jpg)
...
Razorpay supports [Debit Card](/razorpay-docs-md/payment-gateway/emi-/faqs.md#5-can-you-provide-a-list-of-the) and [Credit Card](/razorpay-docs-md/payment-gateway/emi-/faqs.md#1-what-are-the-standard-credit-card-interest)

EMI providers for EMI options. By default, all EMI options satisfying the minimum transaction amount will appear on the widget. If you want to display limited EMI options on the widget, enter the list of **provider codes** based on your requirement.
...
To display the [Pay Later](/razorpay-docs-md/payment-methods/pay-later.md) payment option, select the **Enable Pay Later** check box. To disable the Pay Later payment option, clear the check box. If you disable the Pay Later options, they will not appear on the widget and the customers will not be able to view them.
...
![Configure the themes and colours of the widget](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-woocommerce-theme.jpg)
...
![Configure the widget theme colour](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-theme-colour.jpg)
...
![Customise the heading colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-heading.jpg)
...
![Customise the content colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-content.jpg)

![View the customisation field on the WooCommerce Dashboard](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-woocommerce-theme2.jpg)
...
![Customise the link colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-link.jpg)
...
![Customise the appearance of the logo on the widget](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/woocommerce/build/browser/assets/images/widget-dark-logo.jpg)

Once you customise the widget based on your requirement, click **Save Changes**.

### Related Information

- [Affordability Widget: WooCommerce FAQs](/razorpay-docs-md/payment-gateway/emi-/faqs.md#woocommerce)
