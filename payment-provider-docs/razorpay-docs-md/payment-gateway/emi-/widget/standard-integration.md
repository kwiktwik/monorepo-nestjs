<!-- Source: https://razorpay.com/docs/payments/payment-gateway/emi²/widget/standard-integration -->
...
- This feature is only supported on [Native Website](/razorpay-docs-md/payment-gateway/emi-/widget/native-web.md)
...
- Generate the [API keys](/razorpay-docs-md/api/authentication.md#generate-api-keys)
  ...
  from the Dashboard. You can use the **Test Mode** keys to test the integration and preview the Widget. Later, switch to **Live Mode** of the Dashboard, generate the [Live API keys](/razorpay-docs-md/api/authentication.md#live-mode-api-keys)
...
Pass the callback function [previously defined](/razorpay-docs-md/payment-gateway/emi-/widget/standard-integration.md#11-define-checkout-callback-function) to `widgetConfig` as `checkout_callback`, when initialising Razorpay Affordability Widget.
...
`string` The currency in which the customer should make the payment. Check the list of [supported currencies](/razorpay-docs-md/international-payments.md#supported-currencies).
...
<script src="https://cdn.razorpay.com/widgets/emi²/affordability.js"> </script> // new
<script>
  var options = {
    "key": "YOUR_KEY_ID", 
    "amount": "400000", 
