<!-- Source: https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/customise -->
...
1. Log in to the [Shopify Store](https://accounts.shopify.com/store-login)
   ...
   and navigate to **Apps** → **Razorpay Affordability Widget**.
2. Select **Customisation Options**.

   ![Customise the widget on Shopify](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/shopify-widget-customise.jpg)

You can now customise the following options:

1. [Themes and Colours](/razorpay-docs-md/payment-gateway/emi-/widget/shopify/customise.md#1-themes-and-colours)
   ...
   - Enable Button Link
   - Widget Dark Mode
2. [Payment Methods](/razorpay-docs-md/payment-gateway/emi-/widget/shopify/customise.md#2-payment-methods)
   ...
   - Pay Later Providers
3. [Offers](/razorpay-docs-md/payment-gateway/emi-/widget/shopify/customise.md#3-offers)
...
![Theme and colour customisation](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/shopify-widget-theme.jpg)
...
![Customise the widget theme colour](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/widget-theme-colour-v2.jpg)
...
![Customise the heading colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/widget-heading-v2.jpg)
...
![Customise the content colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/widget-content-v2.jpg)
...
![Customise the link colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/widget-link-color-size.jpg)

![Theme and colour customisation](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/shopify-widget-theme2.jpg)
...
![Customise the content colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/widget-discount-v2.jpg)
...
![Customise the appearance of the logo on the widget](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/widget-dark-logo-v2.jpg)
...
![Customise the link colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/widget-button-link.jpg)
...
![Enable widget dark mode on your website](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/widget-dark-mode.jpg)

## 2. Payment Methods

Configure the payment methods you want to display on the store based on your requirement.

![Customise payment methods](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/shopify-widget-payment-methods.jpg)
...
EMI providers for EMI options. By default, all EMI options satisfying the minimum transaction amount will appear on the widget. If you want to display limited EMI options on the widget, in the **Options** drop-down list, select/unselect the providers of your choice.

#### 2.5 Cardless EMI Providers

Razorpay supports [these Cardless EMI providers](/razorpay-docs-md/payment-gateway/emi-/faqs.md#cardless-emi). By default, all Cardless EMI options satisfying the minimum transaction amount will appear on the widget. To display limited Cardless EMI options on the widget, in the **Options** drop-down list, select/unselect the provider of your choice.

#### 2.6 Pay Later Providers

Razorpay supports [these Pay Later providers](/razorpay-docs-md/payment-gateway/emi-/faqs.md#2-what-are-the-standard-interest-rates-charged). By default, all Pay Later options satisfying the minimum transaction amount will appear on the widget. If you want to display limited Pay Later options on the widget, in the **Options** drop-down list, select/unselect the provider of your choice.

## 3. Offers

Configure the offers you want to display on the store based on your requirement. Customers can choose from a wide range of offers for your product or service. Know how to [create offers](/razorpay-docs-md/offers/create.md).

**Handy Tips**

By default, all the offers marked visible on the Dashboard during the offer creation appear on the widget.

![Customise offers](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/shopify/build/browser/assets/images/shopify-widget-offers.jpg)
...
- [Affordability Widget: Shopify FAQs](/razorpay-docs-md/payment-gateway/emi-/faqs.md#shopify)
