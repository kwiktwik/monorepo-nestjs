<!-- Source: https://razorpay.com/docs/payments/payment-gateway/emi²/widget/native-web/customise -->

After you successfully integrate the widget on your website, you can customise the following options:

1. [Offers](/razorpay-docs-md/payment-gateway/emi-/widget/native-web/customise.md#1-offers)

   .
   - Add additional Offers.
   - Show limited Offers.
   - Disable Offers.
2. [Payment Methods](/razorpay-docs-md/payment-gateway/emi-/widget/native-web/customise.md#2-payment-methods)

   (EMI, Cardless EMI and Pay Later).
   - Configure the list of providers for various payment methods.
   - Disable payment methods.
3. [Themes and Colours](/razorpay-docs-md/payment-gateway/emi-/widget/native-web/customise.md#3-themes-and-colours)
...
Configure the offers you want to display on the website based on your requirement. The customers can make a choice from a wide range of offers available for your product or service. Know how to [create offers](/razorpay-docs-md/offers/create.md).
...
`string` API Key ID generated from the [Dashboard](/razorpay-docs-md/api/authentication.md#generate-api-keys).
...
EMI providers for EMI options. By default, all EMI options satisfying the minimum transaction amount will appear on the widget. In case you want to display limited EMI options on the widget, enter the list of **provider codes** based on your requirement.
...
`array<string>` List of limited set of [providers](/razorpay-docs-md/payment-gateway/emi-/faqs.md#1-what-are-the-issuers-that-razorpay-supports) for EMI options.
...
`array<string>` List of limited set of [providers](/razorpay-docs-md/payment-methods/emi/cardless-emi.md#supported-payment-partners) for Cardless EMI options.
...
`array<string>` List of limited set of [providers](/razorpay-docs-md/payment-methods/pay-later.md#providers) for Pay Later options.
...
![Customise the widget theme colour](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/native-web/build/browser/assets/images/widget-theme-colour-v2.jpg)
...
![Customise the heading colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/native-web/build/browser/assets/images/widget-heading-v2.jpg)
...
![Customise the content colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/native-web/build/browser/assets/images/widget-content-v2.jpg)
...
![Customise the content colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/native-web/build/browser/assets/images/widget-discount-v2.jpg)
...
![Customise the link colour and font size](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/native-web/build/browser/assets/images/widget-button-link.jpg)
...
![Customise the appearance of the logo on the widget](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/native-web/build/browser/assets/images/widget-dark-logo-v2.jpg)
...
![Enable widget dark mode on your website](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/native-web/build/browser/assets/images/widget-dark-mode.jpg)
...
- [Integration steps](/razorpay-docs-md/payment-gateway/emi-/widget/native-web.md)
- [Affordability Widget FAQs](/razorpay-docs-md/payment-gateway/emi-/faqs.md#affordability-widget)
