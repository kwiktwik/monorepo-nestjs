<!-- Source: https://razorpay.com/docs/payments/payment-gateway/emi²/widget/faqs -->

Find answers to the commonly asked questions about the Affordability Widget.

- [Generic](/razorpay-docs-md/payment-gateway/emi-/widget/faqs.md#generic)
- [Native Website](/razorpay-docs-md/payment-gateway/emi-/widget/faqs.md#native-website)
- [WooCommerce Website](/razorpay-docs-md/payment-gateway/emi-/widget/faqs.md#woocommerce)
- [Shopify Store](/razorpay-docs-md/payment-gateway/emi-/widget/faqs.md#shopify)
...
- All EMI, Cardless EMI, and Pay Later options enabled by you which satisfies the minimum order limit. Know more about the minimum order limit for [EMI](/razorpay-docs-md/payment-gateway/emi-/faqs.md#2-what-are-the-standard-credit-card-interest)  , [Cardless EMI](/razorpay-docs-md/payment-gateway/emi-/faqs.md#cardless-emi)

  and [Pay Later](/razorpay-docs-md/payment-gateway/emi-/faqs.md#pay-later)  .
...
The widget is available on [Android](/razorpay-docs-md/payment-gateway/emi-/widget/android.md) but **not** on iOS SDK.

6. Is it possible to integrate the widget on my website using plugins?

Yes, it is possible to integrate the widget on your website using [WooCommerce](/razorpay-docs-md/payment-gateway/emi-/widget/woocommerce.md) and [Shopify](/razorpay-docs-md/payment-gateway/emi-/widget/shopify.md).
...
- [Discount Whisperer](/razorpay-docs-md/payment-gateway/emi-/widget/features.md#discount-whisperer)

  .
- [Eligibility Check](/razorpay-docs-md/payment-gateway/emi-/widget/features.md#eligibility-check)

  .
- [Checkout from Widget](/razorpay-docs-md/payment-gateway/emi-/widget/features.md#checkout-from-widget)
...
Know more about the [customisation options](/razorpay-docs-md/payment-gateway/emi-/widget/native-web/customise.md).
...
Know more about how to [disable offers](/razorpay-docs-md/payment-gateway/emi-/widget/native-web/customise.md#14-disable-the-offers).

You can also disable [EMI](/razorpay-docs-md/payment-gateway/emi-/widget/native-web/customise.md#212-disable-emi-options), [Cardless EMI](/razorpay-docs-md/payment-gateway/emi-/widget/native-web/customise.md#222-disable-cardless-emi-options) and [Pay Later](/razorpay-docs-md/payment-gateway/emi-/widget/native-web/customise.md#232-disable-pay-later-options) options on the widget.
...
Know more about [themes and colours](/razorpay-docs-md/payment-gateway/emi-/widget/native-web/customise.md#3-themes-and-colours).

4. What is Checkout from Affordability Widget and how does it benefit my business? [Checkout from Affordability Widget](/razorpay-docs-md/payment-gateway/emi-/widget/standard-integration.md) is a feature that allows customers browsing EMI plans via the Affordability Widget on your website to directly checkout from the Widget itself. This enables a frictionless checkout journey for customers.
...
3. They are then redirected to the Razorpay checkout if you have integrated the widget with our [Standard Checkout](/razorpay-docs-md/payment-gateway/emi-/widget/standard-integration.md)   . If not, they are redirected to your custom-built checkout.
...
- Integrate with the [Razorpay Affordability Widget](/razorpay-docs-md/payment-gateway/emi-/widget/native-web.md)  . This feature is only supported on Native Website.
...
1. Log in to the [WordPress account](https://wordpress.com/log-in)   , navigate to **WooCommerce** → **Settings** and click the **Payments** tab.
   ...
   ![WooCommerce settings](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/build/browser/assets/images/woocommerce-settings.jpg)
2. In the **Payments** tab, scroll down to **Razorpay** and click **Manage** to edit the settings.

   ![edit](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/build/browser/assets/images/widget-razorpay-edit.jpg)
3. In the **Plugin Settings**, enter the **Key ID** and **Key Secret** generated from the Dashboard. Click **Save Changes**.

   ![API Keys](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/build/browser/assets/images/widget-woocommerce-keys.jpg)

You can now follow the [integration steps](/razorpay-docs-md/payment-gateway/emi-/widget/woocommerce.md#integration-steps).
...
2. Create a [Razorpay account](https://dashboard.razorpay.com/signup)
   ...
   and follow the [integration steps](/razorpay-docs-md/payment-gateway/emi-/widget/woocommerce.md#integration-steps)   .
...
1. On the WordPress Dashboard hover over **Razorpay WordPress** and click **Visit Store**.
   ...
   ![Test widget](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/build/browser/assets/images/widget-woocommerce-test.jpg)
2. Click on a product to view the widget.

   ![Preview](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/build/browser/assets/images/widget-woocommerce-preview.jpg)
...
Know more about the [customisation options](/razorpay-docs-md/payment-gateway/emi-/widget/woocommerce/customise.md).
...
3. Add `/widgets/affordability/affordability.js` to the following sections in your settings:
   1. Navigate to **ADVANCE RULES** in the left menu → **Never Cache URL(s)**
      ...
      ![Add URL to Never Cache URL(s) section](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/build/browser/assets/images/affordability-add-url-1.jpg)
   2. Navigate to **CDN** in the left menu → **Exclude files from CDN**

      ![Add the URL to Exclude files from CDN](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/build/browser/assets/images/affordability-add-url-2.jpg)
...
5. Add `/widgets/emi²/affordability.js` within the **Excluded Javascript Files** section.
   ...
   ![Configure file optimization section](https://razorpay.com/docs/payments/payment-gateway/emi²/widget/build/browser/assets/images/aff-wooc-file-optimization.jpg)
...
2. Create a [Razorpay account](https://dashboard.razorpay.com/signup)
   ...
   and perform the [EMI² integration](/razorpay-docs-md/payment-gateway/emi-/widget/shopify.md#integration-steps)

   steps on your Shopify store.
...
Ensure your website's theme version supports [Online Store Theme 2.0](https://shopify.dev/docs/themes/os20). You can [verify](https://community.shopify.com/c/shopify-design/how-to-identify-shopify-online-2-0-theme-or-later/td-p/1521884#:~:text=Next%20Topic-,REPLIES%20(3),-Halothemes)

if the Online Store Theme 2.0 is supported on your website.
...
- Fill in the [integration support form](https://form.typeform.com/to/Ro3nJPzp)
  ...
  in case you are still facing issues with the integration.
...
- Payment Methods
- Theme
  Know more about the [customisation options](/razorpay-docs-md/payment-gateway/emi-/widget/shopify/customise.md)  .
...
To see the list of themes that are compatible with the Razorpay Affordability Widget on the Shopify store, refer to [Compatible Themes](/razorpay-docs-md/payment-gateway/emi-/widget/shopify.md#compatible-themes).

### Related Information

- [EMI² Suite FAQs](/razorpay-docs-md/payment-gateway/emi-/faqs.md)
