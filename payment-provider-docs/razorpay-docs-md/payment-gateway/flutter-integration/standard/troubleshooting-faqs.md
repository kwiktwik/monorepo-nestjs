<!-- Source: https://razorpay.com/docs/payments/payment-gateway/flutter-integration/standard/troubleshooting-faqs -->

1. What is order id and how to generate it?

Order creation is the primary step of the Razorpay payment flow. When customer clicks the pay button on your app, an Order is created and a corresponding order\_id is generated in the response. This order\_id must be passed to the Razorpay Checkout options added in your Flutter app. Know more about [Orders](/razorpay-docs-md/api/orders.md).
