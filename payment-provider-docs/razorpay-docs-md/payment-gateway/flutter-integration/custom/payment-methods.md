<!-- Source: https://razorpay.com/docs/payments/payment-gateway/flutter-integration/custom/payment-methods -->
...
View the complete list of [UPI supported apps and their package names](/razorpay-docs-md/payment-methods/upi/supported-apps.md).
...
Given below is the sample code for the payment method `paylater`. Know more about [paylater](/razorpay-docs-md/payment-methods/pay-later/custom-integration.md).
...
Given below is the sample code for the payment method `cardless_emi`. Know more about [Cardless EMI](/razorpay-docs-md/payment-methods/emi/cardless-emi/custom-integration.md).
