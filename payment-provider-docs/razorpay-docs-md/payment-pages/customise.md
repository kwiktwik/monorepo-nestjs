<!-- Source: https://razorpay.com/docs/payments/payment-pages/customise -->

You can customise Payment Pages for customers and send them custom links with the amount, email, phone and custom fields (such as First Name and Last Name) pre-populated. This serves as a personalisation value-add for customers. You can do this by making changes to the Payment Pages URL before sending it to customers. You can pre-populate [Input Fields](/razorpay-docs-md/payment-pages/customise.md#pre-populate-input-fields) and [Amount Fields](/razorpay-docs-md/payment-pages/customise.md#pre-populate-amount-fields)

![Sample Payment Page](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-prepopulate_pp.jpg)
...
![Payment Page - Prepopulate Input Fields](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-prepopulate_pp_sk.jpg)
...
![Payment Page - Customised Page](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-prepopulate_pp_bk.jpg)
...
You want to sell iPhone 11 Pro smartphone cases for ₹399. You are creating a Payment Page titled `Limited Edition iPhone 11 Phone Case` to sell the product. You can ensure that when the customer opens the Payment Page, the quantity to be purchased appears pre-selected as `1`. However, this will work only when the field has been marked optional.
...
3. In the Payment Details Section, create a price field called `Marble Pink Case` using `Item with Quantity` as the amount field type.
   ...
   ![Payment Page - Prepopulate Item with Quantity](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-item_with_quantity.jpg)
...
![Payment Page - Customised Payment Page](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-item_qty_selected.jpg)
...
3. In the Payment Details Section, create a price field called `Creative Writing Course Registration` using `Fixed Amount` as the amount field type.
   ...
   ![Payment Page - Prepopulate Fixed Amount](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-fixed-amount.jpg)
...
![Payment Page - Customised Payment Page](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-fixed_amount_selected.jpg)
...
![Payment Page - Customised Payment Page](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-prepopulate_pp.jpg)
...
3. In the Payment Details Section, create a price field. - `Customer Decides Amount`.
   ...
   ![Payment Page - Customer Decides Amount](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-customer_decides_amount.jpg)
4. Create an input field with type as `Single Line` to capture the customer's **Full Name**.
5. **Save and Publish** the Payment Page.
6. Copy and paste the Payment Page short URL on the browser.
...
![Payment Page - Prepopulate Fields](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-prepopulate_pp.jpg)
...
- [Create a Payment Page](/razorpay-docs-md/payment-pages/create.md)
- [Add Images, Videos and More](/razorpay-docs-md/payment-pages/add-images-videos.md)
