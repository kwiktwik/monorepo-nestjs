<!-- Source: https://razorpay.com/docs/payments/payment-pages/create -->
...
- The Dashboard has [test and live modes](/razorpay-docs-md/dashboard/test-live-modes.md)  . Use the test mode for a sandbox experience. You can switch to live mode when you are ready to accept payments. You will have to create a new Payment Page in live mode.
- Understand the [Payment Flow](/razorpay-docs-md/payment-gateway/how-it-works.md)  .

![Payment Pages Flow](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-create_pp.jpg)
...
![Select which product you want to use.](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/pp-select-choice.jpg)
...
2. Fill in the page details:
   ...
   2. You can use the [rich-text features](/razorpay-docs-md/payment-pages/add-images-videos.md)
...
- You can customise this section by adding videos, images and more, using our [rich-text features](/razorpay-docs-md/payment-pages/add-images-videos.md)  .

The section appears as shown once the details are filled in:

![Payment Pages - Business Details](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-completed_business_details.jpg)
...
4. If you have selected `Item with Quantity` or `Fixed Amount` as the price field type, enter the price you want to charge.
5. Click the more icon to open the **Additional Options** menu to:
   1. Add image.
   2. Specify if the field is mandatory.
   3. Configure further for quantity and price. Know more about [Additional Options](/razorpay-docs-md/payment-pages/create.md#additional-options)      .
6. Click **Save**.
...
![Payment Pages - Additional Details](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-image_added.jpg)
...
![Payment Pages - Contact Details Description](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-phone_field.jpg)
...
1. Click **Add new** and select **Input Field**. In the drop-down, select **Single Line Text** as the **Field Type**.
   ...
   ![Payment Pages - Custom Input Fields](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-custom_field_1.jpg)
2. Add the label for the field - `Full Name`.

   ![Payment Pages - Custom Input Fields](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-custom_field_ps.jpg)
3. Click **Save**.
...
![Payment Pages - Custom Input Fields](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-reorder_generic.gif)

Customise Pay Button Label

1. Hover on the Pay button and click the edit icon.

   ![Payment Pages - Custom Pay Button Label](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-pay_button_hover.jpg)
2. Enter a new label - `Book Tickets` and click the save icon.

   ![Payment Pages - Custom Pay Button Label](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-pay_button.jpg)

The label cannot exceed 16 characters.

Step 3: Configure Payment Receipt (Optional)

You can ensure that your customers receive payment receipts via email once they complete the payment. Know how you can [send and download automated or manual payment receipts](/razorpay-docs-md/payment-pages/receipt.md).

If you are an NGO, [know how you can send and download payment receipts with 80-G information](/razorpay-docs-md/payment-pages/80g-receipt.md).
...
3. To set the expiry date for the page, disable
   **No Expiry**
   . In the calendar that is displayed, select the expiry date and set the time.
...
5. You can [put a hyperlink button on your website](/razorpay-docs-md/payment-pages/create.md#create-hyperlink-button)   . This can be done only after your page is published.
6. Click **Save**.

![Configure Page Settings](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-page-settings.jpg)
...
![Enter Contact details to share Payment Page Link](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-payment-button-result.jpg)
...
You can set up webhooks to receive notifications on payments using the page. Know more about how to [set up webhooks](/razorpay-docs-md/payment-pages/subscribe-to-webhooks.md).

## View Payment Page in Action

Your Payment Page is now live!

![Sample Payment Page](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-generic_hosted_page_view.jpg)

## Payments

You can view the payments as and when they are made in the [Transactions Details View](/razorpay-docs-md/payment-pages/view-reports.md) of the page.

![Payment Page Transaction Tab](https://razorpay.com/docs/payments/payment-pages/build/browser/assets/images/payment-pages-v3-generic_report.jpg)
...
**Try it Out** [Try creating the entire payment page yourself](https://dashboard.razorpay.com/app/paymentpages/new).

### Related Information

- [How Payment Pages Work](/razorpay-docs-md/payment-pages/how-it-works.md)
- [Search for Payment Pages](/razorpay-docs-md/payment-pages/search.md)
- [Manage Payment Pages](/razorpay-docs-md/payment-pages/manage.md)
