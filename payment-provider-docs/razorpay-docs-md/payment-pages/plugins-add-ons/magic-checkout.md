<!-- Source: https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/magic-checkout -->
...
2. Click the **+ Create Payment Page** button.
   ...
   ![Create](https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/build/browser/assets/images/pp-magic-create.jpg)
3. Select a template from the list or click **Create your Own**.

   ![](https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/build/browser/assets/images/payment-pages-v3-create-your-own.jpg)
4. Click **Magic Checkout Settings**.

   ![](https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/build/browser/assets/images/pp-shipping-settings.jpg)
5. Enable **Magic Checkout**. This will remove your customer input fields such as shipping and customer details.

   ![](https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/build/browser/assets/images/pp-magic-enable.jpg)
6. Select the required **Delivery Charge**. The three different categories for delivery charges are:
   ...
   ![](https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/build/browser/assets/images/pp-shiprocket-charge.jpg)
7. Click **Save**. After you save the changes, the following address fields are removed, and the customer's shipping address will be collected at checkout. Click **Confirm and Save**.
   ...
   ![](https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/build/browser/assets/images/pp-magic-fields.jpg)
8. Continue with the creation of your Payment Page. Know more about how to [Create a Payment Page](/razorpay-docs-md/payment-pages/create.md#step-2-add-page-details/)   .
...
3. In the top right corner of the page, click the **Edit** button.
   ...
   ![](https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/build/browser/assets/images/payment-pages-v3-edit-pp.jpg)
4. The page appears in edit mode. You can now edit any of the fields from [step 4](/razorpay-docs-md/payment-pages/plugins-add-ons/magic-checkout.md#integration-steps:~:text=Click%20Magic%20Checkout%20Settings.)
...
![](https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/build/browser/assets/images/pp-magic.gif)
...
![Payment details](https://razorpay.com/docs/payments/payment-pages/plugins-add-ons/build/browser/assets/images/pp-magic-payment-details.jpg)

**Handy Tips**

After you integrate Payment Pages with Magic Checkout, you can also integrate with [Shiprocket](/razorpay-docs-md/payment-pages/plugins-add-ons/shiprocket.md) if required.
