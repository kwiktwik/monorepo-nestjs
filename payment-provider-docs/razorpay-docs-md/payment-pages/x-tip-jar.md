<!-- Source: https://razorpay.com/docs/payments/payment-pages/x-tip-jar -->
...
- [Set up](/razorpay-docs-md/set-up.md)

  your Razorpay account and complete the KYC process.
- Create a [Payment Page](/razorpay-docs-md/payment-pages/create.md)

  and copy the page URL. If you already have a Payment Page, follow the steps given below.
...
4. Click on the payment\_id for more details.
