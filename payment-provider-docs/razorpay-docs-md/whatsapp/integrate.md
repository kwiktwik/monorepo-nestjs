<!-- Source: https://razorpay.com/docs/payments/whatsapp/integrate -->

To enable Razorpay - Payments on WhatsApp:

1. [Integrate with WhatsApp Business API](/razorpay-docs-md/whatsapp/integrate.md#1-integrate-with-whatsapp-business-api)
2. [Link Razorpay Account to WhatsApp](/razorpay-docs-md/whatsapp/integrate.md#2-link-razorpay-account-with-whatsapp)
...
- WhatsApp Business API provides automated messaging, chatbots, and customisation features. You can send messages in bulk and create customised messaging experiences with chatbots. If you have already integrated with WhatsApp Business API, you will see a green tick next to your business name.
  ...
  ![Integrated with WhatsApp Business API](https://razorpay.com/docs/payments/whatsapp/build/browser/assets/images/whatsapp-api-integrated.jpg)
...
- Refer to the [Meta Partner directory](https://www.facebook.com/business/partner-directory/search?solution_type=messaging&ref=fmp_about_solution_card&capabilities=Payments&countries=IN&platforms=whatsapp)

  to find a suitable BSP.
...
- [Self-Owned WABA](/razorpay-docs-md/whatsapp/integrate.md#self-owned-waba)
- [BSP-Owned WABA (OBO model)](/razorpay-docs-md/whatsapp/integrate.md#bsp-owned-waba-obo-model)
