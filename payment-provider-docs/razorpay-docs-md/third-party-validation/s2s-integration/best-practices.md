<!-- Source: https://razorpay.com/docs/payments/third-party-validation/s2s-integration/best-practices -->
...
1. We recommended using [S2S JSON API](/razorpay-docs-md/payment-gateway/s2s-integration/json/v2.md)
...
4. You should integrate [webhooks](/docs/webhooks/)

   to get a callback via a server to server call.
5. Integrate the [Payments Rainy Day kit](/razorpay-docs-md/payment-gateway/rainy-day.md)

   to tackle payment exceptions such as late authorized payments, payment downtimes and errors.
