<!-- Source: https://razorpay.com/docs/payments/refunds/faqs -->
...
- [Dashboard](/razorpay-docs-md/refunds/issue.md#issue-refunds)

  .
- [APIs](/razorpay-docs-md/api/refunds.md)
...
If your current balance is less than the amount you are trying to refund, you can either initiate the refund once you receive further payments or you can [add funds](/razorpay-docs-md/dashboard/account-settings.md#add-funds) to your account from the Dashboard.
