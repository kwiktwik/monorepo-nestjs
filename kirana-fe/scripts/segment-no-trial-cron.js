...
/**
 * Cron script to send notifications to users who never purchased
...
const apiUrl = new URL('/api/cron/segment-no-trial', BASE_URL);
...
console.log(`[CRON] Starting no-purchase segment notification at ${new Date().toISOString()}`);
