      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="space-y-12 text-gray-600 leading-relaxed">
          <section>
            ...
            <p className="text-lg">
              By accessing or using Sangam App (com.sangam.wallpaperapp), you agree to comply with and be bound by these Terms of Service. These terms apply to all visitors, users, and others who access or use the Service.
            </p>
          </section>
          ...
          <section className="bg-primary/10 p-10 rounded-[3rem] border border-primary/20">
            ...
            <p className="text-lg text-primary/80">
              In no event shall Sangam App, nor its directors, employees, or partners, be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of the service.
            </p>
          </section>
