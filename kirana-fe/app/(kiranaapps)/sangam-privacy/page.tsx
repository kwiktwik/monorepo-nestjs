    ...
    <div className="bg-white min-h-[80vh] selection:bg-primary/10 selection:text-primary">
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div className="space-y-12 text-gray-600 leading-relaxed max-w-none">
          <section>
            <p className="text-lg">
              At Sangam App, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our mobile applications and services under the package name <strong>com.sangam.wallpaperapp</strong>.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-4 list-disc list-inside ml-4 text-lg">
              <li>To provide and maintain our services for Sangam App.</li>
