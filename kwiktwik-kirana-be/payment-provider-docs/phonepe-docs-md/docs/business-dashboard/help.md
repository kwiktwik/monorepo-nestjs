<!-- Source: https://developer.phonepe.com/docs/business-dashboard/help -->
...
1. Identify the category that best fits your query (e.g., if you have a question about a payment, click on “Transactions”).
2. Click on the relevant category icon.
3. You will then be presented with a list of FAQs within that category. Click on an FAQ to reveal its answer. (As per “nested FAQs,” this implies you might drill down further into sub-categories or directly into answers).
4. If your question isn’t listed, you may find an option to contact support or raise a new ticket within that specific category.
...
![](/static/b24e7872e74f9127daf7c4ed57212c06/58f13/help-page.png)![](/static/b24e7872e74f9127daf7c4ed57212c06/58f13/help-page.png)
