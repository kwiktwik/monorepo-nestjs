<!-- Source: https://razorpay.com/docs/payments/third-party-validation/s2s-integration/debit-card -->
...
- You must have a PCI compliance certificate to enable this feature on your account. For more details, refer to the [PCI Compliance](https://www.pcisecuritystandards.org/)
...
1. [Collect Investor Bank Account Details](/razorpay-docs-md/third-party-validation/s2s-integration/debit-card.md#step-1-collect-investor-bank-account-details)
2. [Create an Order](/razorpay-docs-md/third-party-validation/s2s-integration/debit-card.md#step-2-create-an-order)
3. [Create a Payment](/razorpay-docs-md/third-party-validation/s2s-integration/debit-card.md#step-3-create-a-payment)
4. [Store Fields in Your Server](/razorpay-docs-md/third-party-validation/s2s-integration/debit-card.md#step-4-store-fields-in-your-server)
5. [Verify the Signature](/razorpay-docs-md/third-party-validation/s2s-integration/debit-card.md#step-5-verify-the-signature)
