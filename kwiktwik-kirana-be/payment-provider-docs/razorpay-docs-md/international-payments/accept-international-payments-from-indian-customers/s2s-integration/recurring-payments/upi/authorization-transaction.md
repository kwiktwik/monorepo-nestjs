<!-- Source: https://razorpay.com/docs/payments/international-payments/accept-international-payments-from-indian-customers/s2s-integration/recurring-payments/upi/authorization-transaction -->
...
`string` The unique identifier of the order created in [Step 1.2 Create an Order](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/s2s-integration/recurring-payments/upi/authorization-transaction.md#12-create-an-order).
...
`string` Unique identifier of the customer, obtained from the response of [Step 1.1 Create an Customer](/razorpay-docs-md/international-payments/accept-international-payments-from-indian-customers/s2s-integration/recurring-payments/upi/authorization-transaction.md#11-create-a-customer).
...
If the payment request is valid, the response contains the following fields. Refer to the [UPI Intent Flow document](/razorpay-docs-md/payment-gateway/s2s-integration/payment-methods/upi/intent.md#step-2-initiate-a-payment) for more details.
