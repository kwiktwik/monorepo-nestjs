<!-- Source: https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/fraud-sales-ratio -->
...
![How to calculate FTS](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/calculate-fts.jpg)
...
![Fraud to sales ratio value](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/fts-value-count.jpg)
...
![FTS graph](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/fts-total-count.jpg)
...
For example, you may notice a spike in fraudulent transactions from a particular country or Card BIN associated with specific product categories. By visualising this data through custom charts or analysing the parameters in the [downloadable list of fraudulent transactions](/razorpay-docs-md/international-payments/risk-visibility-dashboard/fraud-sales-ratio.md#download-the-list-of-fraudulent-transactions), you can gain valuable insights into potential risk factors contributing to the FTS ratio.

![FTS spike graph](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/fraud-spike-example.jpg)
...
**Taking Proactive Measures:** Using the Dashboard, you can request our risk team to [block future transactions](/razorpay-docs-md/international-payments/risk-visibility-dashboard/fraud-sales-ratio.md#block-highest-fraud-contributors) from this high-risk IP address. This proactive measure helps prevent further fraudulent activities associated with the identified cohort, reducing the likelihood of future fraud incidents.
...
2. Navigate to **Risk and Fraud** and click **Download list**.
   ...
   ![Fraudulent list download](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/fts-download-list.jpg)
3. On the **Download fraudulent transaction list** page, select the **duration** of fraudulent transactions and add the **Recipient's Details**. Click **Send Request**.
   ...
   ![Fraudulent list download send request](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/fts-send-request.jpg)
...
2. Navigate to **Risk and Fraud** and click **Request blacklist**.
   ...
   ![Fraudulent blacklist request](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/fts-request-blacklist.jpg)
3. On the **Request blacklist** page.
   ...
   ![Send request blacklist](https://razorpay.com/docs/payments/international-payments/risk-visibility-dashboard/build/browser/assets/images/fts-blacklist-send-request.jpg)
