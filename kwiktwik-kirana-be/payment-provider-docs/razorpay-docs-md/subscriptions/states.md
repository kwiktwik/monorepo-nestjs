...
![subscription life cycle](https://razorpay.com/docs/payments/subscriptions/build/browser/assets/images/subscriptions-subscription-lifecycle.jpg)
...
- A Subscription can be cancelled using the [Cancel API](/razorpay-docs-md/api/payments/subscriptions.md#cancel-a-subscription)

  or from the [Dashboard](/razorpay-docs-md/subscriptions/pause-resume-cancel.md#cancel-a-subscription-via-the-dashboard)  .

Paused

- Only Subscriptions in the `active` state can be paused.
- You can pause a Subscription.
- From the [Dashboard](/razorpay-docs-md/subscriptions/pause-resume-cancel.md#pause-a-subscription-via-the-dashboard)  .
- Using [API](/razorpay-docs-md/api/payments/subscriptions.md#pause-a-subscription)  .
