<!-- Source: https://razorpay.com/docs/payments/subscriptions/view -->

You can view details of a Subscription from the [Dashboard](/razorpay-docs-md/subscriptions/view.md#view-subscription-details-from-dashboard) or using [APIs](/razorpay-docs-md/subscriptions/view.md#view-subscription-details-using-apis).
...
- [Fetch All Subscriptions API](/razorpay-docs-md/api/payments/subscriptions/fetch-subscriptions.md)
- [Fetch a Subscription With ID API](/razorpay-docs-md/api/payments/subscriptions/fetch-subscription-id.md)
