<!-- Source: https://razorpay.com/docs/payments/payment-button/buy-now -->
...
1. [Select a Template](/razorpay-docs-md/payment-button/buy-now.md#1-select-a-template)
2. [Add Button Details](/razorpay-docs-md/payment-button/buy-now.md#2-add-buy-now-button-details)
...
![Dashboard Payment Buttons](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-payment-button-dashboard.jpg)

1.3. Click **+ Create Payment Button**.

1.4. On the **Button Creation Wizard**, select the **Buy Now** button type.

![Select Payment Buttons type](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-buy-now.jpg)
...
![Payment Button Details](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-buy-now-create.jpg)
...
1. Click **+Add Amount Field**.
   ...
   ![Payment Button amount details](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-amount-details-create.jpg)
...
3. On the pop-up page:
   ...
   3. Enter the amount as `500`.
      ...
      ![Amount Details - field label](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-amount-field-create.jpg)
   4. Click the more icon to view **Advanced Options**.
      ...
      2. Select **Item has Limited Stock** and enter the value as `25`.
         ...
         ![Amount Details - advanced options](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-advanced-options.jpg)
   5. Click **Save**.
4. **Save** the field.

![Amount Details - Preview](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-amount-field-created.jpg)
...
![Amount Details - Preview](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-all-amount-fields-complete.jpg)
...
![Enter customer details](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-customer-details-default.jpg)
...
![Customer Details - Custom field preview](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-customer-details-added.jpg)
...
1. Click **Create Button**.
   ...
   ![Review and create the Payment Button](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-review-button.jpg)
2. After completing the steps, the button code appears. Copy this code and add it in your webpage.

   ![Payment Button created successfully](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-pb-success.jpg)
...
![Transaction details on the Razorpay Dashboard](https://razorpay.com/docs/payments/payment-button/build/browser/assets/images/payment-button-buy-now-transaction-detail.jpg)
