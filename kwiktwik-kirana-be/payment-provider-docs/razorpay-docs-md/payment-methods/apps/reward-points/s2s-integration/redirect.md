<!-- Source: https://razorpay.com/docs/payments/payment-methods/apps/reward-points/s2s-integration/redirect -->
...
![Feature Request GIF](https://razorpay.com/docs/payments/payment-methods/apps/reward-points/s2s-integration/build/browser/assets/images/feature-request.gif)
...
- Configure [payment capture settings](/razorpay-docs-md/payments.md#dashboard-actions)
  ...
  on the Dashboard.
- Follow the [Razorpay S2S Integration (Redirect) documentation](/razorpay-docs-md/payment-gateway/s2s-integration/redirect.md)  .
...
1. [Fetch payment methods using the Methods API](/razorpay-docs-md/payment-methods/apps/reward-points/s2s-integration/redirect.md#step-1-fetch-payment-methods-using-methods-api)

   .
2. [Create an order using the Orders API](/razorpay-docs-md/payment-methods/apps/reward-points/s2s-integration/redirect.md#step-2-create-an-order-using-orders-api)

   .
3. [Create a payment using the S2S Payments Redirect API](/razorpay-docs-md/payment-methods/apps/reward-points/s2s-integration/redirect.md#step-3-create-a-payment-using-s2s-redirect)

   .
4. [Handle payment success and failure](/razorpay-docs-md/payment-methods/apps/reward-points/s2s-integration/redirect.md#step-4-handle-payment-success-and-failure)

   .
5. [Fetch payment status](/razorpay-docs-md/payment-methods/apps/reward-points/s2s-integration/redirect.md#step-5-fetch-payment-status)
...
- You can create an order using the [Orders API](/razorpay-docs-md/payment-methods/apps/reward-points/s2s-integration/redirect.md#api-sample-code)  . It is a server-side API call. Know how to [authenticate](/razorpay-docs-md/dashboard/account-settings/api-keys.md#generate-api-keys)
...
Refer to the [errors document](/docs/errors/) for more details.
