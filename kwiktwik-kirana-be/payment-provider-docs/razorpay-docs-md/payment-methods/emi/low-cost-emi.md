<!-- Source: https://razorpay.com/docs/payments/payment-methods/emi/low-cost-emi -->
...
You can create [Low Cost EMI Offers](/razorpay-docs-md/offers/low-cost-emi.md) for a selected issuer from your Dashboard.
...
3. Select the EMI option where Low Cost EMI is available. If the amount entered in the Checkout is eligible for the discount, all the applicable EMI options are shown.
   ...
   ![select EMI option where Low Cost EMI is available](https://razorpay.com/docs/payments/payment-methods/emi/build/browser/assets/images/low-cost-select-emi.jpg)
...
5. Choose the EMI tenure and click **Continue**.
   ...
   ![Select Low Cost EMI tenure](https://razorpay.com/docs/payments/payment-methods/emi/build/browser/assets/images/low-cost-emi-select-tenure.jpg)
...
See: [Low Cost EMI FAQs](/razorpay-docs-md/payment-methods/emi/faqs.md#low-cost-emi).
