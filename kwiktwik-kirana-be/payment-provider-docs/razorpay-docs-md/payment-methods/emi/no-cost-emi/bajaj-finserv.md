<!-- Source: https://razorpay.com/docs/payments/payment-methods/emi/no-cost-emi/bajaj-finserv -->
...
Checkout with Callback URL (JavaScript)Checkout with Handler Functions (JavaScript)
...
1. On the Razorpay Checkout, customers enter the required details and select **EMI** as the payment method.
   ...
   ![Standard checkout with bajaj finserv.](https://razorpay.com/docs/payments/payment-methods/emi/no-cost-emi/build/browser/assets/images/bajaj-finserv-emi-new-amount.jpg)
2. They can select **Cardless and Others**.

   ![Bajaj FinServ displayed in Cardless and Others section](https://razorpay.com/docs/payments/payment-methods/emi/no-cost-emi/build/browser/assets/images/bajaj-finserv-new-select-new.jpg)
3. Customers select the EMI tenure and click **Continue**.

   ![Select an EMI Plan and Select Plan.](https://razorpay.com/docs/payments/payment-methods/emi/no-cost-emi/build/browser/assets/images/bajaj-finserv-new-plan-select.jpg)
4. They enter the details of Bajaj Finserv-issued card and click **Continue**.

   ![details of Bajaj Finserv-issued card.](https://razorpay.com/docs/payments/payment-methods/emi/no-cost-emi/build/browser/assets/images/bajaj-finserv-new-card-details.jpg)
...
See: [No Cost EMI FAQs](/razorpay-docs-md/payment-methods/emi/faqs.md#no-cost-emi).
