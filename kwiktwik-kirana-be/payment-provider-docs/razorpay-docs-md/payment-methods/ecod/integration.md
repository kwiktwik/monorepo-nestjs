<!-- Source: https://razorpay.com/docs/payments/payment-methods/ecod/integration -->
...
2. The delivery executive clicks on **Initiate Payment**.
...
Step 4 described above involves creating an Invoice using Razorpay’s API. For creating an Invoice, you require the amount and the contact number of the customer. Know more about the [Invoice APIs](/razorpay-docs-md/api/payments/invoices.md).
...
- invoice\_id: `<pass the invoice_id>`
- ecod: true
