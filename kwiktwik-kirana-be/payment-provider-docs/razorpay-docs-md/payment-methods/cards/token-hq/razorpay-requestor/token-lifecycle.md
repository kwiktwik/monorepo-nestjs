<!-- Source: https://razorpay.com/docs/payments/payment-methods/cards/token-hq/razorpay-requestor/token-lifecycle -->
...
![Token Lifecycle](https://razorpay.com/docs/payments/payment-methods/cards/token-hq/razorpay-requestor/build/browser/assets/images/cards-token-hq-token-lifecycle.jpg)
