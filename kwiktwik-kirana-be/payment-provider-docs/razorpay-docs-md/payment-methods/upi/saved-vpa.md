<!-- Source: https://razorpay.com/docs/payments/payment-methods/upi/saved-vpa -->
...
![Saved VPA Flow](https://razorpay.com/docs/payments/payment-methods/upi/build/browser/assets/images/saved-vpa2.gif)
