<!-- Source: https://razorpay.com/docs/payments/payment-links/transfer-payments -->
...
Check the [transfer payments received using Payment Links API](/razorpay-docs-md/api/payments/payment-links/transfer-payments.md).
...
Use the [API](/razorpay-docs-md/api/payments/payment-links/transfer-payments.md) to transfer payments received using Payment Links.
