<!-- Source: https://razorpay.com/docs/payments/offers/low-cost-emi/custom-integration -->
...
You can decide the cost to subvent for each EMI tenure while [creating an offer](/razorpay-docs-md/offers/low-cost-emi/create.md) and the customer bears the remaining cost. This approach ensures that customers enjoy the benefits of EMI at an affordable cost, helping you minimise the overall cost.
...
1. [Create a Low Cost EMI Offer](/razorpay-docs-md/offers/low-cost-emi/custom-integration.md#step-1-create-a-low-cost-emi-offer)
2. [Create an Order and Pass Offer\_id](/razorpay-docs-md/offers/low-cost-emi/custom-integration.md#step-2-create-an-order-and-pass-offer-id)
3. [Show the Offer on Checkout](/razorpay-docs-md/offers/low-cost-emi/custom-integration.md#step-3-show-the-offer-on-checkout)
4. [Submit Payment Details](/razorpay-docs-md/offers/low-cost-emi/custom-integration.md#step-4-submit-payment-details)

## Step 1: Create a Low Cost EMI Offer

You can create a Low Cost EMI offer from the [Dashboard](/razorpay-docs-md/offers/create.md).
...
This is mandatory only in cases where you want to associate an offer or offers with the Order or you had not selected the [Show Offer on Checkout](/razorpay-docs-md/offers/create.md#offer-validity) while creating the offer from the Dashboard.
