<!-- Source: https://razorpay.com/docs/payments/offers/voucher/s2s-integration -->
...
1. [Create Offers from Dashboard](/razorpay-docs-md/offers/voucher/s2s-integration.md#step-1-create-offers)

   .
2. [Fetch all Offers](/razorpay-docs-md/offers/voucher/s2s-integration.md#step-2-fetch-all-offers)

   .
3. [Create Orders to include the Offers in the payment request](/razorpay-docs-md/offers/voucher/s2s-integration.md#step-3-create-an-order)

   .
4. [Validate Offers](/razorpay-docs-md/offers/voucher/s2s-integration.md#step-4-validate-offers)

   .
5. [Fetch Orders](/razorpay-docs-md/offers/voucher/s2s-integration.md#step-5-fetch-orders)

   .
6. [Create a Payment](/razorpay-docs-md/offers/voucher/s2s-integration.md#step-6-create-a-payment)

   .
7. [Verify the Payment](/razorpay-docs-md/offers/voucher/s2s-integration.md#step-7-verify-the-payment)

   .

### Step 1: Create Offers [Create an offer](/razorpay-docs-md/offers/create.md) from the Dashboard.

![](https://razorpay.com/docs/payments/offers/voucher/build/browser/assets/images/offers-offers-description.jpg)
...
Once the customer completes the payment, a `POST` request is sent to the `callback_url` provided in the [payment create request](/razorpay-docs-md/offers/voucher/s2s-integration.md#step-3-create-a-payment). The data contained in the `POST` request depends on the **success** or **failure** of the payment made by the customer.
