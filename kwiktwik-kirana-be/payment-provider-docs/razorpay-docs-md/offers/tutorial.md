<!-- Source: https://razorpay.com/docs/payments/offers/tutorial -->
...
3. The **Create an Offer** wizard appears with these four tabs.
   ...
   - [**Description**](/razorpay-docs-md/offers/tutorial.md#description)
   - [**Discount Type**](/razorpay-docs-md/offers/tutorial.md#discount-type)
   - [**Applicable On**](/razorpay-docs-md/offers/tutorial.md#applicable-on)
   - [**Offer Validity**](/razorpay-docs-md/offers/tutorial.md#offer-validity)

   ![View components required during creating an offer](https://razorpay.com/docs/payments/offers/build/browser/assets/images/offers-offers-wizard.jpg)

You can review the Offer configurations at the end under the [**Overview**](/razorpay-docs-md/offers/tutorial.md#overview) tab.
...
Now that an offer is created, you should integrate the offers with the Checkout for customers to avail themselves the discounts and make payments. Know more about [integrating offers with Standard Checkout](/razorpay-docs-md/offers/standard-integration.md).
