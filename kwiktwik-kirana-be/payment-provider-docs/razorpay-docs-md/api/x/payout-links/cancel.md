<!-- Source: https://razorpay.com/docs/api/x/payout-links/cancel -->

# Cancel a Payout Link

`POST`

`/v1/payout-links/:id/cancel`

Use this endpoint to cancel a Payout Link. You can only cancel Payout Links in the `issued` state. Know more about the [Payout Link Life Cycle section](/docs/x/payout-links/life-cycle/).
...
The unique identifier for the Payout Link you want to cancel. For example, `poutlk_00000000000003`.
...
The unique identifier of the Payout Link that was created. For example, `poutlk_00000000000001`.
...
Details of the contact to whom the Payout Link was to be sent.
...
The amount, in paise, that was to be transferred from the business account to the contact's fund account.
...
The currency in which the payout was to be made. Here, it is `INR`.
...
A short link for the Payout Link that was created. This is the link shared with the contact.
...
The unique identifier of the contact's fund account to which the payout will be made. For example, `fa_00000000000001`.
 ...
 Fund Account id is returned only when the Payout Link moves to the [`processing` state](/docs/x/payout-links/life-cycle/) after the contact provides their account details.
...
The unique identifier for the payout made to the contact. For example, `pout_00000000000001`.
 ...
 This value is returned only when the Payout Link moves to the [`processed` state](/docs/x/payout-links/life-cycle/) after the contact would receive the amount in their account.
