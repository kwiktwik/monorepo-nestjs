<!-- Source: https://razorpay.com/docs/api/x/payout-wallet/create/payout-composite -->
...
Use this endpoint to create a payout to a Fund Account of type wallet. Know more about [RazorpayX Composite API](/razorpay-docs-md/api/x/payout-composite.md).
