<!-- Source: https://razorpay.com/docs/api/payments/payment-links/change-business-name -->
...
Option to customise the business name. Parent parameter under which the `checkout` child parameter must be passed.
