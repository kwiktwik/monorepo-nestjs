<!-- Source: https://razorpay.com/docs/api/payments/recurring-payments/upi-otm/authorization-transaction -->
...
1. [Create an authorisation transaction](/razorpay-docs-md/api/payments/recurring-payments/upi-otm/authorization-transaction.md#create-an-authorisation-transaction)
...
You can create an authorisation transaction using the [Razorpay APIs](/razorpay-docs-md/api/payments/recurring-payments/upi-otm/authorization-transaction.md#11-using-razorpay-apis) or [Registration Link](/razorpay-docs-md/api/payments/recurring-payments/upi-otm/authorization-transaction.md#12-using-a-registration-link).

## 1.1 Using Razorpay APIs

To create an authorisation transaction using the Razorpay APIs, you need to:

1. [Create a Customer](/razorpay-docs-md/api/payments/recurring-payments/upi-otm/authorization-transaction.md#111-create-a-customer)

   .
2. [Create an Order](/razorpay-docs-md/api/payments/recurring-payments/upi-otm/authorization-transaction.md#112-create-an-order)

   .
3. [Create Authorisation Payment using Razorpay APIs](/razorpay-docs-md/api/payments/recurring-payments/upi-otm/authorization-transaction.md#114-create-an-authorization-payment)
...
`string` Unique identifier of the customer created in the [first step](/razorpay-docs-md/api/payments/recurring-payments/upi-otm/authorization-transaction.md#111-create-a-customer).

order\_id

mandatory

`string` Unique identifier of the order created in the [second step](/razorpay-docs-md/api/payments/recurring-payments/upi-otm/authorization-transaction.md#112-create-an-order).
