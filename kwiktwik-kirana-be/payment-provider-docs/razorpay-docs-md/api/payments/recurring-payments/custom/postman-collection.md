<!-- Source: https://razorpay.com/docs/api/payments/recurring-payments/custom/postman-collection -->

We have a Postman collection to make the integration quicker and easier. Click the **Download Postman Collection** button below to get started. [Download Postman Collection](/razorpay-docs-md/api/payments/recurring-payments/custom/build/browser/assets/images/RecurringPayments_Custom.postman_collection.json.md)
...
- All Razorpay APIs are authorized using Basic Authorization.
  ...
  ![](https://razorpay.com/docs/api/payments/recurring-payments/custom/build/browser/assets/images/api-postman_basic_auth.gif)
