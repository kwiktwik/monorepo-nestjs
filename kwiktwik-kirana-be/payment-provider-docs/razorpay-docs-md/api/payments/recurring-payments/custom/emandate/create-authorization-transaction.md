...
1. [Fetch Payment Methods](/razorpay-docs-md/api/payments/recurring-payments/custom/emandate/create-authorization-transaction.md#111-fetch-payment-methods)
   ...
   .
2. [Create a Customer](/razorpay-docs-md/api/payments/recurring-payments/custom/emandate/create-authorization-transaction.md#111-create-a-customer)

   .
3. [Create an Order](/razorpay-docs-md/api/payments/recurring-payments/custom/emandate/create-authorization-transaction.md#112-create-an-order)
