...
![Configure node.js integrated payment gateway checkout based on your requirement](https://razorpay.com/docs/payments/server-integration/nodejs/build/browser/assets/images/web-integration-checkout-new.jpg)

Watch this video to know how to integrate Razorpay Payment Gateway on your Node.js app.

#### Sample App

We recommend you check the [Node.js Sample App](/razorpay-docs-md/server-integration/nodejs/build/browser/assets/images/razorpay-node-sample-project.md), created using the video tutorial.
...
Before you begin, we recommend you check the [Node.js Sample App](/razorpay-docs-md/server-integration/nodejs/build/browser/assets/images/razorpay-node-sample-project.md), created using the video tutorial, and verify that your project contains the following files:
...
- You can create an order using the [Orders API](/razorpay-docs-md/server-integration/nodejs/integration-steps.md#api-sample-code)

  in the **app.js** file. It is a server-side API call.  Know how to [authenticate](/razorpay-docs-md/api/authentication.md#generate-api-keys)
...
You can capture payments automatically with one-time [Payment Capture setting configuration](/razorpay-docs-md/server-integration/nodejs/integration-steps.md#3-go-live-checklist) on the Dashboard.
...
You can also integrate the Razorpay Checkout with [React.js](/razorpay-docs-md/server-integration/nodejs/troubleshooting-faqs.md#3-can-i-integrate-razorpay-checkout-with-reactjs) using the sample code.

Node.js Checkout CodeCallback URL (JS) Checkout CodeHandler Function (JS) Checkout Code
...
Test the integration using these [test cards](/razorpay-docs-md/server-integration/nodejs/integration-steps.md#2-test-integration).
...
The way the Payment Success and Failure scenarios are handled depends on the [Checkout Sample Code](/razorpay-docs-md/server-integration/nodejs/integration-steps.md#132-code-to-add-pay-button) you used in the last step.
...
![Check if the payment id is generated and the status is captured](https://razorpay.com/docs/payments/server-integration/nodejs/build/browser/assets/images/testpayment.jpg)

### 2. Test Integration

After the integration is complete, a **Pay** button appears on your webpage/app.

![Test integration on your webpage/app](https://razorpay.com/docs/payments/server-integration/nodejs/build/browser/assets/images/test-int.gif)
...
Razorpay offers a range of [payment products](/razorpay-docs-md/index.md) to meet your business requirements. Visit our [GitHub repository](https://github.com/razorpay/razorpay-node) for the sample codes.
...
### Related Information [Troubleshooting and FAQs](/razorpay-docs-md/server-integration/nodejs/troubleshooting-faqs.md)
