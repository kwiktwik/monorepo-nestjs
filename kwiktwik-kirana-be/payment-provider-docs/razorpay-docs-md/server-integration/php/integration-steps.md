<!-- Source: https://razorpay.com/docs/payments/server-integration/php/integration-steps -->
...
![Configure PHP integrated payment gateway checkout based on your requirement](https://razorpay.com/docs/payments/server-integration/php/build/browser/assets/images/web-integration-checkout-new.jpg)

Watch this video to know how to integrate Razorpay Payment Gateway on your PHP app.

#### Sample App

We recommend you check the [PHP Sample App](/razorpay-docs-md/server-integration/php/build/browser/assets/images/razorpay-php-sample-project.md), created using the video tutorial.
...
Before you begin, we recommend you check the [PHP Sample App](/razorpay-docs-md/server-integration/php/build/browser/assets/images/razorpay-php-sample-project.md), created using the video tutorial, and verify that your project contains the following files:
...
Integrate with your PHP-based website.
...
- You can create an order using the [Orders API](/razorpay-docs-md/server-integration/php/integration-steps.md#api-sample-code)  . It is a server-side API call.  Know how to [authenticate](/razorpay-docs-md/api/authentication.md#generate-api-keys)
...
You can capture payments automatically with one-time [Payment Capture setting configuration](/razorpay-docs-md/server-integration/php/integration-steps.md#3-go-live-checklist) on the Dashboard.
...
PHP Checkout CodeCheckout Code (JS)
...
- If you want to use this as your final code, follow the steps given below:
  ...
  1. Edit the `[KEY_ID]` inside the html file. Use the test keys while testing your application.  Know how to [Generate API keys](/razorpay-docs-md/api/authentication.md#generate-api-keys)     .
  2. Edit the `[KEY_ID]` and `[KEY_SECRET]` in **config.php**.
- Test your integration using these [test cards](/razorpay-docs-md/server-integration/php/integration-steps.md#2-test-integration)  .
...
The way the Payment Success and Failure scenarios are handled depends on the [Checkout Sample Code](/razorpay-docs-md/server-integration/php/integration-steps.md#122-code-to-add-pay-button) you used in the last step.
...
![Check if the payment id is generated and the status is captured](https://razorpay.com/docs/payments/server-integration/php/build/browser/assets/images/testpayment.jpg)

### 2. Test Integration

After the integration is complete, a **Pay** button appears on your webpage/app.

![Test integration on your webpage/app](https://razorpay.com/docs/payments/server-integration/php/build/browser/assets/images/test-int.gif)
...
Razorpay offers a range of [payment products](/razorpay-docs-md/index.md) to meet your business requirements. Visit our [GitHub repository](https://github.com/razorpay/razorpay-php) for sample codes.
...
### Related Information [Troubleshooting and FAQs](/razorpay-docs-md/server-integration/php/troubleshooting-faqs.md)
