<!-- Source: https://razorpay.com/docs/payments/optimizer/convenience-fees -->
...
![Dynamic Convenience Fees](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/payments-dynamic-convenience-fees-v2.jpg)
...
1. The customer selects an item on your website/Payment Link/Payment Page and clicks the pay button.
   ...
   ![Customer clicks pay button](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/dashboard-guide-settings-fee-bearer-payment-page.jpg)
2. The checkout pop-up page is displayed. The customer selects the payment mode and clicks the **Pay** button.

   ![checkout form](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/dashboard-guide-settings-fee-bearer-checkout-new1.jpg)
3. The **Fees Breakup** page containing the Convenience Fee appears, and the customer clicks **Continue and pay**.

   ![Fees breakup](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/dashboard-guide-settings-fee-bearer-fee-breakup-new1.jpg)
4. The customer is redirected to the bank page with the total amount, including the Convenience Fee.

**Handy Tips**

All Optimizer gateways support the Customer Fee Bearer feature. Know more about the [gateways supported by Optimizer](/razorpay-docs-md/optimizer/supported-gateways-aggregators.md).
