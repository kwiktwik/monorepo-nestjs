<!-- Source: https://razorpay.com/docs/payments/optimizer/paytm-s2s -->
...
1. [Write to the Paytm Support Team](/razorpay-docs-md/optimizer/paytm-s2s.md#email-format-for-paytm)
...
2. To pass your unique **Order ID** or **Receipt** for every order, write to Paytm support team to show the `extendInfo.udf1` parameter in the Paytm Dashboard and customize report. Know more about [how to send your order id to Paytm](/razorpay-docs-md/optimizer/paytm-s2s.md#send-receipt-order-id-to-external-gateway)   .
...
Follow the email format given below to communicate the [prerequisites](/razorpay-docs-md/optimizer/paytm-s2s.md#prerequisites) or any other requirements to the Paytm support team:
