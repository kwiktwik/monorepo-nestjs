<!-- Source: https://razorpay.com/docs/payments/optimizer/payu-instant -->
...
- [Configure the required webhooks](/razorpay-docs-md/optimizer/payu-instant.md#to-configure-a-webhook)
...
2. Navigate to Settings → Webhook.
   ...
   ![optimizer payu instant webhook](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-payu-instant-webhook.jpg)
3. Click **Create Webhook** on the top-right corner of the Create Webhooks page.

   ![optimizer payu instant webhook create](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/optimizer-payu-instant-webhook-create.jpg)
...
7. Select the payment methods you want to enable for PayU and click **Submit**.
   ...
   ![Add Salt Key payu instant](https://razorpay.com/docs/payments/optimizer/build/browser/assets/images/add-key-salt-payu.jpg)
...
You might be generating a unique Order ID or Receipt for every order which can be passed to PayU via [Orders API](/razorpay-docs-md/api/orders.md#orders-api).
