<!-- Source: https://razorpay.com/docs/payments/magic-checkout/rto-reduction/allowlist-blocklist -->
...
4. Toggle on **COD Intelligence** and click **Enable COD Intelligence** in the confirmation pop-up modal.
   ...
   ![Enable COD Intelligence](https://razorpay.com/docs/payments/magic-checkout/rto-reduction/build/browser/assets/images/magic-enable-cod.jpg)
5. Navigate to the **Block List** tab and click **Add New Blocklist**.

   ![Add Blocklist to block COD for customers](https://razorpay.com/docs/payments/magic-checkout/rto-reduction/build/browser/assets/images/add-new-blocklist.jpg)
...
7. Click **Confirm**.
   ...
   ![Confirm settings on the Razorpay Dashboard](https://razorpay.com/docs/payments/magic-checkout/rto-reduction/build/browser/assets/images/blocklist-confirm.jpg)
...
5. Navigate to the **Allow List** tab and click **Add New Allowlist**.
   ...
   ![Add Allowlist to allow COD for customers](https://razorpay.com/docs/payments/magic-checkout/rto-reduction/build/browser/assets/images/add-new-allowlist.jpg)
6. You can either upload a list or enter it manually.
...
7. Click **Confirm**.
   ...
   ![Confirm settings on the Razorpay Dashboard](https://razorpay.com/docs/payments/magic-checkout/rto-reduction/build/browser/assets/images/allowlist-confirm.jpg)
...
![Delete each item in the list](https://razorpay.com/docs/payments/magic-checkout/rto-reduction/build/browser/assets/images/delete-item.jpg)
