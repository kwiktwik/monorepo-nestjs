<!-- Source: https://razorpay.com/docs/payments/magic-checkout/login-with-razorpay/automation-tags -->

When customers authenticate through [Login with Razorpay (SSO)](/razorpay-docs-md/magic-checkout/login-with-razorpay.md) on your Shopify store, specific tags are automatically assigned to their profiles. These tags provide automation capabilities that enhance your marketing efforts and improve customer engagement.
...
### Related Information [Customer Analytics](/razorpay-docs-md/magic-checkout/login-with-razorpay/customer-analytics.md)
