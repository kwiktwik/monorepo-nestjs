<!-- Source: https://razorpay.com/docs/payments/magic-checkout/woocommerce/configuration -->
...
- [Cash on Delivery](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#cash-on-delivery)
- [RTO](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#rto)
- [Convert COD Orders to Prepaid](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#convert-cod-orders-to-prepaid)
- [Shipping Options](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#shipping-options)
- [International Shipping](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#international-shipping)
- [Coupons](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#coupons)
- [Separate Billing Address](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#separate-billing-address)
- [Capture and Validate GSTIN](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#capture-and-validate-gstin)
- [Capture Order Instructions](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#capture-order-instructions)
- [Gift Card Settings](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#gift-card-settings)
- [Google and Facebook Analytics](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#google-and-facebook-analytics)
...
2. Select **WooCommerce** from the **Platform** drop-down list. Paste the [WordPress Address or Site Address](/razorpay-docs-md/magic-checkout/woocommerce.md#step-1-configure-settings-on-razorpay-dashboard)

   in the **Domain hyperlink** field and click **Next**.
3. Navigate to the **COD Settings** → **COD Setup**.
4. Enable **COD as a payment option**.

   ![COD settings](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-wooc-enable-cod.jpg)
...
1. Configure the **Cart order value** by selecting an option based on your requirement:
   ...
   - **Charge COD Fee**: Charge a COD fee to customers who opt for the COD payment method. You can configure the order range and set a corresponding **Fee** accordingly.
     ...
     4. Click **Save slabs**.
        ...
        ![Create COD eligibility slabs with COD charges](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-wooc-cod-slabs.jpg)
   ...
   - **Free COD**: No COD charge will apply within the configured order range. The customer cannot view the COD payment method if an order value does not fall within the configured range.
     ...
     3. Click **Save slab**.
        ...
        ![Create COD eligibility slabs](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-wooc-free-cod.jpg)
...
4. Select the country, state, and city where the COD charges configured in the previous step should be applicable. Click **Confirm**.
   ...
   ![Create COD zones](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-wooc-cod-zone.jpg)
5. Click **Save & apply**.
6. Navigate to **Manual Zipcode upload** and click **Upload ZIP codes** to offer COD only to specific ZIP codes.

   ![Upload ZIP codes to offer COD only to specific ZIP codes](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-wooc-cod-shipping-pincode.jpg)
...
4. Click **Save slab**.
   ...
   ![Create advanced COD eligibility slabs](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-shopify-advanced-cod-slabs.jpg)
...
9. You can configure COD based on either the zone or product categories.
   ...
   - **Zone Configuration**: Manage applicable COD slabs and rates for different zones.
     1. Click **+ Set zone configuration**.
        ...
        ![Set zone configuration](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-shopif-zone-config.jpg)
     2. Select the slabs based on your requirement and click **Save configuration**. It is mandatory to configure all the zones you create. The COD charge applies to each zone based on the slabs you select.
        ...
        ![Select zone-wise COD slabs](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-shopify-zone-cod-slabs.jpg)
     3. Click **Save & apply**.
   - **Product categories**: Create **Product categories** to establish custom rates or zone restrictions for different categories.
     ...
     2. Click **+ Add categories**.
        ...
        ![Add product categories](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-shopify-product-cat.jpg)
     ...
     6. Click **+ Set category configuration** to configure the zones and slabs for each category.
        ...
        ![Set category configuration](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-shopify-product-cat-config.jpg)
     ...
     8. Click **Save configuration**. It is mandatory to configure slabs for all the zones you create.
        ...
        ![Config zone and slabs for each category](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-shopify-category-config.jpg)
     9. Click **Save & apply**.
...
6. Click **Confirm**.
   ...
   ![Confirm](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/cod-blocklist-confirm.jpg)
...
![Enable COD intelligence](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-cod-enable-shopify.jpg)
...
4. Toggle on **Manually review COD orders**.
   ...
   ![Enable manual Review](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-enable-manual-review.jpg)
5. Enter the **Consumer Key** and **Secret**. Follow the steps given below to generate API keys:
   1. Log in to the [WordPress account](https://wordpress.com/log-in)
      ...
      and navigate to **WooCommerce** → **Settings**.
   2. Navigate to **Advanced** → **REST API**.

      ![REST APIs](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-rest-apis.jpg)
   3. Click **Add Key**.
   ...
   5. Copy the API keys and paste them onto the Razorpay Dashboard. Click **Submit**.
      ...
      ![Submit keys](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-submit-keys.jpg)
6. Click **Enable manual review**.

Once you enable manual review, you can review the COD orders and take necessary actions. Refer to the [COD Orders](/razorpay-docs-md/magic-checkout/order-settings/review-cod-orders.md#cod-orders) section for more information.
...
4. Click **Add Profile** in the **Custom Shipping Profile** section.
   ...
   ![Navigate to Shipping settings on the Razorpay Dashboard](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-shipping-settings.jpg)
5. Click **+ Add category** in the **Product categories** section.

   ![Add product categories to configure shipping](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-wooc-shipping-category.jpg)
...
8. Enter the **Zone name** and select the country, state, and city of your choice.
   ...
   ![Add shipping zones to determine the shipping charges for each zone](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/wooc-add-shipping-zone.jpg)
...
11. Click **+ Add shipping method** and configure the **Shipping method & rate** for all the shipping zones added in the previous step.
    ...
    ![Configure the shipping rates for each zone](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/wooc-shipping-method.jpg)
...
14. Configure the Shipping slab based on the **Amount** and **Weight** of the product and enter the minimum and maximum values respectively. For example, enter the minimum-maximum value as ₹500-₹900. If the amount of the product falls in that range, a shipping rate is applicable on the product.
    ...
    ![Configure the shipping method](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/wooc-configure-shipping-method.jpg)
15. Enter the delivery estimated timeline for the customers which appears on checkout.
16. Click **Confirm**.

    ![Configure the shipping method](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/wooc-configure-shipping-delivery.jpg)
...
19. If you selected **Magic Shipping** as the **Shipping Type** above, enable **Magic Shipping** below on the Dashboard. To confirm the action, click **Yes, enable**.
    ...
    **Watch Out!**
    ...
    - Once you enable **Magic Shipping**, it surpasses all shipping configurations from any plugins or your ecommerce platform and prioritise our configurations.
      ...
      ![Enable Shipping settings on the Razorpay Dashboard](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/wooc-magic-enable-shipping-settings.jpg)
    - You will get a pop-up if you have not opted for [COD Engine](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#cash-on-delivery)

      and [COD order to prepaid](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#convert-cod-orders-to-prepaid)      . Enter the **Consumer Key** and **Secret**. Follow the steps given below to generate API keys:
      1. Log in to the [WordPress account](https://wordpress.com/log-in)

         and navigate to **WooCommerce** → **Settings**.
      2. Navigate to **Advanced** → **REST API** and click **Add Key**.
...
2. Navigate to **WooCommerce** → **Settings** and click the **Shipping** tab.
   ...
   ![Shipping settings](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-navigate.jpg)
3. Add the appropriate **Shipping Zones** and the respective **Shipping Method**.
   ...
   **Watch Out!**
   ...
   ![Shipping Zone and methods](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-shipping-zone.jpg)
4. Enable COD for the shipping methods, if required. Navigate to **WooCommerce** → **Settings** and click the **Payments** tab.

   ![Shipping Zone](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-woocommerce-payments.jpg)
5. Scroll down to **Cash on Delivery** and select the **Enable cash on delivery** check box.
   ...
   ![Shipping method COD](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-shipping-method-cod.jpg)
...
You can integrate Magic Checkout with following logistics partners to easily fetch delivery status details. This is a mandatory step if you have opted for [RTO protection](/razorpay-docs-md/magic-checkout/woocommerce/configuration.md#rto):

- [Shiprocket](/razorpay-docs-md/magic-checkout/rto-reduction/logistics-partners/shiprocket.md)
- [Delhivery](/razorpay-docs-md/magic-checkout/rto-reduction/logistics-partners/delhivery.md)
- [iThink Logistics](/razorpay-docs-md/magic-checkout/rto-reduction/logistics-partners/ithink-logistics.md)
- [Unicommerce](/razorpay-docs-md/magic-checkout/rto-reduction/logistics-partners/unicommerce.md)
- [ClickPost](/razorpay-docs-md/magic-checkout/rto-reduction/logistics-partners/clickpost.md)

![Logistics partners](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-logistics-connect.jpg)
...
2. Select **WooCommerce** from the **Platform** drop-down list. Paste the [WordPress Address or Site Address](/razorpay-docs-md/magic-checkout/woocommerce.md#step-1-enable-features-on-razorpay-dashboard)

   in the **Domain hyperlink** field and click **Next**.
3. Navigate to **Shipping Setup** and enable **International Shipping**.

   ![enable international shipping for customers](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-int-shipping.jpg)
...
4. Add a **Description** for the coupon.
   ...
   **Handy Tips**
   ...
   ![](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-coupon.jpg)
5. In the Razorpay Dashboard, navigate to **Magic Checkout** → **Setup & Settings** → **Platform Settings**.
6. Select **WooCommerce** from the **Platform** drop-down list. Paste the [WordPress Address or Site Address](/razorpay-docs-md/magic-checkout/woocommerce.md#step-1-enable-features-on-razorpay-dashboard)
...
7. In the **Checkout Setup** tab, the **Coupon Settings** fields are auto-filled. If you want to show all the available coupons directly on Magic Checkout, enable **Auto fetch coupon**.
   ...
   ![Enable Auto Fetch coupons to show all the available coupons on Magic Checkout](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-auto-fetch-coupons.jpg)
8. Click **Save settings**.

**Handy Tips**

If you want to display specific coupons on checkout instead of all, you can provide a list of coupons you would like us to whitelist. Write to us at [[magic-checkout-support@razorpay.com](mailto:magic-checkout-support@razorpay.com)](mailto:magic-checkout-support@razorpay.com)
...
3. Navigate to **Checkout Setup**, enable **Capture billing address** and click **Save settings**.
   ...
   ![enable separate billing address capture for customers](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-billing-add.jpg)
...
3. Navigate to **Checkout Setup**, enable **Capture GSTIN?** and click **Save settings**.
   ...
   ![Capture customers GST details](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-wooc-gstin.jpg)
...
![GSTIN on checkout](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-config-gstin.jpg)
...
3. Navigate to **Checkout Setup**, enable **Capture order instructions?** and click **Save settings**.
   ...
   ![Capture customer order instructions if any](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-wooc-order-instructions.jpg)
...
4. Once you enable the gift card settings, you can also enable the following options **if required**:
   ...
   ![Configure the gift card options if required](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-wooc-gift-config.jpg)
...
4. Scroll towards the end and activate Google and Facebook analytics based on your requirement.
   ...
   ![enable google and facebook analytics](https://razorpay.com/docs/payments/magic-checkout/woocommerce/build/browser/assets/images/magic-checkout-other-settings3.jpg)
