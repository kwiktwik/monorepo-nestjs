<!-- Source: https://razorpay.com/docs/payments/route/faqs -->
...
You can also use [Route Transfers APIs](/razorpay-docs-md/api/payments/route.md) to transfer money.
...
The transfer is processed asynchronously and on success, `transfer.processed` webhook is sent (if enabled). Know more about [setting up Webhooks](/razorpay-docs-md/route/subscribe-to-webhooks.md).
...
Know more about [setting up Webhooks](/razorpay-docs-md/route/subscribe-to-webhooks.md).
...
1. Log in to the Dashboard.
2. Go to **Route** → **Transfers**. Click on a **Transfer id** to view the details. Click on the **Create Reversal** button to reverse the transfer.
   - You can also use the [Reverse Transfers from all Linked Accounts API](/razorpay-docs-md/api/payments/route/reverse-a-transfer.md)

     to reverse money transfer.
   - You can also [refund payment and simultaneously reverse](/razorpay-docs-md/api/payments/route/refund-payments-and-reverse-transfer.md)

     all the transfers made on that payment.
...
You can create linked accounts using bulk upload from the Dashboard. Know more about [Batch Upload](/razorpay-docs-md/route/batch-upload.md).
...
Know more about the [Create Transfers from Payments API](/razorpay-docs-md/api/payments/route/create-transfers-payments.md).
...
For detailed calculation examples, refer to our [Transfers and Related Fees Examples](/razorpay-docs-md/route/transfer-fees-example.md) page.
...
![Route - Linked Account Verification Failed](https://razorpay.com/docs/payments/route/build/browser/assets/images/route_la_pt_vf.jpg)

**Activated**

![Route - Linked Account Activated](https://razorpay.com/docs/payments/route/build/browser/assets/images/route_la_pt_act.jpg)

**Verification Pending**

![Route - Linked Account Verification Pending](https://razorpay.com/docs/payments/route/build/browser/assets/images/route_la_pt_vp.jpg)

**Not Activated**

![Route - Linked Account Not Activated](https://razorpay.com/docs/payments/route/build/browser/assets/images/route_la_pt_na.jpg)
...
You can upload 50,000 rows in one go with 11 MB as the max file size using the [Bulk Upload](/razorpay-docs-md/route/batch-upload.md#create-linked-accounts-via-batch-upload) feature. Below is the expected TAT:
