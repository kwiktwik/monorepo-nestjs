<!-- Source: https://razorpay.com/docs/payments/route/linked-account/initiate-refund -->
...
The Linked Account holders must send an offline request to you to use [Refund Credits](/razorpay-docs-md/route/linked-account.md#enable-refund-credits). Upon gaining access, funds can be transferred to the Refund Credits pool through the account number that you share.
...
![Refund credits on the Reversals screen](https://razorpay.com/docs/payments/route/linked-account/build/browser/assets/images/Route-Refund-Credits.jpg)

You can initiate the following types of refunds from the Linked Account: [Individual Refund](/razorpay-docs-md/route/linked-account/initiate-refund.md#individual-refunds), [Full Refund](/razorpay-docs-md/route/linked-account/initiate-refund.md#full-refund), [Partial Refund](/razorpay-docs-md/route/linked-account/initiate-refund.md#partial-refund) and [Batch Refund](/razorpay-docs-md/route/linked-account/initiate-refund.md#batch-refunds).
...
![Refund checklist page](https://razorpay.com/docs/payments/route/linked-account/build/browser/assets/images/route_allow_refund.jpg)
...
![Full refund page](https://razorpay.com/docs/payments/route/linked-account/build/browser/assets/images/Route-Full-Refund.jpg)
...
![Partial refund page](https://razorpay.com/docs/payments/route/linked-account/build/browser/assets/images/Route-Partial-Refund.jpg)
...
- [Reversals and Settlements](/razorpay-docs-md/route/linked-account/reversals-settlements.md)
- [Manage Profile and Team](/razorpay-docs-md/route/linked-account/manage-profile.md)
