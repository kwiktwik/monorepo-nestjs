<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/shopify/migration-steps -->

If you are using Razorpay to accept payments, you can now upgrade to the **1 Razorpay App** on your Shopify Store. Watch the [video tutorial](/razorpay-docs-md/payment-gateway/ecommerce-plugins/shopify/migration-steps.md#video-tutorial) or follow the [migration steps](/razorpay-docs-md/payment-gateway/ecommerce-plugins/shopify/migration-steps.md#migration-steps) to migrate to 1 Razorpay App. Know more about why you need to [upgrade to 1 Razorpay](/razorpay-docs-md/payment-gateway/ecommerce-plugins/shopify/faqs.md#1-why-do-i-need-to-upgrade-to).
...
1. Click on [this link](https://accounts.shopify.com/store-login?redirect=settings%2Fpayments%2Falternative-providers%2F1058839)
   ...
   to access the 1 Razorpay App on your Shopify store.
2. Click **Install**.

   ![Shopify Install](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/shopify/build/browser/assets/images/shopify-1-razorpay-install-new.jpg)
...
1. Click on [this link](https://accounts.shopify.com/store-login?redirect=settings/payments/alternative-providers/1030400)

   to access the existing Razorpay App on your Shopify store.
2. Click **Deactivate Razorpay** to deactivate the existing Razorpay App on your Shopify store.

   ![Deactivate Shopify v1](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/shopify/build/browser/assets/images/shopify-deactivate-v1-final.jpg)

For more information, see [Shopify FAQs](/razorpay-docs-md/payment-gateway/ecommerce-plugins/shopify/faqs.md).
...
Know more about how to [reconcile Shopify orders on the Dashboard](/razorpay-docs-md/payment-gateway/ecommerce-plugins/shopify/reconcile-payments.md).
...
![Old New difference](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/shopify/build/browser/assets/images/old-new-plugin.jpg)
