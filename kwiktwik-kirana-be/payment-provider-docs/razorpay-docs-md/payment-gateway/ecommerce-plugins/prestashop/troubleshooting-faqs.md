<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/prestashop/troubleshooting-faqs -->
...
2. In the **Website and app settings** section, click **Webhooks**.
   ...
   ![Navigate to Webhooks](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/prestashop/build/browser/assets/images/account-settings-webhooks.jpg)
3. Click **+ Add New Webhook**.

   ![](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/prestashop/build/browser/assets/images/webhooks-webhook-creation-1.jpg)
4. In the **Webhook Setup** pop-up page:
   ...
   5. Click **Create Webhook**.
      ...
      ![](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/prestashop/build/browser/assets/images/webhooks-webhook-creation-2.jpg)
...
4. On the right panel, check if the status for `payment.authorized`, `refund.created` and `virtual_account.credited` is enabled.
   ...
   ![List of webhooks created](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/prestashop/build/browser/assets/images/plugin-webhook-faq.jpg)
...
1. Reinstall the Razorpay Prestashop plugin and ensure that your system meets all the requirements mentioned [here](/razorpay-docs-md/payment-gateway/ecommerce-plugins/prestashop/integration-steps.md#installation-and-configuration)   .
...
1. Verify if the Razorpay scripts are loading.
   ...
   - Check if **script.js** and **checkout.js** are loading under the loaded modules.
     ...
     ![Prestashop Razorpay pay button inspect](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/prestashop/build/browser/assets/images/prestashop-script-checkout.jpg)
2. If the scripts are not loading check hook configuration in Prestashop database:
   - Open the Prestashop database and navigate to the **hook\_alias** table.
