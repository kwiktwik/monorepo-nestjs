<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/wix/faqs -->
...
2. In the **Website and app settings** section, click **Webhooks**.
   ...
   ![Navigate to Webhooks](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/wix/build/browser/assets/images/account-settings-webhooks.jpg)
3. Click **+ Add New Webhook**.

   ![](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/wix/build/browser/assets/images/webhooks-webhook-creation-1.jpg)
...
1. Reinstall the Razorpay Wix plugin and ensure that your system meets all the requirements mentioned [here](/razorpay-docs-md/payment-gateway/ecommerce-plugins/wix/integration-steps.md)   .
...
4. On the right panel, check if the status for `order.paid`, `refund.processed` and `payment.failed` is enabled.
   ...
   ![List of webhooks created](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/wix/build/browser/assets/images/plugin-webhook-faq.jpg)
