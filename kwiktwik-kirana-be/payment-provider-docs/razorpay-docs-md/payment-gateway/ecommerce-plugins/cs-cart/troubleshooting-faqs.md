<!-- Source: https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/cs-cart/troubleshooting-faqs -->
...
2. In the **Website and app settings** section, click **Webhooks**.
   ...
   ![Navigate to Webhooks](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/cs-cart/build/browser/assets/images/account-settings-webhooks.jpg)
3. Click **+ Add New Webhook**.

   ![](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/cs-cart/build/browser/assets/images/webhooks-webhook-creation-1.jpg)
...
6. Enter a **Secret** for the webhook endpoint. The secret is used to validate that the webhook is from Razorpay. Do not expose the secret publicly. Know more about [how to validate webhooks](/docs/webhooks/validate-test/)   .
...
8. Select the required events from the list of **Active Events**.
   ...
   ![](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/cs-cart/build/browser/assets/images/webhooks-webhook-creation-2.jpg)
...
4. On the right panel, check if the status for `payment.authorized`, `refund.created` and `virtual_account.credited` is enabled.
   ...
   ![List of webhooks created](https://razorpay.com/docs/payments/payment-gateway/ecommerce-plugins/cs-cart/build/browser/assets/images/plugin-webhook-faq.jpg)
...
1. Reinstall the Razorpay CS-Cart plugin and ensure that your system meets all the requirements mentioned [here](/razorpay-docs-md/payment-gateway/ecommerce-plugins/cs-cart/integration-steps.md)   .
