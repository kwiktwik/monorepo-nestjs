...
1. [Intent](/razorpay-docs-md/payment-gateway/react-native-integration/custom/additional-features.md#intent-flow)
2. [Collect](/razorpay-docs-md/payment-gateway/react-native-integration/custom/additional-features.md#collect-flow)
