<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments -->
...
![Feature Request GIF](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/build/browser/assets/images/feature-request.gif)
...
For automated, fixed-schedule billing (weekly, monthly, quarterly), consider using [Subscriptions](/razorpay-docs-md/subscriptions.md) instead.
...
![](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/build/browser/assets/images/recurring-payments-recurring_payments_standard_checkout.jpg)
...
![](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/build/browser/assets/images/recurring-payments-recurring_payments_registration_link.jpg)
...
- [APIs for Cards](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/cards/authorization-transaction.md)
- APIs for UPI Autopay: [Collect](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi/authorization-transaction.md)

  and [Intent](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-intent/authorization-transaction.md)
- APIs for UPI OTM: [Collect](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/authorization-transaction.md)

  and [Intent](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-otm/intent/authorization-transaction.md)
- [APIs for UPI TPV](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-tpv/authorization-transaction.md)
- [APIs for Emandate](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/emandate/authorization-transaction.md)
- [APIs for Paper NACH](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/paper-nach/authorization-transaction.md)

Step 2: Fetch Token Details

Fetch the customer's token detail to proceed with the authorisation payment using:

- [APIs for Cards](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/cards/tokens.md)
- APIs for UPI Autopay: [Collect](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi/tokens.md)

  and [Intent](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-intent/tokens.md)
- APIs for UPI OTM: [Collect](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/tokens.md)

  and [Intent](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-otm/intent/tokens.md)
- [APIs for UPI TPV](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-tpv/tokens.md)
- [APIs for Emandate](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/emandate/tokens.md)
- [APIs for Paper NACH](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/paper-nach/tokens.md)

Step 3: Charge Subsequent Payments

Use the token to charge customers as needed using:

- [APIs for Cards](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/cards/subsequent-payments.md)
- APIs for UPI Autopay: [Collect](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi/subsequent-payments.md)

  and [Intent](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-intent/subsequent-payments.md)
- APIs for UPI OTM: [Collect](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/one-time-payment.md)

  and [Intent](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-otm/intent/one-time-payment.md)
- [APIs for UPI TPV](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/upi-tpv/subsequent-payments.md)
- [APIs for Emandate](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/emandate/subsequent-payments.md)
- [APIs for Paper NACH](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/paper-nach/subsequent-payments.md)
