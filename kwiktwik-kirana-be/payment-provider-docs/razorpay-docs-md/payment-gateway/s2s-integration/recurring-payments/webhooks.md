<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments/webhooks -->
...
3. Click the **+ Add New Webhook** button.
   ...
   ![Add a new webhooks button on the Dashboard](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments/build/browser/assets/images/webhooks-webhook-creation-1.jpg)
4. In the **Webhook Setup** pop-up page:
   ...
   ![List of active webhook events on Razorpay Dashboard](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments/build/browser/assets/images/webhooks-webhook-creation-2.jpg)
5. Click **Create Webhook**. After you set up a webhook, it appears on the list of webhooks.

   ![List of webhooks on Razorpay Dashboard](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments/build/browser/assets/images/webhooks-webhooks-list.jpg)
...
You can use these webhooks to check the status of the pre-debit notification sent to the customer when the payment method is [UPI](/razorpay-docs-md/api/payments/recurring-payments/upi/create-authorization-transaction.md) and [Cards](/razorpay-docs-md/api/payments/recurring-payments/cards/create-authorization-transaction.md). These notification webhooks are available only if you send the notification object while creating an order.
