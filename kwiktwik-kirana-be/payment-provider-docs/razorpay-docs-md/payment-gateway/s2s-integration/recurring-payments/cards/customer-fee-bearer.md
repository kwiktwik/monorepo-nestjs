<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments/cards/customer-fee-bearer -->
...
If you have already integrated with [Recurring Payments Cards APIs](/razorpay-docs-md/payment-gateway/s2s-integration/recurring-payments/cards/authorization-transaction.md), you must implement an additional API integration step that calculates fees before creating recurring payments.
...
![Feature Request GIF](https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments/cards/build/browser/assets/images/feature-request.gif)
...
Refer to the [Create a Subsequent Card Payment API](/razorpay-docs-md/api/payments/recurring-payments/cards/create-subsequent-payments.md#32-create-a-recurring-payment) to proceed.

## Related Information

- [Recurring Payments Documentation](/razorpay-docs-md/recurring-payments.md)
- [Recurring Payments APIs](/razorpay-docs-md/api/payments/recurring-payments.md)
