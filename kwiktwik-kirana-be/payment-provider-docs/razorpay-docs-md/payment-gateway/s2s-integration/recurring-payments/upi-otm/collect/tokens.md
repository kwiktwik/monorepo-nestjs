<!-- Source: https://razorpay.com/docs/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/tokens -->
...
You can also retrieve the `token_id` via the [payment.failed webhook](/razorpay-docs-md/api/payments/recurring-payments/webhooks.md#payment-failed).
