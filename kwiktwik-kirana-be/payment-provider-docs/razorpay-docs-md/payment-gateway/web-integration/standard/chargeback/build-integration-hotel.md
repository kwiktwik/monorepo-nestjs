<!-- Source: https://razorpay.com/docs/payments/payment-gateway/web-integration/standard/chargeback/build-integration-hotel -->

Follow these steps to integrate the standard checkout form on your website:

**1.1** [Generate API Keys](/razorpay-docs-md/payment-gateway/web-integration/standard/chargeback/build-integration-hotel.md#11-generate-api-keys).

**1.2** [Create an order in server](/razorpay-docs-md/payment-gateway/web-integration/standard/chargeback/build-integration-hotel.md#12-create-an-order-in-server).

**1.3** [Integrate with checkout on client-side](/razorpay-docs-md/payment-gateway/web-integration/standard/chargeback/build-integration-hotel.md#13-integrate-with-checkout-on-client-side).

**1.4** [Handle payment success and failure](/razorpay-docs-md/payment-gateway/web-integration/standard/chargeback/build-integration-hotel.md#14-handle-payment-success-and-failure).

**1.5** [Store fields in server](/razorpay-docs-md/payment-gateway/web-integration/standard/chargeback/build-integration-hotel.md#15-store-fields-in-your-server).

**1.6** [Verify payment signature](/razorpay-docs-md/payment-gateway/web-integration/standard/chargeback/build-integration-hotel.md#16-verify-payment-signature).

**1.7** [Verify payment status](/razorpay-docs-md/payment-gateway/web-integration/standard/chargeback/build-integration-hotel.md#17-verify-payment-status).
...
- You can create an order using the [Orders API](/razorpay-docs-md/payment-gateway/web-integration/standard/chargeback/build-integration-hotel.md#api-sample-code)  . It is a server-side API call.  Know how to [authenticate](/razorpay-docs-md/api/authentication.md#generate-api-keys)
...
The way the Payment Success and Failure scenarios are handled depends on the [Checkout Sample Code](/razorpay-docs-md/payment-gateway/web-integration/standard/chargeback/build-integration-hotel.md#code-to-add-pay-button) you used in the last step.
