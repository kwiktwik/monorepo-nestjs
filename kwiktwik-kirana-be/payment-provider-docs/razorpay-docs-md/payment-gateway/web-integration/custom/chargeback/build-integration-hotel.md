<!-- Source: https://razorpay.com/docs/payments/payment-gateway/web-integration/custom/chargeback/build-integration-hotel -->

Follow the steps to integrate Custom Checkout in your site:

**1.1** [Generate API Keys](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#11-generate-api-keys).

**1.2** [Create an Order in Server](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#12-create-an-order-in-server).

**1.3** [Fetch Payment Methods](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#13-fetch-payment-methods).

**1.4** [Invoke Checkout and Pass Order Id and Other Options to it](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#14-invoke-checkout-and-pass-order-id-and).

**1.4.1** [Include JavaScript code in your Webpage](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#141-include-javascript-code-in-your-webpage).

**1.4.2** [Instantiate Custom Checkout](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#142-instantiate-custom-checkout).

**1.4.3** [Submit Payment Details](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#143-submit-payment-details).

**1.5** [Store Fields in Your Server](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#15-store-fields-in-your-server).

**1.6** [Verify Payment Signature](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#16-verify-payment-signature).

**1.7** [Verify Payment Status](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#17-verify-payment-status).
...
- You can create an order using the [Orders API](/razorpay-docs-md/payment-gateway/web-integration/custom/chargeback/build-integration-hotel.md#api-sample-code)  . It is a server-side API call.  Know how to [authenticate](/razorpay-docs-md/api/authentication.md#generate-api-keys)
