...
export class MockPhonePeService {
  ...
  async createOrder(
    ...
    this.logger.log(
      `[MOCK PhonePe] createOrder merchantOrderId=${merchantOrderId}`,
    );
  ...
  async createOrderWithAuth(
    ...
    const merchantOrderId = nanoid(10);
    this.logger.log(
      `[MOCK PhonePe] createOrderWithAuth merchantOrderId=${merchantOrderId}`,
    );
  ...
  async initiatePayment(
    ...
    const merchantOrderId = nanoid(10);
    this.logger.log(
      `[MOCK PhonePe] initiatePayment merchantOrderId=${merchantOrderId}`,
    );
  ...
  async createOrderToken(
    ...
    this.logger.log(
      `[MOCK PhonePe] createOrderToken merchantOrderId=${merchantOrderId}`,
    );
  ...
  async setupSubscription(
    ...
    const merchantOrderId = nanoid(10);
    this.logger.log(
      `[MOCK PhonePe] setupSubscription merchantSubscriptionId=${merchantSubscriptionId}`,
    );
