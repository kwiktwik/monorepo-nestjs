...
export interface ICrawlJobRepository {
  ...
  findByDedupKey(endpointId: number, dedupKey: string): Promise<CrawlJob | null>;
  ...
  updateStatus(id: string, status: CrawlJobStatus, metadata?: UpdateCrawlJobInput): Promise<void>;
