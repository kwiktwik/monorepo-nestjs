...
export const paymentWebhookEvents = pgTable(
  ...
  (table) => ({
    ...
    appIdIdx: index('webhook_events_app_id_idx').on(table.appId),
    ...
    merchantSubIdx: index('webhook_events_merchant_sub_idx').on(table.merchantSubscriptionId),
    merchantOrderIdx: index('webhook_events_merchant_order_idx').on(table.merchantOrderId),
    createdAtIdx: index('webhook_events_created_at_idx').on(table.createdAt),
    uniqueEventId: unique('webhook_events_event_id_unique').on(table.provider, table.eventId),
  }),
);
